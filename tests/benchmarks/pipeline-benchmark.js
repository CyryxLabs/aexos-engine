...
const PIPELINE_MODULES = [
  '.aexos-core/development/scripts/unified-activation-pipeline',
  '.aexos-core/development/scripts/greeting-builder',
  '.aexos-core/development/scripts/agent-config-loader',
  '.aexos-core/development/scripts/greeting-preference-manager',
  '.aexos-core/development/scripts/workflow-navigator',
  '.aexos-core/core/session/context-loader',
  '.aexos-core/core/session/context-detector',
  '.aexos-core/core/permissions',
  '.aexos-core/infrastructure/scripts/project-status-loader',
  '.aexos-core/infrastructure/scripts/git-config-detector',
  '.aexos-core/core/config/config-resolver',
  '.aexos-core/core/config/config-cache',
];
...
async function runBenchmark(options) {
  const pipelinePath = path.resolve(
    PROJECT_ROOT, '.aexos-core/development/scripts/unified-activation-pipeline',
  );
