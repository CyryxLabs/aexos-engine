...
const { Layer1PreCommit } = require('../../.aexos-core/core/quality-gates/layer1-precommit');
const { Layer2PRAutomation } = require('../../.aexos-core/core/quality-gates/layer2-pr-automation');
const { Layer3HumanReview } = require('../../.aexos-core/core/quality-gates/layer3-human-review');
const { ChecklistGenerator } = require('../../.aexos-core/core/quality-gates/checklist-generator');

let spawnSyncSpy;
const originalSpawnSync = childProcess.spawnSync;

beforeEach(() => {
  // Pipeline tests replace the external command adapter. Model a usable WSL
  // prerequisite as part of that boundary so results do not vary by host.
    ...
    it('should generate checklist with context', async () => {
      const checklist = await generator.generate({
        ...
        changedFiles: [
          ...
          '.aexos-core/core/quality-gates/manager.js',
