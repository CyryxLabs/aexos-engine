...
utilities.forEach(util => {
  try {
    const utilPath = path.join(__dirname, '../../aexos-core/utils', `${util}.js`);
    require(utilPath);
...
const agents = [
  { name: 'qa', path: '.aexos-core/development/agents/qa.md' },
  { name: 'po', path: '.aexos-core/development/agents/po.md' },
  { name: 'devops', path: '.aexos-core/development/agents/devops.md' },
  { name: 'dev', path: '.aexos-core/development/agents/dev.md' },
];
