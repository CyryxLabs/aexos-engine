...
const { searchKeyword } = require('../../.aexos-core/cli/commands/workers/search-keyword');
const { applyFilters } = require('../../.aexos-core/cli/commands/workers/search-filters');
const { formatOutput, formatJSON } = require('../../.aexos-core/cli/utils/output-formatter-cli');
...
describe('Smoke Tests - Search CLI', () => {
   ...
   * `aexos workers search "validator"` returns results
