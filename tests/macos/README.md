# macOS Testing Suite for AEXOS
**Story 1.10b - macOS Testing & Validation**

Comprehensive test automation framework for validating AEXOS installation on macOS (Intel and Apple Silicon).
...
```bash
./run-all-tests.sh
# View report at: /tmp/aexos-macos-test-report-*.txt
```
...
2. **Test Logs:**
   - Attach all `/tmp/aexos-test-*.log` files
...
**Created by:** Argus (QA Guardian) 🛡️
**Date:** 2025-01-23
**Version:** 1.0
