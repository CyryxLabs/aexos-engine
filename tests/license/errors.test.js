...
describe('errors', () => {
  describe('ProFeatureError', () => {
    ...
    it('should include activation instructions in message', () => {
      ...
      expect(error.message).toContain('Premium Squads requires an active CYRYX Pro license');
      expect(error.message).toContain('aexos pro activate --key <KEY>');
      expect(error.message).toContain('https://cyryx.ai/pro');
    });
    ...
    describe('toCliMessage', () => {
      it('should return formatted CLI message', () => {
        ...
        expect(cliMsg).toContain('Premium Squads requires an active CYRYX Pro license');
    ...
    describe('toJSON', () => {
      it('should return JSON-serializable object', () => {
        ...
        expect(json.message).toContain('requires an active CYRYX Pro license');
