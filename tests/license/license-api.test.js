...
describe('license-api', () => {
  ...
  beforeEach(() => {
    ...
    testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'aexos-api-test-'));
  ...
  describe('LicenseApiClient constructor', () => {
    it('should use default config', () => {
      ...
      expect(client.baseUrl).toBe(process.env.AEXOS_LICENSE_API_URL || 'https://aexos-license-server.vercel.app');
    ...
    it('should successfully activate license (AC-1)', async () => {
      ...
      await createMockServer((req, res) => {
        ...
        req.on('end', () => {
          ...
          expect(data.cyryxCoreVersion).toBe('3.0.0');
