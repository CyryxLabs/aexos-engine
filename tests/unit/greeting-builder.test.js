...
const {
  loadProjectStatus,
  formatStatusDisplay,
} = require('../../.aexos-core/infrastructure/scripts/project-status-loader');
  ...
  describe('User Profile-Based Filtering (Story 10.3)', () => {
    ...
    beforeEach(() => {
      ...
      mockPmAgent = {
        ...
        persona_profile: {
          greeting_levels: {
            minimal: '📋 PM ready',
            named: '📋 Janus (PM) ready',
            archetypal: '📋 Janus the Product Manager ready',
          },
        },
        persona: {
      ...
      mockDevAgent = {
        ...
        persona_profile: {
          greeting_levels: {
            minimal: '👨‍💻 Dev ready',
            named: '👨‍💻 Vulcan (Developer) ready',
            archetypal: '👨‍💻 Vulcan the Developer ready',
          },
        },
        persona: {
    ...
    describe('buildBobModeRedirect()', () => {
      test('should return redirect message with agent name', () => {
        ...
        expect(redirect).toContain('Vulcan');
      });
    ...
    describe('Full greeting in bob mode', () => {
      test('PM agent should show commands in bob mode (AC5)', async () => {
        ...
        expect(greeting).toContain('Janus');
        expect(greeting).toContain('help');
