...
const {
  ...
  getQuickSummary,
} = require('../../../.aexos-core/quality/metrics-hook');
const { MetricsCollector } = require('../../../.aexos-core/quality/metrics-collector');
...
describe('Metrics Hook', () => {
  ...
  describe('recordPRReviewMetrics', () => {
    ...
    it('should record PR review with Argus data', async () => {
      const result = await recordPRReviewMetrics({
        passed: true,
        durationMs: 120000,
        quinn: {
