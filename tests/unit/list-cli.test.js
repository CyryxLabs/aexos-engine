...
// Test modules
const { formatTree, formatTreeCollapsed, groupWorkers } = require('../../.aexos-core/cli/commands/workers/formatters/list-tree');
const { formatTable, formatJSON, formatYAML, formatList, formatCount, truncate } = require('../../.aexos-core/cli/commands/workers/formatters/list-table');
const { paginate, formatPaginationInfo, formatPaginationHint } = require('../../.aexos-core/cli/commands/workers/utils/pagination');
...
const mockWorkers = [
  ...
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'json', 'csv'],
    path: '.aexos-core/tasks/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.aexos-core/tasks/json-validator.md',
  },
  {
    id: 'unit-test-runner',
    ...
    path: '.aexos-core/tasks/unit-test-runner.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.aexos-core/tasks/api-generator.md',
  },
];
...
describe('Tree Formatter', () => {
  ...
  test('formatTree includes usage hints', () => {
    const output = formatTree(mockWorkers, {});
    expect(output).toContain('aexos workers info <id>');
    expect(output).toContain('aexos workers search <query>');
  });
...
describe('Performance Requirements', () => {
  ...
  const largeMockWorkers = Array.from({ length: 250 }, (_, i) => ({
    ...
    tags: ['tag1', 'tag2', 'tag3'],
    path: `.aexos-core/tasks/worker-${i}.md`,
  }));
