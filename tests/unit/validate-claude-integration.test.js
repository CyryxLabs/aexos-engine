...
const {
  ...
  listTopLevelNames,
} = require('../../.aexos-core/infrastructure/scripts/validate-claude-integration');
...
describe('validate-claude-integration', () => {
  ...
  it('passes when required Claude files exist', () => {
    ...
    write(path.join(tmpRoot, '.claude', 'commands', 'AEXOS', 'agents', 'dev.md'), '# dev');
    write(
      path.join(tmpRoot, '.claude', 'skills', 'AEXOS', 'agents', 'dev', 'SKILL.md'),
  ...
  it('ignores local Claude artifacts excluded by gitignore', () => {
    ...
    write(path.join(tmpRoot, '.claude', 'skills', 'aexos-dev', 'SKILL.md'), '# local legacy');
    write(path.join(tmpRoot, '.aexos-core', 'development', 'agents', 'dev.md'), '# dev');
  ...
  it('fails when non-core Claude native subagents are present', () => {
    ...
    write(path.join(tmpRoot, '.claude', 'agents', 'aexos-dev.md'), '# native dev');
  ...
  it('fails when non-core Claude agent memories are present', () => {
    ...
    write(path.join(tmpRoot, '.claude', 'agent-memory', 'aexos-dev', 'MEMORY.md'), '# allowed');
