...
jest.mock('../../.aexos-core/development/scripts/decision-log-generator', () => ({
...
describe('decision-recorder', () => {
  ...
  describe('completeDecisionLogging', () => {
    it('should complete logging and generate log file', async () => {
      const { generateDecisionLog } = require('../../.aexos-core/development/scripts/decision-log-generator');
