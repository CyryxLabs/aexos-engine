...
// Test modules
const { searchKeyword, fuzzyMatchScore, levenshteinDistance } = require('../../.aexos-core/cli/commands/workers/search-keyword');
const { applyFilters, filterByCategory, filterByTags } = require('../../.aexos-core/cli/commands/workers/search-filters');
const { formatOutput, formatTable, formatJSON, formatYAML } = require('../../.aexos-core/cli/utils/output-formatter-cli');
const { calculateScores, sortByScore, calculateSearchAccuracy } = require('../../.aexos-core/cli/utils/score-calculator');
const { isSemanticAvailable, cosineSimilarity, buildSearchText } = require('../../.aexos-core/cli/commands/workers/search-semantic');
...
const mockWorkers = [
  {
    ...
    path: '.aexos-core/development/tasks/data/json-csv-transformer.md',
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'data', 'json', 'csv'],
    path: '.aexos-core/development/tasks/data/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.aexos-core/development/tasks/validation/json-validator.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.aexos-core/development/tasks/code/api-generator.md',
  },
  {
    id: 'test-runner',
    name: 'Test Runner',
    ...
    path: '.aexos-core/development/tasks/testing/test-runner.md',
  },
];
  ...
  const testResults = [
    {
      ...
      tags: ['etl', 'json', 'csv'],
      score: 95,
      path: '.aexos-core/tasks/json-csv-transformer.md',
    },
  ];
