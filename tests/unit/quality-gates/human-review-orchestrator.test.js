...
describe('HumanReviewOrchestrator', () => {
  ...
  beforeEach(() => {
    orchestrator = new HumanReviewOrchestrator({
      statusPath: '.aexos/qa-status-test.json',
      reviewRequestsPath: '.aexos/human-review-requests-test',
    });
  });
  ...
  describe('constructor', () => {
    ...
    it('should create orchestrator with custom config', () => {
      expect(orchestrator.statusPath).toBe('.aexos/qa-status-test.json');
      expect(orchestrator.reviewRequestsPath).toBe('.aexos/human-review-requests-test');
    });
  });
