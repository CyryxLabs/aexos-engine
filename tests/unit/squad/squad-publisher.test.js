...
describe('SquadPublisher', () => {
  ...
  describe('Constants', () => {
    it('should export AEXOS_SQUADS_REPO', () => {
      expect(AEXOS_SQUADS_REPO).toBe('CyryxLabs/aexos-squads');
    });
  ...
  describe('Constructor', () => {
    ...
    it('should use default repo when not specified', () => {
      const defaultPublisher = new SquadPublisher();
      expect(defaultPublisher.repo).toBe(AEXOS_SQUADS_REPO);
    });
  ...
  describe('publish()', () => {
    ...
    it('should return preview in dry run mode', async () => {
      ...
      expect(result.preview.repo).toBe(AEXOS_SQUADS_REPO);
  ...
  describe('generatePRBody()', () => {
    ...
    it('should include checklist in PR body', () => {
      ...
      expect(body).toContain('[x] Squad follows AEXOS task-first architecture');
    ...
    it('should include submit attribution', () => {
      ...
      expect(body).toContain('AEXOS-FullStack');
    });
  });
