...
jest.mock('../../.aexos-core/core/synapse/memory/synapse-memory-provider', () => ({
...
const { MemoryBridge, BRACKET_LAYER_MAP, BRIDGE_TIMEOUT_MS } = require('../../.aexos-core/core/synapse/memory/memory-bridge');
