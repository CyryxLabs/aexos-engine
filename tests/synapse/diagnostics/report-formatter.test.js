...
const { formatReport } = jest.requireActual(
  '../../../.aexos-core/core/synapse/diagnostics/report-formatter',
);
...
jest.mock('../../../.aexos-core/core/synapse/diagnostics/collectors/hook-collector');
jest.mock('../../../.aexos-core/core/synapse/diagnostics/collectors/session-collector');
jest.mock('../../../.aexos-core/core/synapse/diagnostics/collectors/manifest-collector');
jest.mock('../../../.aexos-core/core/synapse/diagnostics/collectors/pipeline-collector');
jest.mock('../../../.aexos-core/core/synapse/diagnostics/collectors/uap-collector');
jest.mock('../../../.aexos-core/core/synapse/diagnostics/report-formatter');
jest.mock('../../../.aexos-core/core/synapse/domain/domain-loader');

const { collectHookStatus } = require('../../../.aexos-core/core/synapse/diagnostics/collectors/hook-collector');
const { collectSessionStatus } = require('../../../.aexos-core/core/synapse/diagnostics/collectors/session-collector');
const { collectManifestIntegrity } = require('../../../.aexos-core/core/synapse/diagnostics/collectors/manifest-collector');
const { collectPipelineSimulation } = require('../../../.aexos-core/core/synapse/diagnostics/collectors/pipeline-collector');
const { collectUapBridgeStatus } = require('../../../.aexos-core/core/synapse/diagnostics/collectors/uap-collector');
const { formatReport: mockFormatReport } = require('../../../.aexos-core/core/synapse/diagnostics/report-formatter');
const { parseManifest } = require('../../../.aexos-core/core/synapse/domain/domain-loader');

const { runDiagnostics, runDiagnosticsRaw } = require('../../../.aexos-core/core/synapse/diagnostics/synapse-diagnostics');
