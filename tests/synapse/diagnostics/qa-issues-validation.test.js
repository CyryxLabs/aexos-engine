 ...
 *
 * @created 2026-02-14 by Argus (@qa)
 */
...
const { collectQualityMetrics, BRACKET_ACTIVE_LAYERS, MAX_STALENESS_MS } = require(
  '../../../.aexos-core/core/synapse/diagnostics/collectors/quality-collector',
);
const { collectConsistencyMetrics, MAX_TIMESTAMP_GAP_MS } = require(
  '../../../.aexos-core/core/synapse/diagnostics/collectors/consistency-collector',
);
const { collectOutputAnalysis, UAP_OUTPUT_EXPECTATIONS } = require(
  '../../../.aexos-core/core/synapse/diagnostics/collectors/output-analyzer',
);
const { collectRelevanceMatrix, IMPORTANCE } = require(
  '../../../.aexos-core/core/synapse/diagnostics/collectors/relevance-matrix',
);
const { getActiveLayers } = require(
  '../../../.aexos-core/core/synapse/context/context-tracker',
);
