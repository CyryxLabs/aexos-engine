...
const {
  ...
  main,
  ROMAN_TO_ARABIC,
} = require('../../.aexos-core/core/synapse/scripts/generate-constitution');
const { parseManifest, loadDomainFile } = require('../../.aexos-core/core/synapse/domain/domain-loader');
 ...
 */
const FULL_CONSTITUTION = `# AEXOS (Cyryx) Constitution
...
describe('generateConstitution', () => {
  ...
  test('should include header comments', () => {
    ...
    expect(output).toContain('# Auto-generated from .aexos-core/constitution.md');
...
describe('integration: real constitution.md', () => {
  const realConstitutionPath = path.join(__dirname, '..', '..', '.aexos-core', 'constitution.md');
