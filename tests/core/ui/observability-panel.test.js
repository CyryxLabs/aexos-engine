...
const {
  ...
  PipelineStage,
  createDefaultState,
} = require('../../../.aexos-core/core/ui/observability-panel');

const { PanelRenderer, BOX, STATUS } = require('../../../.aexos-core/core/ui/panel-renderer');
...
describe('ObservabilityPanel', () => {
  ...
  describe('AC1: Current Agent Display', () => {
    it('should set current agent correctly', () => {
      ...
      panel.setCurrentAgent('@dev', 'Vulcan', 'implementing jwt-handler.ts');

      expect(panel.state.current_agent.id).toBe('@dev');
      expect(panel.state.current_agent.name).toBe('Vulcan');
    ...
    it('should set agent with reason for detailed mode', () => {
      ...
      panel.setCurrentAgent('@dev', 'Vulcan', 'implementing jwt-handler.ts', 'Story tipo "código geral"');
    ...
    it('should render current agent in output', () => {
      const panel = createPanel();
      panel.setCurrentAgent('@dev', 'Vulcan', 'implementing feature');
  ...
  describe('AC6: Detailed Mode (Educativo)', () => {
    ...
    it('should show agent reason in detailed mode', () => {
      const panel = createPanel({ mode: PanelMode.DETAILED });
      panel.setCurrentAgent('@dev', 'Vulcan', 'implementing', 'Story tipo "código geral"');
  ...
  describe('AC8: Real-time Updates', () => {
    ...
    it('should update state while running', () => {
      ...
      panel.setCurrentAgent('@qa', 'Argus', 'running tests');
  ...
  describe('State Management', () => {
    ...
    it('should get full state with getState method', () => {
      const panel = createPanel();
      panel.setCurrentAgent('@dev', 'Vulcan', 'implementing');
      panel.startStoryTimer();
