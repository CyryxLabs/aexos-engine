...
const BUILT_IN_CHECK_MODULES = [
  '../../../.aexos-core/core/health-check/checks/project',
  '../../../.aexos-core/core/health-check/checks/local',
  '../../../.aexos-core/core/health-check/checks/repository',
  '../../../.aexos-core/core/health-check/checks/deployment',
  '../../../.aexos-core/core/health-check/checks/services',
];
...
function loadFreshRegistryModules() {
  ...
  let loadedModules;
  jest.isolateModules(() => {
    const baseCheck = require('../../../.aexos-core/core/health-check/base-check');
    const CheckRegistry = require('../../../.aexos-core/core/health-check/check-registry');
