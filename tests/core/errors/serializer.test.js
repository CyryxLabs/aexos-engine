...
describe('error serializer', () => {
  ...
  test('serializes CYRYXError with redacted stack by default', () => {
    const error = new CYRYXError('Layer failed', {
  ...
  test('preserves generic error own properties and cause', () => {
    ...
    error.code = 'AEXOS_EXECUTION_FAILED';
    error.detail = {
      attempt: 2,
    };
  ...
  test('sanitizes circular and non-JSON metadata values', () => {
    ...
    const error = new CYRYXError('json safe', {
      code: 'AEXOS_EXECUTION_FAILED',
      metadata,
    });
