const { proErrorRegistry, PRO_ERROR_DEFINITIONS } = require('../../../.aexos-core/core/errors/pro-error-registry');
const { defaultErrorRegistry, ErrorCategory } = require('../../../.aexos-core/core/errors');
