...
jest.mock('../../.aexos-core/development/scripts/unified-activation-pipeline', () => ({
...
const { ActivationRuntime, activateAgent } = require('../../.aexos-core/development/scripts/activation-runtime');
