...
jest.mock('../../.aexos-core/workflow-intelligence/engine/wave-analyzer', () => null);
jest.mock('../../.aexos-core/infrastructure/scripts/worktree-manager', () => { throw new Error('not available'); });
jest.mock('../../.aexos-core/core/memory/gotchas-memory', () => ({ GotchasMemory: jest.fn() }));

const EventEmitter = require('events');
const childProcess = require('child_process');
const { mockChildProcess, createMockMemoryQuery, createMockGotchasMemory } = require('./execution-test-helpers');
const { SubagentDispatcher } = require('../../.aexos-core/core/execution/subagent-dispatcher');
const { BuildOrchestrator } = require('../../.aexos-core/core/execution/build-orchestrator');
