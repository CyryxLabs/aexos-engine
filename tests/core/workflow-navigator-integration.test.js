...
const { SessionState } = require('../../.aexos-core/core/orchestration/session-state');
const { SurfaceChecker } = require('../../.aexos-core/core/orchestration/surface-checker');
...
describe('WorkflowNavigator Integration (Story ACT-5)', () => {
    ...
    mockAgent = {
      ...
      persona_profile: {
        greeting_levels: {
          ...
          archetypal: '\uD83D\uDCBB Vulcan the Builder ready!',
        },
        communication: {
          signature_closing: '-- Vulcan, always building',
        },
      },
      persona: {
  ...
  describe('AC5: Bob orchestration patterns in workflow-patterns.yaml', () => {
    ...
    beforeAll(() => {
      const patternsPath = path.join(
        __dirname,
        '../../.aexos-core/data/workflow-patterns.yaml',
      );
  ...
  describe('UnifiedActivationPipeline _detectWorkflowState relaxation', () => {
    ...
    beforeEach(() => {
      ...
      jest.mock('../../.aexos-core/development/scripts/greeting-builder');
      ...
      const MockWorkflowNavigator = require('../../.aexos-core/development/scripts/workflow-navigator');
