 ...
 *
 * @see .aexos-core/core/doctor/fix-handler.js
 * @issue #52
 */
...
const { applyFixes } = require(path.join(PROJECT_ROOT, '.aexos-core/core/doctor/fix-handler'));
const { EXPECTED_RULES } = require(path.join(PROJECT_ROOT, '.aexos-core/core/doctor/checks/rules-files'));
