 ...
 *
 * @see .aexos-core/core/permissions/index.js
 */
...
jest.mock('../../../.aexos-core/core/permissions/permission-mode', () => ({
...
jest.mock('../../../.aexos-core/core/permissions/operation-guard', () => ({
...
const {
  ...
  cycleMode,
  enforcePermission,
} = require('../../../.aexos-core/core/permissions/index');
