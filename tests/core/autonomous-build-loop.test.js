...
jest.mock('../../.aexos-core/core/execution/build-state-manager', () => ({
  BuildStateManager: jest.fn().mockImplementation(() => ({ ...mockStateInstance })),
}));

// Mock optional dependencies to not load
jest.mock('../../.aexos-core/infrastructure/scripts/recovery-tracker', () => {
...
const {
  ...
  SubtaskResult,
  DEFAULT_CONFIG,
} = require('../../.aexos-core/core/execution/autonomous-build-loop');

const { BuildStateManager } = require('../../.aexos-core/core/execution/build-state-manager');
