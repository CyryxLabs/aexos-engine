...
const { DashboardEmitter, getDashboardEmitter } = require('../../../.aexos-core/core/events/dashboard-emitter');
const { DashboardEventType } = require('../../../.aexos-core/core/events/types');
...
describe('DashboardEmitter Bob-specific methods', () => {
  ...
  beforeEach(async () => {
    ...
    emitter.fallbackPath = path.join(tempDir, '.aexos', 'dashboard', 'events.jsonl');
  });
