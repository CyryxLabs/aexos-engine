...
const { validateUserProfile } = require('../../.aexos-core/infrastructure/scripts/validate-user-profile');
...
describe('validate-user-profile standalone', () => {
  ...
  const actualValidateUserProfile = jest.requireActual(
    '../../.aexos-core/infrastructure/scripts/validate-user-profile',
  ).validateUserProfile;
