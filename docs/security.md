...
We take security seriously at CyryxLabs. If you discover a security vulnerability in AEXOS, please report it responsibly.
...
1. **GitHub Security Advisories** (Preferred)
   - Go to [Security Advisories](https://github.com/CyryxLabs/AEXOS/security/advisories)
   - Click "Report a vulnerability"
   - Fill out the form with details

2. **GitHub Issues (Private)**
   - Open a [private security advisory](https://github.com/CyryxLabs/AEXOS/security/advisories)
...
When using AEXOS Framework, we recommend:
...
AEXOS Framework executes AI-generated code and commands. Users should:
...
- AEXOS may process sensitive data through AI providers
...
- [GitHub Security Advisories](https://github.com/CyryxLabs/AEXOS/security/advisories)
