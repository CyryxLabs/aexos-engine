# AEXOS Framework Documentation

**Status:** Official Framework Standards
**Created:** 2025-01-16 (Story 6.1.2.6)
**Migration Target:** Q2 2026 → `CyryxLabs/AEXOS` repository

---

## 📋 Overview

This directory contains **official AEXOS framework documentation** that defines standards, patterns, and structures applicable across all AEXOS projects (greenfield and brownfield).
...
| [**epics/core-super-update/**](epics/core-super-update/EPIC-CORE-SUPER-UPDATE.md) | Public epic: harvest hub/enterprise into OSS core (no workspace product) | Architects, maintainers |

---

## 🔄 Migration Notice

**⚠️ IMPORTANT**: These documents are now in the `CyryxLabs/AEXOS` repository. The migration from the old `cyryx/aexos-core` org was completed in December 2024 as part of OSR-9 (Architecture Core).

### Migration Timeline

- **Phase 1 (Q1 2026 - Story 6.1.2.6):** ✅ Framework docs separated into `docs/framework/`
- **Phase 2 (Q4 2024):** ✅ Repository migrated to `CyryxLabs/AEXOS` (OSR-9)
...
- **Scope**: Portable across all AEXOS projects
- **Examples**: Coding standards, tech stack, source tree structure
- **Lifecycle**: Lives in `CyryxLabs/AEXOS` repository
...
### For Developers
1. **Read framework docs during onboarding** - Understand AEXOS standards
...
### For AEXOS Framework Maintainers
...
**Maintainer**: AEXOS Framework Team
