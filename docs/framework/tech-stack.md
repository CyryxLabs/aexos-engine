...
**Migration Notice:** This document will migrate to `CyryxLabs/AEXOS` repository in Q2 2026 (see Decision 005)
...
AEXOS is built on modern JavaScript/TypeScript with Node.js runtime, optimized for cross-platform CLI development with interactive UX and agent orchestration capabilities.
...
AEXOS integrates with Model Context Protocol (MCP) servers:
...
| ------- | ---------- | ---------------------------------------------------------------------------------------- | ---------------- |
| 1.0     | 2025-01-15 | Initial tech stack documentation                                                         | Vega (architect) |
| 1.1     | 2025-12-14 | Updated migration notice to CyryxLabs/AEXOS, semantic-release to v25.0.2 [Story 6.10] | Vulcan (dev)        |

---

_This is an official AEXOS framework standard. All technology choices must align with this stack._
