...
## File counts (`.aexos-core` files, this machine)

| Tree | Count (approx) |
|------|----------------|
| aexos-core (this branch) | ~1208 |
| sinkra-hub | 1272 |
| CYRYX-enterprise | 1192 |

## Confirmed

- Package OSS: `@aexos-squads/core` 5.2.9  
...
OSS lean SDC skills + `aexos sdc`/`wave` exist. Future skill enrichment: **read enterprise full-sdc (468)** before hub (2209).
...
**AEXOS super-UPDATE** remains the active program. lendario-lms app-code notes are separate; governance/DB resume only on explicit ask.
