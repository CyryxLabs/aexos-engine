...
2. `aexos install` on win32 under npx prints non-blocking hint.  
...
- `.aexos-core/core/install/windows-npx-hint.js`
- `.aexos-core/core/doctor/checks/windows-npx-install.js`
- `.aexos-core/core/doctor/checks/index.js`
- `.aexos-core/development/tasks/health-check.yaml`
- `bin/aexos.js`
- `docs/npx-install.md`
