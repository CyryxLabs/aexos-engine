...
- [x] Guards added under `.aexos-core/core/permissions/`
...
|------|---------|-------------|--------|
| 2026-07-09 | audit | Retrospective lifecycle baseline: Done status and guard/test evidence verified; missing historical transitions were not fabricated. | Vulcan (@dev) |
