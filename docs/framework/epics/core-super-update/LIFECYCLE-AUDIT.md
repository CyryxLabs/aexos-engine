...
- Projected skills are generated from `.aexos-core/development/skills/` and must
...
**Audit status:** final — verdict `PASS`; reviewer `Argus (Test Architect)`;
...
implementation in `.aexos-core/core/sdc/progress.js` and projection sources in
