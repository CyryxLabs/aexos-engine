# AEXOS Source Tree Structure

**Version:** 4.0.0
**Last Updated:** 2026-02-11
**Status:** Official Framework Standard
**Repository:** CyryxLabs/AEXOS
...
- [Framework Core (.aexos-core/)](#framework-core-aexos-core)
...
AEXOS uses a **modular architecture** with clear separation of concerns:

1. **Framework Core** (`.aexos-core/`) - Portable framework components organized by domain
...
├── .aexos-core/                        # Framework core (modular)
...
│
├── data/                              # Shared Data
│   ├── aexos-kb.md                     # AEXOS knowledge base (@aexos-master, lazy-loaded)
...
│   │   ├── aexos-master.md             # Master orchestrator
...
```yaml
Agents:
  Location: .aexos-core/development/agents/
  Format: Markdown with YAML frontmatter
  Naming: {agent-name}.md (kebab-case)
  Example: dev.md, qa.md, architect.md

Tasks:
  Location: .aexos-core/development/tasks/
...
Workflows:
  Location: .aexos-core/development/workflows/
  Format: YAML
...
### Shared Data Files (.aexos-core/data/)

| File | Owner | Fill Rule | Update Trigger | Used By |
|------|-------|-----------|----------------|---------|
| `aexos-kb.md` | @aexos-master | Updated on major framework changes | Manual edit | @aexos-master (lazy) |
...
### Product Data Files (.aexos-core/product/data/)
...
Squads are modular extensions that add specialized capabilities to AEXOS. Unlike the deprecated Squads, Squads follow a standardized template structure.
...
### REPO 1: CyryxLabs/AEXOS (MIT)

```
aexos-core/
├── .aexos-core/                        # Framework assets (modular v2.0)
│   ├── cli/                           # CLI commands and utilities
│   ├── core/                          # Framework essentials
│   │   ├── config/                    # Configuration system
...
### REPO 2: CyryxLabs/squads (MIT)

```
squads/
├── verified/                          # AEXOS-curated squads
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
### REPO 3: CyryxLabs/mcp-ecosystem (Apache 2.0)
...
### REPO 4: CyryxLabs/certified-partners (Private)
...
### REPO 5: CyryxLabs/mmos (Private + NDA)
...
Location: .aexos-core/development/agents/{agent-name}.md
Example: .aexos-core/development/agents/security-expert.md

# I'm creating a new task:
Location: .aexos-core/development/tasks/{task-name}.md
Example: .aexos-core/development/tasks/deploy-to-production.md

# I'm creating a new workflow:
Location: .aexos-core/development/workflows/{workflow-name}.yaml
Example: .aexos-core/development/workflows/continuous-deployment.yaml

# I'm creating a new template:
Location: .aexos-core/product/templates/{template-name}-tmpl.{yaml|md}
Example: .aexos-core/product/templates/deployment-plan-tmpl.yaml

# I'm creating a new checklist:
Location: .aexos-core/product/checklists/{checklist-name}-checklist.md
Example: .aexos-core/product/checklists/security-review-checklist.md

# I'm creating a CLI command:
Location: .aexos-core/cli/commands/{category}/{command-name}.js
Example: .aexos-core/cli/commands/generate/workflow.js

# I'm creating a core utility:
Location: .aexos-core/core/utils/{utility-name}.js
Example: .aexos-core/core/utils/performance-monitor.js

# I'm creating an infrastructure script:
Location: .aexos-core/infrastructure/scripts/{category}/{script-name}.js
Example: .aexos-core/infrastructure/scripts/llm-routing/router.js

# I'm adding a PM tool adapter:
Location: .aexos-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Example: .aexos-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
The ADE is configured via `.aexos-core/core-config.yaml`:
...
ade:
  ...
  memoryLayer:
    enabled: true
    patternStore: .aexos/patterns/
```

### ADE Runtime State

Runtime state is persisted in `.aexos/`:
...
| ------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| 1.0     | 2025-01-15 | Initial source tree documentation                                                                                                                                  | Vega (architect) |
| 1.1     | 2025-12-14 | Updated org to CyryxLabs, replaced Squads with Squads system [Story 6.10]                                                                                           | Vulcan (dev)        |
| 2.0     | 2025-12-15 | Major update to reflect modular architecture (cli/, core/, development/, infrastructure/, product/) [Story 6.13]                                                   | Themis (PO)         |
| 3.0     | 2026-01-29 | Added ADE (Autonomous Development Engine) section documenting Epics 1-7: workflow-intelligence, ADE scripts, workflows, tasks, and runtime state [ADE Integration] | Vega (architect) |
| 3.1     | 2026-02-06 | Added Data File Governance section: documented 7 missing data files with owner, fill rule, and update trigger. Expanded .aexos-core/data/ and product/data/ tree listings. [Story ACT-8] | Vulcan (dev) |

---

_This is an official AEXOS framework standard. All file placement must follow this structure._
