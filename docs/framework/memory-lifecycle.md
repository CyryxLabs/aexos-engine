...
|---|---|---|---|
| Constitution | Framework | L1 | Generated by installer, references `.aexos-core/constitution.md` |
...
| Sistema de Agentes | Framework | L2 | Agent definitions from `.aexos-core/development/agents/` |
...
- `<!-- FRAMEWORK-OWNED: Generated by AEXOS installer, do not customize -->` for L1/L2 sections
...
Use `.aexos-core/development/checklists/memory-audit-checklist.md` periodically to:
