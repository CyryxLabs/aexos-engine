...
AEXOS (Agentic eXecution & Orchestration System) is proprietary software of Cyryx Labs LLC. This privacy policy explains how we handle any data that may be collected when you use AEXOS.

## Data Collection

### What We Don't Collect

AEXOS does **NOT** collect:
...
AEXOS uses a **consent-based telemetry system**. The system is designed as follows:
...
```javascript
const cyryx = new CYRYX({
  telemetry: { enabled: false },
});
```

You can also revoke consent at any time through the consent management interface or by deleting the `.aexos/telemetry/` directory.

## Local Data Storage

AEXOS stores some data locally on your machine:

- Configuration files (`.aexos/`, `.aexos-core/`)
- Project status cache (`.aexos/project-status.yaml`)
...
When using AEXOS, you may interact with third-party services:
...
**Important:** Your interactions with these services are governed by their respective privacy policies. AEXOS does not control or have access to data you share with these services.
...
- **Delete** all local data by removing the `.aexos/` and `.ai/` directories
...
AEXOS is proprietary software, but its source is published for inspection so you
can verify these claims yourself. Readability does not grant a licence — see
[LICENSE](../../LICENSE).

- Repository: [github.com/CyryxLabs/AEXOS](https://github.com/CyryxLabs/AEXOS)
- No hidden data collection mechanisms
- All configuration options are documented

## Children's Privacy

AEXOS is a development tool intended for professional use. We do not knowingly collect any information from children under 13 years of age.
...
- API keys and credentials are never stored by AEXOS (users manage their own)
- Regular security audits of the codebase

For security vulnerabilities, please [open an issue](https://github.com/CyryxLabs/AEXOS/issues) or email security@cyryxlabs.com.

## Contact

For privacy concerns or questions:

- **GitHub Issues:** [Open an issue](https://github.com/CyryxLabs/AEXOS/issues)
...
**Copyright (c) 2026 Cyryx Labs LLC. All rights reserved.**
