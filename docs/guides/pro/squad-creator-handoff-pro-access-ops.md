...
Convert the validated AEXOS Pro access grant procedure into a reusable task/workflow pair so DevOps can execute it repeatedly without rediscovering:
...
2. `docs/aexos-workflows/pro-access-grant-workflow.md`
3. `.aexos-core/development/tasks/devops-pro-access-grant.md`
