...
Introduction to AEXOS Squads - modular teams of AI agents that extend framework functionality.
...
Squads are modular teams of AI agents that extend AEXOS functionality for specific domains or use cases. Each squad is a self-contained package that can be installed, shared, and composed with other squads.

> **AEXOS Squads:** AI agent teams working with you
...
| Traditional Agents   | AEXOS Squads                |
| -------------------- | -------------------------- |
...
| ----------------- | ------- | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Data collection and transformation | [aexos-squads/etl](https://github.com/CyryxLabs/aexos-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Content generation utilities       | [aexos-squads/creator](https://github.com/CyryxLabs/aexos-squads/tree/main/creator) |
...
│  Level 2: CYRYX-SQUADS  --> github.com/CyryxLabs (Public)     │
...
- **Explore Official Squads:** Check [aexos-squads repository](https://github.com/CyryxLabs/aexos-squads)
- **Contribute:** See [Contributing Squads Guide](./contributing-squads.md)
- **Learn Task Format:** Read [TASK-FORMAT-SPECIFICATION-V1](../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Task Format Specification](../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_CYRYX Squads: AI agent teams working with you_
