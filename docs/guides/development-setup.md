...
| Tool                 | Purpose                                 |
| -------------------- | --------------------------------------- |
| **Claude Code**      | AI-powered development with AEXOS agents |
| **VS Code / Cursor** | IDE with AEXOS integration               |
...
1. Navigate to [github.com/CyryxLabs/AEXOS](https://github.com/CyryxLabs/AEXOS)
...
# Verify remotes
git remote -v
# origin    https://github.com/YOUR_USERNAME/aexos-core.git (fetch)
# origin    https://github.com/YOUR_USERNAME/aexos-core.git (push)
# upstream  https://github.com/CyryxLabs/AEXOS.git (fetch)
# upstream  https://github.com/CyryxLabs/AEXOS.git (push)
```
...
AEXOS_API_TOKEN=your-aexos-token
```
...
Understanding the `aexos-core` directory structure:

```
aexos-core/
├── .aexos-core/                    # Framework source (committed)
...
│   ├── commands/AEXOS/agents/      # Agent skill commands
│   ├── hooks/                     # Governance hooks
│   └── rules/                     # AI behavior rules
│
├── bin/                           # CLI entry points
│   ├── aexos.js                    # Main CLI
│   └── aexos-minimal.js            # Minimal CLI
│
...
| ----------------------------------- | ---------------------------- | ----------------------- |
| `.aexos-core/development/agents/`    | Agent personas and behaviors | Adding/modifying agents |
| `.aexos-core/development/tasks/`     | Executable task workflows    | Adding/modifying tasks  |
| `.aexos-core/development/workflows/` | Multi-step orchestrations    | Creating workflows      |
...
Create a new file in `.aexos-core/development/agents/`:

```bash
# File: .aexos-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Create in .aexos-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Create in .aexos-core/development/checklists/
  tools:
    - git
    - context7
````
...
Create a new file in `.aexos-core/development/tasks/`:
...
# Examples:
# .aexos-core/development/tasks/dev-build-component.md  (dev agent)
# .aexos-core/development/tasks/create-doc.md          (shared)
```
...
Create a new file in `.aexos-core/development/workflows/`:

```bash
# File: .aexos-core/development/workflows/my-workflow.yaml
```
...
- **GitHub Discussions:** [github.com/CyryxLabs/AEXOS/discussions](https://github.com/CyryxLabs/AEXOS/discussions)
- **Issue Tracker:** [github.com/CyryxLabs/AEXOS/issues](https://github.com/CyryxLabs/AEXOS/issues)
...
- Tag `@CyryxLabs/core-team` for urgent issues
