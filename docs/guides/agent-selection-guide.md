...
| ---------------------------- | ---- | ------------------------------------------------------------------------------------------- | ---------------------------------------- |
| **@analyst** (Sirius)         | 🔍   | Market research, competitive analysis, brainstorming, pattern extraction                    | PRD creation, architecture, stories      |
| **@pm** (Janus)             | 📋   | PRD, epics, product strategy, requirements gathering, spec writing                          | Research, architecture, detailed stories |
| **@architect** (Vega)        | 🏛️   | System architecture, API design, tech stack, complexity assessment, implementation planning | Research, PRD, database schema           |
| **@data-engineer** (Ceres)    | 📊   | Database schema, RLS, migrations, query optimization                                        | App architecture, DB tech selection      |
| **@sm** (Chronos)              | 🌊   | User stories, sprint planning, backlog grooming                                             | PRD, epics, research, implementation     |
| **@dev** (Vulcan)               | 💻   | Story implementation, coding, testing, subtask execution, recovery                          | Story creation, deployment               |
| **@qa** (Argus)              | 🧪   | Code review, testing, quality assurance, spec critique, structured review                   | Implementation                           |
| **@po** (Themis)                | 🎯   | Backlog management, acceptance criteria, prioritization                                     | Epic creation, architecture              |
| **@ux-design-expert** (Nova) | 🎨   | UI/UX design, wireframes, design systems                                                    | Implementation                           |
| **@devops** (Polaris)           | ⚙️   | Git ops, PR creation, deployment, CI/CD, worktree management, migrations                    | Local Git, implementation                |
| **@aexos-master** (Zeus)     | 👑   | Framework development, multi-agent orchestration                                            | Routine tasks (use specialized agents)   |

---

## 🤖 ADE Commands by Agent (v2.2.0)

### @devops (Polaris) - Infrastructure & Operations
...
### @architect (Vega) - System Architecture
...
### @analyst (Sirius) - Research & Analysis
...
| `*list-gotchas` | List known gotchas from .aexos/gotchas.md |
