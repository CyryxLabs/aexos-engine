...
> **Note:** 1MCP documentation has been deprecated. AEXOS now uses Docker MCP Toolkit exclusively (Story 5.11). Archived docs available in `.github/deprecated-docs/guides/`.
...
- [AEXOS Pro Access](./aexos-pro-access.md)
