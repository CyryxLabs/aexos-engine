...
**Applicable Agents:** @qa (Argus), @devops (Polaris)
...
## AEXOS Integration Overview

In AEXOS, CodeRabbit is integrated into the Quality Gates system as part of **Layer 2: PR Automation**.
...
### AEXOS Agent Configuration

CodeRabbit is configured in agent definition files:

**Location:** `.aexos-core/development/agents/qa.md` and `devops.md`
...
coderabbit_integration:
  ...
  wsl_config:
    ...
    working_directory: /mnt/c/Users/.../aexos-core
```
...
# Direct command
wsl bash -c 'cd /mnt/c/.../aexos-core && ~/.local/bin/coderabbit --prompt-only --base main'
```
...
| Severity     | Description                               | AEXOS Action                      |
| ------------ | ----------------------------------------- | -------------------------------- |
...
## Integration with AEXOS Workflow
...
- [Quality Gates Specification](../../../.aexos-core/docs/standards/QUALITY-GATES-SPECIFICATION.md)
- [@qa Agent Definition](../../../.aexos-core/development/agents/qa.md)
- [@devops Agent Definition](../../../.aexos-core/development/agents/devops.md)
- [Pre-Push Quality Gate Task](../../../.aexos-core/development/tasks/github-devops-pre-push-quality-gate.md)
...
_Last Updated: 2026-01-28 | AEXOS Framework Team_
