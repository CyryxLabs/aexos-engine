# AEXOS Complete Cross-Reference Analysis

**Story:** CYRYX-XREF-001
**Generated:** 2026-02-05
**Owners:** @analyst (Sirius) + @architect (Vega)
...
This document is the result of a comprehensive cross-reference analysis of every artifact in the AEXOS framework. The analysis was conducted in 7 phases, examining 25 entity types totaling approximately 745 tracked files.
...
|-------------|-------|----------|
| Agents | 12 | `.aexos-core/development/agents/` |
| Tasks | 191 | `.aexos-core/development/tasks/` |
| Workflows | 12 | `.aexos-core/development/workflows/` |
| Product Templates | 92 | `.aexos-core/product/templates/` |
| Development Templates | 29 | `.aexos-core/development/templates/` |
| Product Checklists | 16 | `.aexos-core/product/checklists/` |
| Product Data | 16 | `.aexos-core/product/data/` |
| Framework Data | 8 | `.aexos-core/data/` |
| Dev Scripts | 37 | `.aexos-core/development/scripts/` |
| Infra Scripts | 90 | `.aexos-core/infrastructure/scripts/` |
| Infra Integrations | 5 | `.aexos-core/infrastructure/integrations/` |
| Infra Tools | 15 | `.aexos-core/infrastructure/tools/` |
| Infra Templates | 15 | `.aexos-core/infrastructure/templates/` |
| Core Modules | 130 | `.aexos-core/core/` |
| CLI Commands | 37 | `.aexos-core/cli/commands/` |
| Schemas | 6 | `.aexos-core/schemas/` |
| Manifests | 4 | `.aexos-core/manifests/` |
| Monitor Hooks | 10 | `.aexos-core/monitor/hooks/` |
| Quality Gates | 10 | `.aexos-core/core/quality-gates/` |
| Quality Metrics | 4 | `.aexos-core/quality/` |
| Workflow Intelligence | 19 | `.aexos-core/workflow-intelligence/` |
| Docs/Standards | 16 | `.aexos-core/docs/standards/` |
| Root Config | 8 | `.aexos-core/` root |
| Elicitation | 8 | `.aexos-core/core/elicitation/` + `.aexos-core/elicitation/` |
| **TOTAL** | **~745** | |
...
### 3.1 @dev (Vulcan) - Full Stack Developer
...
### 3.6 @architect (Vega) - Holistic System Architect
...
### 3.7 @analyst (Sirius) - Business Analyst
...
### 3.8 @devops (Polaris) - DevOps Specialist
...
### 3.9 @data-engineer (Ceres) - Database Architect
...
### 3.10 @ux-design-expert (Iris) - UX/UI Designer
...
### 3.11 @aexos-master (Zeus) - Meta Orchestrator
...
| File | Location |
|------|----------|
| `AEXOS-LIVRO-DE-OURO.md` | `docs/standards/` |
| `AEXOS-LIVRO-DE-OURO-V2.1.md` | `docs/standards/` |
| `AEXOS-LIVRO-DE-OURO-V2.1-SUMMARY.md` | `docs/standards/` |
| `CYRYX-FRAMEWORK-MASTER.md` | `docs/standards/` |
...
|-----------|--------|---------------|
| `.aexos-core/agent-teams/` | Does not exist | install-manifest, source-tree docs, core-architecture |
| `.aexos-core/tools/` | Exists but empty | core-config.yaml, framework-config.yaml |
| `.aexos-core/processes/` | Does not exist | Not referenced |
...
- **infrastructure/** has ZERO dependencies on other AEXOS modules
...
10. **Populate or remove `.aexos-core/tools/`** -- Currently empty despite config references.
