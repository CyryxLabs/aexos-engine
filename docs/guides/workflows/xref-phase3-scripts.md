...
> **Scope:** `.aexos-core/development/scripts/` (38 files)
...
| 26 | `workflow-validator.js` | Validates workflow YAML files against AEXOS conventions (9 checks) | `fs.promises`, `path`, `js-yaml` | 18 files: `validate-workflow.md`, `squad-validator.js`, tasks | @qa, @architect | No |
...
| S6 | `squad-migrator.js` | Migrates legacy squad formats to AEXOS 2.1 standard (SQS-7) | `fs.promises`, `path`, `js-yaml` | `index.js`, `squad-creator-migrate.md`, tests | @squad-creator | No |
| S7 | `squad-downloader.js` | Downloads squads from aexos-squads GitHub repository (SQS-6) | `https`, `fs.promises`, `path` | `index.js`, `squad-creator-download.md`, tests | @squad-creator | No |
| S8 | `squad-publisher.js` | Publishes squads to aexos-squads GitHub repo via PR (SQS-6) | `child_process`, `fs.promises`, `path` | `index.js`, `squad-creator-publish.md`, tests | @squad-creator | No |
...
The AEXOS greeting system generates contextual, session-aware greetings when agents are activated. It consists of **8 greeting-related files** in the development scripts directory plus supporting infrastructure.
...
| `.aexos-core/product/templates/activation-instructions-inline-greeting.yaml` | Template | ~64 | YAML template for inline greeting logic in agent files |
| `.claude/commands/greet.md` | Slash Command | ~102 | `/greet` slash command definition for Claude Code |

**External copies (in `.claude/commands/AEXOS/scripts/`):**
| File | Purpose |
|------|---------|
...
The preference is stored in `.aexos-core/core-config.yaml` under `agentIdentity.greeting.preference`.
...
Used by: @dev, @qa, @architect, @pm, @po, @sm, @analyst, @aexos-master, @squad-creator

```yaml
activation-instructions:
  - STEP 3: |
      Build intelligent greeting using .aexos-core/development/scripts/greeting-builder.js
...
|-------|------|-----------|--------|------------------------|
| @dev (Vulcan) | `\U0001f4bb` | Builder | Aquarius | "Vulcan the Builder ready to construct excellence!" |
| @qa (Argus) | `\U0001f6e1\ufe0f` | Guardian | Virgo | "Argus the Guardian ready!" |
| @po (Themis) | `\u2696\ufe0f` | Balancer | Libra | "Themis the Balancer ready!" |
...
| @aexos-master | `\U0001f9e0` | Orchestrator | Leo | "AEXOS Master Orchestrator ready!" |
...
```
greeting-builder.js
  |-- context-detector.js          (.aexos-core/core/session/)
  |-- git-config-detector.js       (.aexos-core/infrastructure/scripts/)
  |-- workflow-navigator.js        (sibling in development/scripts/)
  |-- greeting-preference-manager.js (sibling)
  |-- project-status-loader.js     (.aexos-core/infrastructure/scripts/)
  |-- PermissionMode               (.aexos-core/core/permissions/)
  |-- js-yaml
  |-- fs, path

generate-greeting.js
  |-- greeting-builder.js          (sibling)
  |-- session-context-loader.js    (.aexos-core/scripts/)
  |-- project-status-loader.js     (.aexos-core/infrastructure/scripts/)
...
| @aexos-master | greeting-builder, agent-config-loader | 2 |
...
```
C:\Users\AllFluence-User\Workspaces\AEXOS\CyryxLabs\aexos-core\.aexos-core\development\scripts\
```

Full absolute paths for top-level scripts:
```
.aexos-core/development/scripts/agent-assignment-resolver.js
.aexos-core/development/scripts/agent-config-loader.js
.aexos-core/development/scripts/agent-exit-hooks.js
.aexos-core/development/scripts/apply-inline-greeting-all-agents.js
.aexos-core/development/scripts/audit-agent-config.js
.aexos-core/development/scripts/backlog-manager.js
.aexos-core/development/scripts/batch-update-agents-session-context.js
.aexos-core/development/scripts/decision-context.js
.aexos-core/development/scripts/decision-log-generator.js
.aexos-core/development/scripts/decision-log-indexer.js
.aexos-core/development/scripts/decision-recorder.js
.aexos-core/development/scripts/dev-context-loader.js
.aexos-core/development/scripts/generate-greeting.js
.aexos-core/development/scripts/greeting-builder.js
.aexos-core/development/scripts/greeting-config-cli.js
.aexos-core/development/scripts/greeting-preference-manager.js
.aexos-core/development/scripts/migrate-task-to-v2.js
.aexos-core/development/scripts/story-index-generator.js
.aexos-core/development/scripts/story-manager.js
.aexos-core/development/scripts/story-update-hook.js
.aexos-core/development/scripts/task-identifier-resolver.js
.aexos-core/development/scripts/test-greeting-system.js
.aexos-core/development/scripts/validate-task-v2.js
.aexos-core/development/scripts/verify-workflow-gaps.js
.aexos-core/development/scripts/workflow-navigator.js
.aexos-core/development/scripts/workflow-state-manager.js
.aexos-core/development/scripts/workflow-validator.js
```
...
*Cross-Reference Phase 3 Analysis - AEXOS Framework*
*Generated: 2026-02-05*
