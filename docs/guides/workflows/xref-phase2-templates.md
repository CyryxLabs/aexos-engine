...
**Scope:** All templates, checklists, and data files in `.aexos-core/` mapped to consuming tasks, agents, and workflows.
...
15. [Framework Data Files (.aexos-core/data/)](#15-framework-data-files)
...
Location: `.aexos-core/product/templates/`
...
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `architecture-tmpl.yaml` | create-doc | architect, aexos-master | greenfield-service (architecture step) | No |
| 2 | `brainstorming-output-tmpl.yaml` | analyst-facilitate-brainstorming | analyst, aexos-master | -- | No |
| 3 | `brownfield-architecture-tmpl.yaml` | create-doc | architect, aexos-master | brownfield-ui, brownfield-service, brownfield-fullstack | No |
| 4 | `brownfield-prd-tmpl.yaml` | create-doc | pm, aexos-master | brownfield-ui, brownfield-service, brownfield-fullstack | No |
| 5 | `competitor-analysis-tmpl.yaml` | create-doc | analyst, aexos-master | -- | No |
| 6 | `design-story-tmpl.yaml` | create-doc (implicit) | -- | -- | **WEAK** |
| 7 | `front-end-architecture-tmpl.yaml` | create-doc | architect, aexos-master, ux-design-expert | greenfield-ui, greenfield-fullstack | No |
| 8 | `front-end-spec-tmpl.yaml` | create-doc | ux-design-expert, aexos-master | greenfield-ui, greenfield-fullstack, brownfield-ui | No |
| 9 | `fullstack-architecture-tmpl.yaml` | create-doc | architect, aexos-master | greenfield-fullstack | No |
| 10 | `index-strategy-tmpl.yaml` | create-doc | data-engineer | -- | No |
| 11 | `market-research-tmpl.yaml` | create-doc | analyst, aexos-master | -- | No |
| 12 | `migration-plan-tmpl.yaml` | create-doc | data-engineer | -- | No |
| 13 | `prd-tmpl.yaml` | create-doc | pm, aexos-master | greenfield-ui, greenfield-service, greenfield-fullstack (implicit) | No |
| 14 | `project-brief-tmpl.yaml` | create-doc | analyst, aexos-master | -- | No |
...
| 19 | `story-tmpl.yaml` | create-doc, create-next-story, sm-create-next-story, dev-validate-next-story, validate-next-story | po, sm, qa, aexos-master | story-development-cycle (implicit) | No |
...
| 8 | `task.hbs` | create-doc (via template engine) | aexos-master (implicit) | -- | **WEAK** |
...
Location: `.aexos-core/product/templates/ide-rules/`
...
| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `personalized-agent-template.md` | create-doc (implicit), modify-agent | aexos-master (implicit) | -- | No |
...
| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `agent-template.yaml` | modify-agent, create-doc | aexos-master | -- | No |
| 2 | `task-template.md` | create-task (implicit), squad-creator-extend | aexos-master | -- | No |
| 3 | `workflow-template.yaml` | squad-creator-extend, verify-workflow-gaps (script) | aexos-master | -- | No |
...
Location: `.aexos-core/product/templates/engine/`
...
Location: `.aexos-core/development/templates/squad/`
...
Location: `.aexos-core/development/templates/service-template/`
...
Location: `.aexos-core/development/templates/squad-template/`
...
Location: `.aexos-core/development/templates/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `aexos-doc-template.md` | create-doc (implicit) | -- | -- | **WEAK** |
| 2 | `subagent-step-prompt.md` | run-workflow-engine | aexos-master | -- | No |

---

## 13. Product Checklists

Location: `.aexos-core/product/checklists/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `architect-checklist.md` | execute-checklist, analyze-cross-artifact | architect, aexos-master | -- | No |
| 2 | `change-checklist.md` | correct-course, modify-agent, modify-task, modify-workflow, update-manifest, qa-review-proposal, propose-modification, brownfield-create-epic | pm, po, aexos-master | -- | No |
| 3 | `pm-checklist.md` | execute-checklist (via prd-tmpl.yaml), analyze-cross-artifact | pm, aexos-master | -- | No |
| 4 | `po-master-checklist.md` | execute-checklist, validate-next-story, create-next-story, sm-create-next-story, create-brownfield-story, brownfield-create-story, brownfield-create-epic, qa-trace-requirements, dev-validate-next-story, po-sync-story-to-clickup, po-pull-story-from-clickup | po, aexos-master | greenfield-ui, greenfield-service, greenfield-fullstack, brownfield-ui, brownfield-service, brownfield-fullstack | No |
| 5 | `story-dod-checklist.md` | execute-checklist, dev-develop-story, analyze-cross-artifact, build-autonomous | dev, aexos-master | story-development-cycle (implicit) | No |
| 6 | `story-draft-checklist.md` | create-next-story, sm-create-next-story, analyze-cross-artifact | sm, aexos-master | -- | No |
...
Location: `.aexos-core/product/data/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `brainstorming-techniques.md` | analyst-facilitate-brainstorming | analyst, aexos-master | -- | No |
| 2 | `elicitation-methods.md` | advanced-elicitation, create-doc | aexos-master | -- | No |
...
Location: `.aexos-core/data/`

| # | File | Consuming Task(s) | Consuming Agent(s) | Workflow(s) | Orphan? |
|---|------|--------------------|---------------------|-------------|---------|
| 1 | `aexos-kb.md` | -- (knowledge base) | analyst, aexos-master | greenfield-ui, greenfield-service, greenfield-fullstack, brownfield-ui, brownfield-service, brownfield-fullstack | No |
...
| 6 | `technical-preferences.md` | qa-nfr-assess, qa-review-story, spec-research-dependencies | architect, pm, qa, ux-design-expert, aexos-master | -- | No |
...
- **WEAK (27 files):** Referenced only in passive registries (install-manifest, service-registry, workers.csv, documentation) but not actively consumed by any task execution path. These include:
  ...
  - IDE rules (deployed to target projects, not consumed by AEXOS agents)
...
These files exist in `.aexos-core/product/templates/` and are listed in the install-manifest, but are not referenced by any task, agent, workflow, or script:
...
- **IDE rules (7):** Output artifacts for target projects. Consumed externally, not by AEXOS tasks.
...
The `create-doc.md` task is the primary template consumer. It dynamically loads templates from `.aexos-core/product/templates/` based on user selection at runtime. The following templates are consumable through `create-doc`:
