...
|-------|-----|------|--------|-------------------|
| @architect | architect | Vega | Holistic System Architect | Analise inicial e arquitetura brownfield |
| @pm | pm | Janus | Product Manager | Criacao do PRD brownfield |
| @ux-expert | ux-design-expert | Iris | UX/UI Designer | Especificacao frontend |
| @po | po | Themis | Product Owner | Validacao, fragmentacao, retrospectiva |
| @sm | sm | Chronos | Scrum Master | Criacao de stories |
| @analyst | analyst | Sirius | Business Analyst | Revisao de stories (opcional) |
| @dev | dev | Vulcan | Full Stack Developer | Implementacao |
| @qa | qa | Argus | Test Architect | Revisao de qualidade (opcional) |
