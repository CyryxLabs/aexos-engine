# @data-engineer (Ceres) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.aexos-core/development/agents/data-engineer.md`
...
|-------|------|--------|---------|
| 1 | `.aexos-core/development/agents/data-engineer.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.aexos-core/core-config.yaml` | generate-greeting.js (CLI wrapper) | Core configuration |
| 3 | `.aexos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, etlLocation |
...
| 6 | `.aexos/session-state.json` | SessionContextLoader.loadContext() | Session type detection (CLI wrapper pre-loads) |
...
> to GreetingBuilder. See `.aexos-core/development/scripts/generate-greeting.js`.
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `📊 Ceres the Sage ready to architect!` |
| Signature | `persona_profile.communication.signature_closing` | `— Ceres, arquitetando dados 🗄️` |
...
**Template:** `.aexos-core/development/templates/schema-design-tmpl.yaml` (MISSING)
...
| `.aexos-core/data/technical-preferences.md` | Data | Loaded at activation |
...
**Task file:** `.aexos-core/development/tasks/create-doc.md`
**Template:** `.aexos-core/development/templates/rls-policies-tmpl.yaml` (MISSING)
...
**Task file:** `.aexos-core/development/tasks/create-doc.md`
**Template:** `.aexos-core/development/templates/migration-plan-tmpl.yaml` (MISSING)
...
**Task file:** `.aexos-core/development/tasks/create-doc.md`
**Template:** `.aexos-core/development/templates/index-strategy-tmpl.yaml` (MISSING)
...
**Task file:** `.aexos-core/development/tasks/db-domain-modeling.md`
...
**Task file:** `.aexos-core/development/tasks/db-env-check.md`
...
**Task file:** `.aexos-core/development/tasks/db-bootstrap.md`
...
**Task file:** `.aexos-core/development/tasks/db-apply-migration.md`
...
**Task file:** `.aexos-core/development/tasks/db-dry-run.md`
...
**Task file:** `.aexos-core/development/tasks/db-seed.md`
...
**Task file:** `.aexos-core/development/tasks/db-snapshot.md`
...
**Task file:** `.aexos-core/development/tasks/db-rollback.md`
...
**Task file:** `.aexos-core/development/tasks/db-smoke-test.md`
...
**Task file:** `.aexos-core/development/tasks/security-audit.md`
...
**Task file:** `.aexos-core/development/tasks/analyze-performance.md`
...
**Task file:** `.aexos-core/development/tasks/db-policy-apply.md`
...
**Task file:** `.aexos-core/development/tasks/test-as-user.md`
...
**Task file:** `.aexos-core/development/tasks/db-verify-order.md`
...
**Task file:** `.aexos-core/development/tasks/db-load-csv.md`
...
**Task file:** `.aexos-core/development/tasks/db-run-sql.md`
...
**Task file:** `.aexos-core/development/tasks/setup-database.md`
...
flowchart TD
    ...
    B --> C[Resolve checklist from .aexos-core/development/checklists/]
...
**Task file:** `.aexos-core/development/tasks/create-deep-research-prompt.md`
