# @ux-design-expert (Iris) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.aexos-core/development/agents/ux-design-expert.md`
...
|-------|------|--------|---------|
| 1 | `.aexos-core/development/agents/ux-design-expert.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.aexos-core/core-config.yaml` | generate-greeting.js (fs.readFile + yaml.load) | Core configuration |
| 3 | `.aexos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, uxLocation |
| 4 | `.aexos-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.aexos/session-state.json` | SessionContextLoader.loadContext() | Session type detection (sessionType, previousAgent, lastCommands) |
| 6 | `.aexos/project-status.yaml` | loadProjectStatus() | Cached project status (60s TTL) |
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `🎨 Iris the Empathizer ready to empathize!` |
| Signature | `persona_profile.communication.signature_closing` | `— Iris, desenhando com empatia 💝` |
...
**Task file:** `.aexos-core/development/tasks/ux-user-research.md`
...
**Task file:** `.aexos-core/development/tasks/ux-create-wireframe.md`
...
**Task file:** `.aexos-core/development/tasks/generate-ai-frontend-prompt.md`
...
**Template:** `.aexos-core/product/templates/front-end-spec-tmpl.yaml`
...
**Task file:** `.aexos-core/development/tasks/audit-codebase.md`
...
**Task file:** `.aexos-core/development/tasks/consolidate-patterns.md`
...
**Task file:** `.aexos-core/development/tasks/generate-shock-report.md`
**Template:** `.aexos-core/product/templates/shock-report-tmpl.html`
...
**Task file:** `.aexos-core/development/tasks/extract-tokens.md`
**Template:** `.aexos-core/product/templates/tokens-schema-tmpl.yaml`
...
**Task file:** `.aexos-core/development/tasks/setup-design-system.md`
...
**Task file:** `.aexos-core/development/tasks/generate-migration-strategy.md`
**Template:** `.aexos-core/product/templates/migration-strategy-tmpl.md`
...
**Task file:** `.aexos-core/development/tasks/tailwind-upgrade.md`
...
**Task file:** `.aexos-core/development/tasks/audit-tailwind-config.md`
...
**Task file:** `.aexos-core/development/tasks/export-design-tokens-dtcg.md`
**Templates:** `.aexos-core/product/templates/token-exports-css-tmpl.css`, `.aexos-core/product/templates/token-exports-tailwind-tmpl.js`
...
**Task file:** `.aexos-core/development/tasks/bootstrap-shadcn-library.md`
...
**Task file:** `.aexos-core/development/tasks/build-component.md`
**Template:** `.aexos-core/product/templates/component-react-tmpl.tsx`
...
**Task file:** `.aexos-core/development/tasks/compose-molecule.md`
...
**Task file:** `.aexos-core/development/tasks/extend-pattern.md`
...
**Task file:** `.aexos-core/development/tasks/generate-documentation.md`
...
**Checklist file:** `.aexos-core/product/checklists/accessibility-wcag-checklist.md`
...
**Task file:** `.aexos-core/development/tasks/calculate-roi.md`
...
**Task file:** `.aexos-core/development/tasks/ux-ds-scan-artifact.md`
**Template:** `.aexos-core/product/templates/ds-artifact-analysis.md`
...
The agent definition references dependencies using short names (e.g., `.aexos-core/development/tasks/...`). The actual resolution paths are:

| Dependency Type | Agent Definition Path | Actual Disk Location |
|-----------------|----------------------|---------------------|
| Tasks | `.aexos-core/development/tasks/{name}` | `.aexos-core/development/tasks/{name}` |
| Templates | `.aexos-core/product/templates/{name}` | `.aexos-core/product/templates/{name}` |
| Checklists | `.aexos-core/product/checklists/{name}` | `.aexos-core/product/checklists/{name}` |
| Data | `.aexos-core/data/{name}` | `.aexos-core/data/{name}` or `.aexos-core/product/data/{name}` |

All 9 templates, all 4 checklists, and all 7 data files resolve correctly to files in `product/` directories. The `development/data/` directory does not exist; data files live under `.aexos-core/data/` and `.aexos-core/product/data/`.
...
**Template for state persistence:** `.aexos-core/product/templates/state-persistence-tmpl.yaml` (EXISTS)
