# @pm (Janus) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.aexos-core/development/agents/pm.md`
...
|-------|------|--------|---------|
| 1 | `.aexos-core/development/agents/pm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.aexos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.aexos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog |
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `📋 Janus the Strategist ready to strategize!` |
| Signature | `persona_profile.communication.signature_closing` | `— Janus, planejando o futuro 📊` |
...
|-----------|---------|--------|
| `correct-course.md` | Delegated to @aexos-master | EXISTS |
...
**Template:** `.aexos-core/development/templates/prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.aexos-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.aexos-core/development/tasks/create-doc.md`
**Template:** `.aexos-core/development/templates/brownfield-prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.aexos-core/product/templates/brownfield-prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.aexos-core/development/tasks/brownfield-create-epic.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-epic.md` | Task | EXISTS |
| `.aexos-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (epic structure) |
| `.aexos-core/product/checklists/pm-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.aexos-core/development/tasks/brownfield-create-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-story.md` | Task | EXISTS |
| `.aexos-core/product/templates/story-tmpl.yaml` | Template | EXISTS (in product/templates/) |
...
**Task file:** `.aexos-core/development/tasks/spec-gather-requirements.md`
...
**Task file:** `.aexos-core/development/tasks/spec-write-spec.md`
...
| @pm -> @aexos-master | Escalate | Course corrections via `*correct-course` |
| @pm -> @devops | Delegate | Git push operations, PR creation |
| @analyst -> @pm | Receives | Project brief for PRD creation |
| @aexos-master -> @pm | Receives | Framework modification requests |
...
| Module | Path | Status |
|--------|------|--------|
| TerminalSpawner | `.aexos-core/core/orchestration/terminal-spawner.js` | EXISTS |
| ExecutorAssignment | `.aexos-core/core/orchestration/executor-assignment.js` | EXISTS |
| PM Script | `.aexos-core/scripts/pm.sh` | EXISTS |
...
**Escalates to @aexos-master when:**
...
**Note:** All 9 task files referenced in dependencies exist in `.aexos-core/development/tasks/`. The 2 templates and 2 checklists are missing from `development/` but exist in `product/` as fallback locations.
