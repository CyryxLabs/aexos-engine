# @qa (Argus) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.aexos-core/development/agents/qa.md`
...
|-------|------|--------|---------|
| 1 | `.aexos-core/development/agents/qa.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.aexos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.aexos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: qaLocation, dataLocation, storyBacklog |
...
| 6 | `.aexos-core/product/data/test-levels-framework.md` | AgentConfigLoader.loadFile() | Test levels framework (always loaded, 8KB) |
| 7 | `.aexos-core/product/data/test-priorities-matrix.md` | AgentConfigLoader.loadFile() | Test priorities matrix (always loaded, 6KB) |
| 8 | `.aexos/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 9 | `.aexos/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
qa:
  ...
  files_loaded:
    - path: .aexos-core/data/technical-preferences.md
      lazy: false
      size: 15KB
    - path: .aexos-core/product/data/test-levels-framework.md
      lazy: false
      size: 8KB
    - path: .aexos-core/product/data/test-priorities-matrix.md
      lazy: false
      size: 6KB
  lazy_loading:
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `✅ Argus the Guardian ready to perfect!` |
| Signature | `persona_profile.communication.signature_closing` | `— Argus, guardiao da qualidade 🛡️` |
...
**Task file:** `.aexos-core/development/tasks/qa-run-tests.md`
...
**Task file:** `.aexos-core/development/tasks/qa-review-story.md`
...
| `.aexos-core/product/data/test-levels-framework.md` | Data | Loaded at activation |
| `.aexos-core/product/data/test-priorities-matrix.md` | Data | Loaded at activation |
...
**Task file:** `.aexos-core/development/tasks/qa-review-build.md`
...
**Task file:** `.aexos-core/development/tasks/qa-gate.md`
**Template:** `.aexos-core/product/templates/qa-gate-tmpl.yaml` (EXISTS in product/templates)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `qa-gate.md` | Task | EXISTS |
| `qa-gate-tmpl.yaml` | Template | EXISTS (in `.aexos-core/product/templates/`) |
| `docs/stories/{storyId}` | Input | Required |
...
**Task file:** `.aexos-core/development/tasks/qa-nfr-assess.md`
...
**Task file:** `.aexos-core/development/tasks/qa-risk-profile.md`
...
**Task file:** `.aexos-core/development/tasks/qa-create-fix-request.md`
...
**Task file:** `.aexos-core/development/tasks/qa-library-validation.md`
...
**Task file:** `.aexos-core/development/tasks/qa-security-checklist.md`
...
**Task file:** `.aexos-core/development/tasks/qa-migration-validation.md`
...
**Task file:** `.aexos-core/development/tasks/qa-evidence-requirements.md`
...
**Task file:** `.aexos-core/development/tasks/qa-false-positive-detection.md`
...
**Task file:** `.aexos-core/development/tasks/qa-browser-console-check.md`
...
**Task file:** `.aexos-core/development/tasks/qa-test-design.md`
...
**Task file:** `.aexos-core/development/tasks/qa-trace-requirements.md`
...
**Task file:** `.aexos-core/development/tasks/create-suite.md`
...
**Task file:** `.aexos-core/development/tasks/spec-critique.md`
...
**Task file:** `.aexos-core/development/tasks/manage-story-backlog.md` (MISSING)
...
| `qa-gate-tmpl.yaml` | Template | `*gate` (in `dependencies.templates`) | EXISTS in `.aexos-core/product/templates/` but NOT in `.aexos-core/development/templates/` per IDE-FILE-RESOLUTION |
| `story-tmpl.yaml` | Template | (in `dependencies.templates`) | EXISTS in `.aexos-core/product/templates/` but NOT in `.aexos-core/development/templates/` per IDE-FILE-RESOLUTION |
| `test-levels-framework.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.aexos-core/product/data/` (NOT in `.aexos-core/data/` where `dependencies.data` resolves) |
| `test-priorities-matrix.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.aexos-core/product/data/` (NOT in `.aexos-core/data/` where `dependencies.data` resolves) |

**Path Resolution Note:** The `IDE-FILE-RESOLUTION` rule in the agent definition maps `dependencies` to `.aexos-core/development/{type}/{name}`. However, 2 templates and 2 data files exist under `.aexos-core/product/` instead. The `agent-config-requirements.yaml` correctly references the full paths under `.aexos-core/product/data/`, but the agent definition's `dependencies` block uses short names that resolve to `.aexos-core/development/templates/` and `.aexos-core/development/data/` respectively, where these files do not exist. Actual runtime loading uses `agent-config-requirements.yaml` paths, so functionality is preserved.
