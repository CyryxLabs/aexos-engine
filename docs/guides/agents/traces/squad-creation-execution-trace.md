# @squad-creator (Arkantos) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.aexos-core/development/agents/squad-creator.md`
...
|-------|------|--------|---------|
| 1 | `.aexos-core/development/agents/squad-creator.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.aexos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.aexos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation (no squad-creator entry found) |
...
sequenceDiagram
    ...
    ACL-->>CC: { agent: { name: 'Arkantos', icon: '🏗️' }, commands: [...13], ... }
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `🏗️ Arkantos the Architect ready to create!` |
| Signature | `persona_profile.communication.signature_closing` | `— Arkantos, sempre estruturando 🏗️` |
...
| `*sync-squad-cyryx` | squad-creator-sync-aexos.md | full | No |
...
**Task file:** `.aexos-core/development/tasks/squad-creator-design.md`
...
**Task file:** `.aexos-core/development/tasks/squad-creator-create.md`
...
| `.aexos-core/development/templates/squad-template/` | Template scaffold | EXISTS |
...
**Task file:** `.aexos-core/development/tasks/squad-creator-validate.md`
...
**Task file:** `.aexos-core/development/tasks/squad-creator-list.md`
...
**Task file:** `.aexos-core/development/tasks/squad-creator-migrate.md`
...
flowchart TD
    ...
    C --> D["Detect: config.yaml, flat structure,<br/>missing cyryx.type, missing cyryx.minVersion"]
    D --> E{Needs migration?}
...
**Migration detections:** config.yaml (rename to squad.yaml), flat structure (create dirs), missing fields (cyryx.type, cyryx.minVersion, name, version)

---

### `*analyze-squad`

**Task file:** `.aexos-core/development/tasks/squad-creator-analyze.md`
...
**Task file:** `.aexos-core/development/tasks/squad-creator-extend.md`
...
| `squad-validator.js` | Script | EXISTS |
| `.aexos-core/development/templates/squad/agent-template.md` | Template | EXISTS |
| `.aexos-core/development/templates/squad/task-template.md` | Template | EXISTS |
| `.aexos-core/development/templates/squad/workflow-template.yaml` | Template | EXISTS |
| `.aexos-core/development/templates/squad/checklist-template.md` | Template | EXISTS |
| `.aexos-core/development/templates/squad/template-template.md` | Template | EXISTS |
| `.aexos-core/development/templates/squad/tool-template.js` | Template | EXISTS |
| `.aexos-core/development/templates/squad/script-template.js` | Template | EXISTS |
| `.aexos-core/development/templates/squad/data-template.yaml` | Template | EXISTS |
...
**Task file:** `.aexos-core/development/tasks/squad-creator-download.md`
...
flowchart TD
    ...
    B --> C{--list flag?}
    C -->|yes| D[Fetch registry.json from aexos-squads]
...
**Source:** `github.com/CyryxLabs/aexos-squads`

---

### `*publish-squad`

**Task file:** `.aexos-core/development/tasks/squad-creator-publish.md`
**Status:** Active (Sprint 8)
...
flowchart TD
    ...
    G -->|no| I[Fork/clone aexos-squads]
...
**Target:** `github.com/CyryxLabs/aexos-squads` via Pull Request
...
**Task file:** `.aexos-core/development/tasks/squad-creator-sync-aexos.md`
**Status:** Active (Sprint 8)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `squad-creator-sync-aexos.md` | Task | EXISTS |
| `squad-validator.js` | Script | EXISTS |
...
**API endpoint:** `https://api.cyryx.dev/api/squads/sync`
...
graph TD
    ...
    subgraph "Task Files"
        ...
        T10[squad-creator-sync-aexos.md]
...
| @aexos-master -> @squad-creator | Invokes | Component creation (agents, tasks, workflows) |
...
- `.aexos-core/development/tasks/squad-creator-design.md`
- `.aexos-core/development/tasks/squad-creator-create.md`
- `.aexos-core/development/tasks/squad-creator-validate.md`
- `.aexos-core/development/tasks/squad-creator-list.md`
- `.aexos-core/development/tasks/squad-creator-migrate.md`
- `.aexos-core/development/tasks/squad-creator-analyze.md`
- `.aexos-core/development/tasks/squad-creator-extend.md`
- `.aexos-core/development/tasks/squad-creator-download.md`
- `.aexos-core/development/tasks/squad-creator-publish.md`
- `.aexos-core/development/tasks/squad-creator-sync-aexos.md`
- `.aexos-core/development/tasks/squad-creator-sync-ide-command.md`

**Scripts (11 files in squad/ dir, all EXISTS):**
- `.aexos-core/development/scripts/squad/index.js`
- `.aexos-core/development/scripts/squad/squad-loader.js`
- `.aexos-core/development/scripts/squad/squad-validator.js`
- `.aexos-core/development/scripts/squad/squad-generator.js`
- `.aexos-core/development/scripts/squad/squad-designer.js`
- `.aexos-core/development/scripts/squad/squad-migrator.js`
- `.aexos-core/development/scripts/squad/squad-analyzer.js`
- `.aexos-core/development/scripts/squad/squad-extender.js`
- `.aexos-core/development/scripts/squad/squad-downloader.js`
- `.aexos-core/development/scripts/squad/squad-publisher.js`
- `.aexos-core/development/scripts/squad/README.md`

**Schemas (2 files, all EXISTS):**
- `.aexos-core/schemas/squad-schema.json`
- `.aexos-core/schemas/squad-design-schema.json`
...
- `.aexos-core/development/templates/squad-template/squad.yaml`
- `.aexos-core/development/templates/squad-template/README.md`
- `.aexos-core/development/templates/squad-template/package.json`
- `.aexos-core/development/templates/squad-template/.gitignore`
- `.aexos-core/development/templates/squad-template/LICENSE`
- `.aexos-core/development/templates/squad-template/agents/example-agent.yaml`
- `.aexos-core/development/templates/squad-template/tasks/example-task.yaml`
- `.aexos-core/development/templates/squad-template/workflows/example-workflow.yaml`
- `.aexos-core/development/templates/squad-template/templates/example-template.md`
- `.aexos-core/development/templates/squad-template/tests/example-agent.test.js`
