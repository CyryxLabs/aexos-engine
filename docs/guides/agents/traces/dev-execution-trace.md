# @dev (Vulcan) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.aexos-core/development/agents/dev.md`
...
|-------|------|--------|---------|
| 1 | `.aexos-core/development/agents/dev.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.aexos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration + devLoadAlwaysFiles list |
| 3 | `.aexos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devLoadAlwaysFiles, devStoryLocation, dataLocation |
...
| 8 | `.aexos-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 9 | `.aexos/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 10 | `.aexos/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
sequenceDiagram
    ...
    ACL-->>CC: { agent: { name: 'Vulcan', icon: '💻' }, commands: [...36], ... }
...
| Data | Source | Value |
|------|--------|-------|
| Greeting level | `persona_profile.greeting_levels.archetypal` | `💻 Vulcan the Builder ready to innovate!` |
| Signature | `persona_profile.communication.signature_closing` | `— Vulcan, sempre construindo 🔨` |
...
**Task file:** `.aexos-core/development/tasks/dev-develop-story.md`
...
**Task file:** `.aexos-core/development/tasks/plan-execute-subtask.md`
...
**Task file:** `.aexos-core/development/tasks/build-autonomous.md`
...
**Task files:** `.aexos-core/development/tasks/gotcha.md`, `.aexos-core/development/tasks/gotchas.md`
...
**Task files:** `.aexos-core/development/tasks/create-worktree.md`, `list-worktrees.md`, `remove-worktree.md`
...
**Task file:** `.aexos-core/development/tasks/qa-fix-issues.md`
...
**Task file:** `.aexos-core/development/tasks/waves.md`
...
**Task file:** `.aexos-core/development/tasks/create-service.md`
