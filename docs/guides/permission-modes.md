...
> Control how much autonomy AEXOS agents have over your system.

---

## Overview

Permission Modes let you control the level of autonomy AEXOS agents have. Whether you're exploring a new codebase or running fully autonomous builds, there's a mode for your workflow.
...
Mode is persisted in `.aexos/config.yaml`:
...
Check `.aexos/config.yaml` exists and is writable:
...
_Permission Modes - Inspired by [Arkantos Agents OSS](https://github.com/lukilabs/craft-agents-oss)_
