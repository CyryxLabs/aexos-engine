...
1. **aexos-squads Repository** - Free, open-source squads on GitHub
2. **Cyryx Marketplace** - Premium squads via AEXOS API
...
| **AEXOS compatibility** | `cyryx.minVersion: "2.1.0"` or higher |
...
This will:
1. Fork `CyryxLabs/aexos-squads` (if needed)
...
## Publishing to Cyryx Marketplace
...
*publish-squad ./squads/my-squad
# or
*sync-squad-cyryx ./squads/my-squad
```
...
- **Questions**: [GitHub Discussions](https://github.com/CyryxLabs/AEXOS/discussions)
- **Issues**: [Issue Tracker](https://github.com/CyryxLabs/AEXOS/issues)
