...
| **Argus Findings**      | Issues found by @qa agent                |
...
```bash
# Sync from .aexos/data to dashboard
npm run sync-metrics
...
This copies `.aexos/data/quality-metrics.json` to `tools/quality-dashboard/public/.aexos/data/`.
