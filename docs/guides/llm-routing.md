...
**Option 1: If you have aexos-core cloned**
```bash
# From aexos-core directory
...
- **Tool Definition:** `.aexos-core/infrastructure/tools/cli/llm-routing.yaml`
- **Install Script:** `.aexos-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Task Definition:** `.aexos-core/development/tasks/setup-llm-routing.md`
...
*Generated by AEXOS Framework - Story 6.7*
