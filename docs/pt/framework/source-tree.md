<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/framework/source-tree.md
...
# Estrutura do Source Tree AEXOS
...
**Repositório:** Cyryx Labs/aexos-core
...
O AEXOS usa uma **arquitetura modular** com clara separação de responsabilidades:

1. **Framework Core** (`.aexos-core/`) - Componentes portáveis do framework organizados por domínio
...
│   ├── aexos migration/                # Stories de migração AEXOS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads são extensões modulares que adicionam capacidades especializadas ao AEXOS. Diferente dos Squads deprecados, Squads seguem uma estrutura de template padronizada.
...
```
squads/
├── verified/                          # Squads curados pelo AEXOS
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
| 1.1    | 2025-12-14 | Atualizado org para Cyryx Labs, substituído Squads pelo sistema Squads [Story 6.10]                                       | Dex (dev)        |
...
_Este é um padrão oficial do framework AEXOS. Todo posicionamento de arquivos deve seguir esta estrutura._
