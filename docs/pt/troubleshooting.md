<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/troubleshooting.md
...
# Guia de Solução de Problemas do AEXOS (Cyryx)

> 🌐 [EN](../troubleshooting.md) | **PT** | [ES](../es/troubleshooting.md)

---

Este guia abrangente ajuda você a diagnosticar e resolver problemas comuns com o AEXOS (Cyryx).
...
npm exec aexos-core init my-project
```
...
```javascript
// Editar .aexos/memory-config.json
{
...
```
Error: "aexos-core" cannot be opened
```
...
xattr -d com.apple.quarantine /usr/local/bin/aexos-core
```
...
export DEBUG=aexos:memory,aexos:agent
```
...
```bash
# Analisar perfil
*debug analyze-profile .aexos/profiles/latest.cpuprofile
```
...
2. **Colete informações:**
   ...
   - Versão do AEXOS: `npx @aexos/core version`

3. **Verifique issues existentes:**
   - [GitHub Issues](https://github.com/CyryxLabs/aexos-engine/issues)
   - [Discussions](https://github.com/CyryxLabs/aexos-engine/discussions)
...
- **Stack Overflow**: Marque perguntas com `aexos-core`
...
1. Executar `npx @aexos/core init test`
...
# Reset completo
rm -rf .aexos node_modules package-lock.json
npm cache clean --force
