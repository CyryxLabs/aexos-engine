<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/contributing.md
...
-->
# Contribuindo para o AEXOS (Cyryx)

> **[English Version](CONTRIBUTING.md)**

Bem-vindo ao AEXOS! Obrigado pelo seu interesse em contribuir. Este guia vai ajuda-lo a entender nosso fluxo de trabalho, processo de contribuicao e como submeter suas alteracoes.
...
git clone https://github.com/SEU_USUARIO/aexos-engine.git
cd aexos-core
...
```
.aexos-core/development/agents/seu-agent.md
```
...
```
.aexos-core/development/tasks/sua-task.md
```
...
- [Discussoes de Squads](https://github.com/CyryxLabs/aexos-engine/discussions/categories/ideas) - Compartilhe ideias
...
- Padroes especificos do AEXOS (agents, tasks, workflows)
...
AEXOS implementa uma estrategia de **Defesa em Profundidade** com 3 camadas de validacao:
...
- **GitHub Issues:** [Abra uma issue](https://github.com/CyryxLabs/aexos-engine/issues)
- **Discussoes:** [Inicie uma discussao](https://github.com/CyryxLabs/aexos-engine/discussions)
...
**Obrigado por contribuir para o AEXOS (Cyryx)!**
