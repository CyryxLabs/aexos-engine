<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/specifications/docs-agent-technical-specification.md
...
**@docs (Ajax)** e um agente de IA especializado em criar **documentacao educacional** para o AEXOS. Diferente da documentacao tecnica (JSDoc/Typedoc), Ajax foca em **tutoriais, guias de onboarding, explicadores visuais e materiais de treinamento para parceiros**.
...
whenToUse: |
  ...
  - Tutoriais explicando como usar recursos do AEXOS
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Usa estilo consistente (paleta de cores AEXOS)"
      blocker: false
...
whenToUse: |
  ...
  - Novo parceiro entra no ecossistema AEXOS
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Links para documentacao AEXOS relevante"
      blocker: false
...
[Nome do Agente] e o agente de [funcao] do AEXOS, especializado em [expertise principal].
...
**Notas do Template:**
- Use paleta de cores AEXOS (Azul primario, Roxo secundario, Rosa terciario)
...
```bash
#!/bin/bash
# Hook de Auto-Atualizacao @docs do AEXOS
...
- [ ] Criar `squads/aexos/agents/docs/agent.yaml`
...
- [ ] **Reconhecimento da Industria:** Docs do AEXOS citados como "melhor no espaco de agentes de IA"
...
Com a adicao do @docs (Ajax), AEXOS agora tem **13 agentes nomeados**:
...
| 13 | @aexos-master | Orion | Commander | Aries | Cyan |
