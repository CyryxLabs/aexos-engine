<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/CHANGELOG.md
...
Todas as alteracoes notaveis do AEXOS (Cyryx) serao documentadas neste arquivo.
...
- **Estrutura de Diretorios**: Renomeado `.legacy-core/` para `.aexos-core/`
...
- **Configuracao de IDE**: Agentes do Claude Code movidos para `.claude/commands/AEXOS/agents/`
...
- Lancamento publico inicial do AEXOS (Cyryx)
...
1. Diretorio renomeado: `.legacy-core/` -> `.aexos-core/`
