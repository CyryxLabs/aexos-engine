<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/platforms/claude-code.md
...
-->
# Guia AEXOS para Claude Code

> 🌐 [EN](../../platforms/claude-code.md) | **PT** | [ES](../../es/platforms/claude-code.md)

---

> **CLI Oficial da Anthropic** - Plataforma Recomendada para AEXOS
...
### Por que usar AEXOS com Claude Code?

O Claude Code oferece a **melhor integração** com o AEXOS devido a:
...
# Verificar se os arquivos AEXOS foram criados
ls -la .claude/
```
...
- Entendimento do framework AEXOS
...
export AEXOS_DEBUG="true"                        # Habilitar log de debug
```
...
```mermaid
flowchart LR
    Source["AEXOS Core<br/>.aexos-core/development/agents"] --> Parser["Parser de Agente"]
...
1. Alterações locais são salvas em `.claude/commands/AEXOS/agents/.backup/`
...
### Perguntas Específicas do AEXOS
...
R: Em `.claude/commands/AEXOS/agents/` após a sincronização.

**P: Com que frequência devo sincronizar agentes?**
R: Após atualizar o AEXOS ou quando agentes são modificados no core.
...
1. Seus agentes AEXOS estão armazenados em `.aexos-core/development/agents/`
2. Inicialize o AEXOS para a IDE de destino
...
*AEXOS (Cyryx) - Guia da Plataforma Claude Code v1.0*
