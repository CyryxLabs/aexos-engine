<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/aiox-nomenclature-specification.md
...
# Especificação de Nomenclatura do AEXOS

> 🌐 [EN](../aexos-nomenclature-specification.md) | **PT** | [ES](../es/aexos-nomenclature-specification.md)
...
Este documento estabelece nomenclatura clara para o AEXOS diferenciando entre:
...
**Características:**
- **Escopo:** Interno a um único arquivo de task (`.aexos-core/tasks/*.md`)
...
- **Localização:** Definido em `.aexos-core/workflows/*.yaml` ou seções de workflow de stories
...
**Conceito:** Inspirado pelo protocolo Organizer-Worker do AsyncThink, workflows do AEXOS podem usar um **Organizer Agent** que coordena **Worker Agents** executando tasks em paralelo.
...
- Exemplo: `.aexos-core/tasks/security-scan.md`

**Arquivos de Workflow:**
- Localização: `.aexos-core/workflows/{workflow-name}.yaml`
- Contém: Definição de orquestração multi-task
- Exemplo: `.aexos-core/workflows/story-development-workflow.yaml`
...
3. **Gerenciamento de Workflow AEXOS:** Padrões de workflow existentes no AEXOS
