<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/guides/development-setup.md
...
Guia completo para desenvolvedores que desejam contribuir com o projeto AEXOS (Cyryx).
...
| -------------------- | --------------------------------------------- |
| **Claude Code**      | Desenvolvimento com IA usando agentes AEXOS    |
| **VS Code / Cursor** | IDE com integração AEXOS                       |
...
1. Navegue até [github.com/Cyryx Labs/aexos-core](https://github.com/CyryxLabs/aexos-engine)
...
Sincronizar agentes AEXOS com sua IDE:
...
Entendendo a estrutura de diretórios do `aexos-core`:

```
aexos-core/
├── .aexos-core/                    # Fonte do framework (commitado)
...
| ----------------------------------- | ----------------------------- | ------------------------- |
| `.aexos-core/development/agents/`    | Personas e comportamentos de agentes | Adicionar/modificar agentes |
| `.aexos-core/development/tasks/`     | Workflows de tasks executáveis | Adicionar/modificar tasks |
| `.aexos-core/development/workflows/` | Orquestrações multi-etapas    | Criar workflows           |
...
Crie um novo arquivo em `.aexos-core/development/agents/`:

```bash
# Arquivo: .aexos-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Criar em .aexos-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Criar em .aexos-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crie um novo arquivo em `.aexos-core/development/tasks/`:
...
# .aexos-core/development/tasks/create-doc.md          (compartilhada)
```
...
## Definição da Task (AEXOS Task Format V1.0)
...
Crie um novo arquivo em `.aexos-core/development/workflows/`:

```bash
# Arquivo: .aexos-core/development/workflows/my-workflow.yaml
```
...
- Marque `@Cyryx Labs/core-team` para issues urgentes
...
_Synkra AEXOS Development Setup Guide v1.0.0_
