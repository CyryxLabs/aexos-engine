<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/guides/api-reference.md
...
-->
# Referência de API do AEXOS

> [EN](../../guides/api-reference.md) | **PT** | [ES](../../es/guides/api-reference.md)

---

Referência completa de API para o AEXOS (Cyryx) - o Sistema Orquestrado por IA para Desenvolvimento Full Stack.
...
O AEXOS fornece uma API unificada para interagir com agentes de IA especializados através de dois mecanismos principais:
...
| `@aexos-master`   | Orion  | Orchestrator | Orquestração do framework, meta-operações       |

### Comportamento de Ativação

Quando um agente é ativado:

1. O arquivo de definição do agente é carregado de `.aexos-core/development/agents/{id}.md`
...
### @aexos-master (Orchestrator)

**Desenvolvimento do Framework:**

| Comando                | Argumentos      | Descrição                                           |
| ---------------------- | --------------- | --------------------------------------------------- |
| `*create`              | `{type} {name}` | Criar componente AEXOS (agent/task/workflow)         |
...
| `*kb`   | -                          | Alternar modo KB (conhecimento do AEXOS Method)   |
...
| -------------------- | ------------------------------- | --------------------------------------------- |
| `AGENT_NOT_FOUND`    | Definição de agente ausente     | Verificar `.aexos-core/development/agents/`    |
...
/aexos-master  → Ativa agente @aexos-master
```
...
- [Guia do Usuário](./user-guide.md) - Começando com AEXOS
...
- [Guia de Squads](./squads-guide.md) - Estendendo AEXOS com squads

---

_Synkra AEXOS Referência de API v4.2.11_
