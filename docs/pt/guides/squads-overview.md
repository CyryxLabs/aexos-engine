<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/guides/squads-overview.md
...
Introdução aos AEXOS Squads - equipes modulares de agentes de IA que estendem a funcionalidade do framework.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do AEXOS para domínios ou casos de uso específicos. Cada squad é um pacote autocontido que pode ser instalado, compartilhado e composto com outros squads.

> **AEXOS Squads:** Equipes de agentes de IA trabalhando com você
...
| Agentes Tradicionais   | AEXOS Squads                  |
| ---------------------- | ---------------------------- |
...
│  Nível 2: AEXOS-SQUADS  --> github.com/Cyryx Labs (Público)     │
...
| Modo       | Comportamento                           |
| ---------- | --------------------------------------- |
| `extend`   | Adiciona regras do squad às regras AEXOS |
| `override` | Substitui regras AEXOS pelas do squad    |
...
- **Aprenda o Formato de Task:** Leia [TASK-FORMAT-SPECIFICATION-V1](../../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Especificação de Formato de Task](../../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_AEXOS Squads: Equipes de agentes de IA trabalhando com você_
