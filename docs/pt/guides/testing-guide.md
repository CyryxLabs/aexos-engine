<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/guides/testing-guide.md
...
-->
# Guia de Testes do AEXOS (Cyryx)

> [EN](../../guides/testing-guide.md) | **PT** | [ES](../../es/guides/testing-guide.md)

---

> Guia completo sobre a estratégia de testes, ferramentas e melhores práticas do AEXOS (Cyryx).
...
O AEXOS segue uma estratégia abrangente de testes que garante qualidade de código em todas as camadas do framework. Nossa filosofia de testes é baseada em:
 ...
 *
 * Garante que agentes de versões anteriores do AEXOS continuem funcionando.
 */
...
O AEXOS suporta Windows, macOS e Linux. Testes cross-platform garantem comportamento consistente.
...
│   └── .aexos-core/       # Cobertura por módulo
...
O Sistema de Quality Gate do AEXOS (veja [Guia de Quality Gates](./quality-gates.md)) integra testes em múltiplas camadas:
...
_Synkra AEXOS v4 Guia de Testes_
