<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/guides/contextual-greeting-system-guide.md
...
### Configuração
- `.aexos-core/core-config.yaml` - Configuração global (seções git + agentIdentity)

### Agentes (Atualizados)
- `.aexos-core/agents/dev.md` - Metadata de visibilidade de comandos
- `.aexos-core/agents/po.md` - Metadata de visibilidade de comandos
- `.aexos-core/agents/*.md` - 9 agentes restantes (atualização pendente)
...
R: Use o script de teste: `node .aexos-core/development/scripts/test-greeting-system.js`
