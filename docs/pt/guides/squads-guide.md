<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/guides/squads-guide.md
...
Guia completo para criar, validar, publicar e gerenciar Squads no AEXOS.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do AEXOS. Cada squad é um pacote autocontido contendo:
...
│  Nível 2: AEXOS-SQUADS  → github.com/Cyryx Labs (Público/Free) │
...
- Node.js 18+
- Projeto AEXOS inicializado (`.aexos-core/` existe)
...
Tasks devem seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Modo       | Comportamento                                   |
| ---------- | ----------------------------------------------- |
| `extend`   | Adiciona regras do squad às regras core do AEXOS |
...
### Nível 2: Repositório aexos-squads (Público)
...
### Nível 3: Cyryx Labs Marketplace
...
3. **Adicionar Campos** - `aexos.type`, `aexos.minVersion`
...
# - aexos.type: deve ser "squad"
# - aexos.minVersion: deve ser semver válido
```
...
### Qual a diferença entre um Squad e formatos legados de squad no AEXOS?

**Squads** são o padrão no AEXOS 2.1+ com:
...
### Qual a versão mínima do AEXOS para Squads?

Squads requerem AEXOS 2.1.0+. Defina no manifesto:
...
- [GitHub Discussions](https://github.com/CyryxLabs/aexos-engine/discussions)
- [Issue Tracker](https://github.com/CyryxLabs/aexos-engine/issues)

---

_AEXOS Squads: Equipes de AI agents trabalhando com você_
