<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/guides/quality-gates.md
...
# Guia do Sistema de Quality Gates AEXOS

> 🌐 [EN](../../guides/quality-gates.md) | **PT** | [ES](../../es/guides/quality-gates.md)

---

> Guia completo para o sistema de quality gates de 3 camadas do AEXOS (Cyryx).
...
O Sistema de Quality Gates do AEXOS fornece garantia de qualidade automatizada através de três camadas progressivas de validação. Cada camada captura diferentes tipos de problemas no estágio apropriado do desenvolvimento.
...
# Executar com opções
aexos qa run --verbose          # Saída detalhada
aexos qa run --fail-fast        # Parar na primeira falha
aexos qa run --continue-on-fail # Continuar apesar de falhas
```
...
_Guia do Sistema de Quality Gates AEXOS (Cyryx) v4_
