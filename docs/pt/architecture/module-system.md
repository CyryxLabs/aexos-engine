<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/architecture/module-system.md
...
# Arquitetura do Sistema de Módulos do AEXOS

> 🌐 [EN](../../architecture/module-system.md) | **PT** | [ES](../../es/architecture/module-system.md)

---

> Guia completo para a arquitetura modular v4.2 do AEXOS (Cyryx).
...
O AEXOS (Cyryx) organiza o diretório `.aexos-core/` em quatro módulos principais:
...
| `data/`          | `aexos-kb.md`, `workflow-patterns.yaml`           | Base de conhecimento do framework           |
...
```javascript
// Configuração
const { loadAgentConfig, globalConfigCache } = require('./.aexos-core/core');

// Sessão
const { ContextDetector, SessionContextLoader } = require('./.aexos-core/core');

// Elicitation
const { ElicitationEngine, ElicitationSessionManager } = require('./.aexos-core/core');
...
**Caminho:** `.aexos-core/development/`
...
| --------------- | ------------------ | ------------------------- |
| AEXOS Master     | `aexos-master`      | Orquestração do framework |
...
**Caminho:** `.aexos-core/infrastructure/`
...
_Arquitetura do Sistema de Módulos AEXOS (Cyryx) v4_
