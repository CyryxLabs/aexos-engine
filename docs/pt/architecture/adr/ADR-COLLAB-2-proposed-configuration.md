<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/architecture/adr/ADR-COLLAB-2-proposed-configuration.md
...
Seguindo a [Auditoria do Estado Atual](./ADR-COLLAB-1-current-state-audit.md), este documento propõe alterações de configuração específicas para habilitar contribuições externas seguras ao AEXOS.
...
# Configuração CodeRabbit do AEXOS
# Story: COLLAB-1
...
reviews:
  ...
  path_instructions:
    ...
    '.aexos-core/development/agents/**':
      - 'Verificar se agente segue estrutura YAML de agente AEXOS (persona_profile, commands, dependencies)'
    ...
    '.aexos-core/development/tasks/**':
      - 'Verificar se tarefa segue formato de tarefa AEXOS com pontos de elicitação claros'
    ...
    '.aexos-core/product/templates/**':
      - 'Garantir que template segue convenções de template AEXOS'
    ...
    '**/*.js':
      ...
      - 'Garantir que código segue padrões de codificação AEXOS'
...
- `@Cyryx Labs/maintainers` - Maintainers gerais (acesso de escrita)
- `@Cyryx Labs/core-team` - Desenvolvedores core do framework
- `@Cyryx Labs/devops` - CI/CD e infraestrutura
...
- [ ] Agente segue estrutura YAML de agente AEXOS
...
- [ ] Tarefa segue formato de tarefa AEXOS
