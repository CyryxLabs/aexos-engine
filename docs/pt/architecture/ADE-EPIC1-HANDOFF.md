<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/architecture/ADE-EPIC1-HANDOFF.md
...
| ------------------------ | ------------------------------------------------------------ | --------- | ------ |
| worktree-manager.js      | `.aexos-core/infrastructure/scripts/worktree-manager.js`      | JS Script | ✅     |
| story-worktree-hooks.js  | `.aexos-core/infrastructure/scripts/story-worktree-hooks.js`  | JS Script | ✅     |
| project-status-loader.js | `.aexos-core/infrastructure/scripts/project-status-loader.js` | JS Script | ✅     |
| auto-worktree.yaml       | `.aexos-core/development/workflows/auto-worktree.yaml`        | Workflow  | ✅     |
| worktree-create.md       | `.aexos-core/development/tasks/worktree-create.md`            | Task      | ✅     |
| worktree-list.md         | `.aexos-core/development/tasks/worktree-list.md`              | Task      | ✅     |
| worktree-merge.md        | `.aexos-core/development/tasks/worktree-merge.md`             | Task      | ✅     |
...
- **status.json**: Status do worktree rastreado em `.aexos/status.json`
- **Dashboard**: API do WorktreeManager consumida pelo AEXOS Dashboard
