<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/architecture/utility-integration-guide.md
...
**Propósito:** Definir padrões para integração de scripts utilitários no framework AEXOS

---

## O que é Integração de Utilitários?

**Definição:** Integração de utilitários é o processo de tornar um script utilitário órfão **descobrível, documentado e utilizável** dentro do framework AEXOS.
...
- `.aexos-core/agents/{agent}.yaml` (adicionar a dependencies.utils)
- `.aexos-core/core-config.yaml` (registrar se necessário)
- `.aexos-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.aexos-core/tasks/{task}.md` (adicionar execution.utils)
- `.aexos-core/agents/{agent}.yaml` (adicionar task à lista executes)
- `.aexos-core/core-config.yaml` (registrar se necessário)
- `.aexos-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.aexos-core/core-config.yaml` (registrar em framework)
- `.aexos-core/utils/README.md` (documentar como utilitário de framework)
...
- `.aexos-core/tasks/{task}.md` (se criar task)
- `.aexos-core/core-config.yaml`
...
**Exemplos:** aexos-validator, code-quality-improver, coverage-analyzer
...
**Localização:** `.aexos-core/utils/{name}.js`
