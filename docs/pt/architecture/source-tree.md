<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/architecture/source-tree.md
...
# Estrutura da Árvore de Código AEXOS
...
**Aviso de Migração:** Este documento será migrado para o repositório `Cyryx Labs/aexos-core` no Q2 2026 (veja Decisão 005)
...
- [Estrutura Atual (aexos-core Brownfield)](#estrutura-atual-aexos-core-brownfield)
...
AEXOS utiliza uma **arquitetura de camada dupla**:

1. **Framework Core** (`.aexos-core/`) - Componentes portáteis do framework
...
## Estrutura Atual (aexos-core Brownfield)

```
aexos-core/                             # Raiz (projeto brownfield)
├── .aexos-core/                        # Core do framework (portátil)
...
│
├── bin/                               # Executáveis CLI
│   ├── aexos-core.js              # Ponto de entrada principal da CLI
│   └── aexos-minimal.js                # CLI mínima
│
...
**Propósito:** Componentes portáteis do framework que funcionam em qualquer projeto AEXOS.
...
Squads são extensões modulares que adicionam capacidades especializadas ao AEXOS. Diferente dos Squads descontinuados, Squads seguem uma estrutura de template padronizada.
...
│   └── cli/                           # Interface CLI
│
├── .aexos-core/                        # Ativos do framework (estrutura atual)
│   ├── agents/
│   ├── tasks/
│   ├── templates/
│   └── ...
...
Localização: .aexos-core/agents/{agent-name}.md
Exemplo: .aexos-core/agents/security-expert.md

# Estou criando uma nova tarefa:
Localização: .aexos-core/tasks/{task-name}.md
Exemplo: .aexos-core/tasks/deploy-to-production.md

# Estou criando um novo workflow:
Localização: .aexos-core/workflows/{workflow-name}.yaml
Exemplo: .aexos-core/workflows/continuous-deployment.yaml

# Estou criando um novo template:
Localização: .aexos-core/product/templates/{template-name}-tmpl.{yaml|md}
Exemplo: .aexos-core/product/templates/deployment-plan-tmpl.yaml

# Estou escrevendo uma story:
Localização: docs/stories/{epic-context}/{story-file}.md
Exemplo: docs/stories/aexos migration/story-6.1.2.6.md
...
Localização: .aexos-core/utils/{utility-name}.js
Exemplo: .aexos-core/utils/performance-monitor.js
