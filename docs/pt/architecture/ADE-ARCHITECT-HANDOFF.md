<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/architecture/ADE-ARCHITECT-HANDOFF.md
...
> **Data:** 2026-01-28
> **Projeto:** AEXOS Autonomous Development Engine (ADE)

---

## Resumo Executivo

O ADE é um projeto de **Prompt Engineering + Infraestrutura** para habilitar execução autônoma de desenvolvimento no AEXOS. Aproximadamente **60% do trabalho é criação de tasks .md, workflows .yaml e templates** - não código tradicional.
...
- `docs/stories/aexos-core-ade/` (7 arquivos de epic + README)

### Quality Gates

- `docs/qa/gates/aexos-core-ade/` (7 arquivos de gate + README)

### Referência

- `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md` (patterns do Auto-Claude)
- `.aexos-core/core-config.yaml` (configuração central)
...
1. **Ler o PRD completo** - `docs/prd/aexos-autonomous-development-engine.md`
