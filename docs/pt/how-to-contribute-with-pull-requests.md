<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/pt/how-to-contribute-with-pull-requests.md
...
- **Para correções de bugs**: Crie uma issue usando o [template de bug report](https://github.com/CyryxLabs/aexos-engine/issues/new?template=bug_report.md)
- **Para novas features**:
  1. Discuta no Discord no [Cyryx support](https://cyryxlabs.com/contact)
  2. Crie uma issue usando o [template de feature request](https://github.com/CyryxLabs/aexos-engine/issues/new?template=feature_request.md)
...
1. Vá para o [repositório AEXOS (Cyryx)](https://github.com/CyryxLabs/aexos-engine)
...
git clone https://github.com/SEU-USUARIO/aexos-engine.git
cd aexos-core
```
...
- 🐛 Reporte bugs usando o [template de bug report](https://github.com/CyryxLabs/aexos-engine/issues/new?template=bug_report.md)
- 💡 Sugira features usando o [template de feature request](https://github.com/CyryxLabs/aexos-engine/issues/new?template=feature_request.md)
