<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/README.md
...
├── framework/                 # English
├── platforms/                 # English
├── aexos-agent-flows/          # Detailed agent documentation (PT)
├── aexos-workflows/            # Detailed workflow documentation (PT)
│
├── pt/                        # Português
├── es/                        # Español
└── zh/                        # 中文（简体）
...
- [代理系统文档](./aexos-agent-flows/README.md)
- [工作流文档](./aexos-workflows/README.md)
