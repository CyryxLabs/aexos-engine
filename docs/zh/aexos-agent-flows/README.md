<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-agent-flows/README.md
...
<!--
  翻译：zh-CN（简体中文）
  原文：/docs/aexos-agent-flows/README.md
  最后同步：2026-02-22
-->

# AEXOS 代理流程 - 代理详细文档

> 🌐 [PT](../../aexos-agent-flows/README.md) | [EN](../../en/aexos-agent-flows/README.md) | [ES](../../es/aexos-agent-flows/README.md) | **ZH**
...
| 代理 | 角色 | 原型 | 文档 |
|--------|---------|-----------|-----------|
| **@aexos-master** | Orion | 编排者 | [aexos-master-system.md](./aexos-master-system.md) |
...
| AEXOS 工作流 | [docs/aexos-workflows/](../aexos-workflows/) | 工作流详情 |
