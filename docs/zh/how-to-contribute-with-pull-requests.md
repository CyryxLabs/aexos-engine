<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/how-to-contribute-with-pull-requests.md
...
- **对于错误修复**：使用[错误报告模板](https://github.com/CyryxLabs/aexos-engine/issues/new?template=bug_report.md)创建一个问题
- **对于新功能**：
  1. 在 Discord 的[Cyryx support](https://cyryxlabs.com/contact)中讨论
  2. 使用[功能请求模板](https://github.com/CyryxLabs/aexos-engine/issues/new?template=feature_request.md)创建一个问题
...
1. 进入 [AEXOS (Cyryx) 存储库](https://github.com/CyryxLabs/aexos-engine)
2. 单击右上角的"Fork"按钮
3. 这会创建您自己的项目副本
...
git clone https://github.com/YOUR-USERNAME/aexos-engine.git
cd @aexos/core
```
...
- 🐛 使用[错误报告模板](https://github.com/CyryxLabs/aexos-engine/issues/new?template=bug_report.md)报告错误
- 💡 使用[功能请求模板](https://github.com/CyryxLabs/aexos-engine/issues/new?template=feature_request.md)建议功能
