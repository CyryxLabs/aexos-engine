<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/guides/installation-troubleshooting.md
...
> **安装故障排除 — availability boundary**
>
> 源文档引用的诊断下载在经过验证的 AEXOS 位置中不存在。
>
> **Portable content retained:** 请使用已安装软件包提供的命令：`aexos --help` 和 `aexos doctor`。
>
> **Unsupported prerequisite:** 请勿从源文档中的 URL 下载或执行脚本。
# aexos-core 安装和故障排除指南
...
*最后更新: 2025年12月 | aexos-core v2.2.0*
