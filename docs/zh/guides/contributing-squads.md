<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/guides/contributing-squads.md
...
1. **aexos-squads Repository** - GitHub上的免费开源Squad
2. **Cyryx Labs Marketplace** - 通过Cyryx Labs API的高级Squad
...
| **AEXOS兼容性** | `aexos.minVersion: "2.1.0"` 或更高 |
...
这将：
1. Fork `Cyryx Labs/aexos-squads` （如需要）
2. 用你的Squad创建分支
3. 开启审查PR
...
- **问题**: [GitHub讨论](https://github.com/CyryxLabs/aexos-engine/discussions)
- **问题**: [问题跟踪器](https://github.com/CyryxLabs/aexos-engine/issues)
- **指南**: 本文档
