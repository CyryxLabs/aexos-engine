<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/guides/squad-migration.md
...
如何将旧版Squad迁移到AEXOS 2.1格式。

## 概述

AEXOS 2.1引入了新的Squad格式，具有以下特性：
- 任务优先的架构
- JSON Schema验证
- 三层级分发
- 标准化清单 (`squad.yaml`)
...
| AEXOS类型字段 | 缺失 | `aexos.type: squad` |
| 最低版本 | 缺失 | `aexos.minVersion: "2.1.0"` |
| 结构 | Agent优先 | Task优先 |
