<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/guides/ide-sync-guide.md
...
在多个IDE配置中同步AEXOS代理、任务、工作流和检查清单。

## 概述

`*command` 任务自动化AEXOS组件到所有配置的IDE目录（`.claude/`、`.cursor/`、`.gemini/` 等）的同步，省去手动复制操作。
