<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/TRANSLATION-PLAN.md
...
本文档描述了将 AEXOS (Cyryx) 文档翻译成中文的完整计划。
...
**代理流程文档 (aexos-agent-flows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 代理流程 README | `aexos-agent-flows/README.md` | `zh/aexos-agent-flows/README.md` | ⬜ |
| AEXOS Master 系统 | `aexos-agent-flows/aexos-master-system.md` | `zh/aexos-agent-flows/aexos-master-system.md` | ⬜ |
| 开发者系统 | `aexos-agent-flows/dev-system.md` | `zh/aexos-agent-flows/dev-system.md` | ⬜ |
| 架构师系统 | `aexos-agent-flows/architect-system.md` | `zh/aexos-agent-flows/architect-system.md` | ⬜ |
| QA 系统 | `aexos-agent-flows/qa-system.md` | `zh/aexos-agent-flows/qa-system.md` | ⬜ |
| UX 设计专家系统 | `aexos-agent-flows/ux-design-expert-system.md` | `zh/aexos-agent-flows/ux-design-expert-system.md` | ⬜ |
| 数据工程师系统 | `aexos-agent-flows/data-engineer-system.md` | `zh/aexos-agent-flows/data-engineer-system.md` | ⬜ |
| 分析师系统 | `aexos-agent-flows/analyst-system.md` | `zh/aexos-agent-flows/analyst-system.md` | ⬜ |
| 产品经理系统 | `aexos-agent-flows/pm-system.md` | `zh/aexos-agent-flows/pm-system.md` | ⬜ |
| Scrum Master 系统 | `aexos-agent-flows/sm-system.md` | `zh/aexos-agent-flows/sm-system.md` | ⬜ |
| DevOps 系统 | `aexos-agent-flows/devops-system.md` | `zh/aexos-agent-flows/devops-system.md` | ⬜ |
| Squad 创建者系统 | `aexos-agent-flows/squad-creator-system.md` | `zh/aexos-agent-flows/squad-creator-system.md` | ⬜ |

**工作流文档 (aexos-workflows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 工作流 README | `aexos-workflows/README.md` | `zh/aexos-workflows/README.md` | ⬜ |
| 绿地全栈工作流 | `aexos-workflows/greenfield-fullstack-workflow.md` | `zh/aexos-workflows/greenfield-fullstack-workflow.md` | ⬜ |
| 绿地服务工作流 | `aexos-workflows/greenfield-service-workflow.md` | `zh/aexos-workflows/greenfield-service-workflow.md` | ⬜ |
| 绿地 UI 工作流 | `aexos-workflows/greenfield-ui-workflow.md` | `zh/aexos-workflows/greenfield-ui-workflow.md` | ⬜ |
| 棕地全栈工作流 | `aexos-workflows/brownfield-fullstack-workflow.md` | `zh/aexos-workflows/brownfield-fullstack-workflow.md` | ⬜ |
| 棕地服务工作流 | `aexos-workflows/brownfield-service-workflow.md` | `zh/aexos-workflows/brownfield-service-workflow.md` | ⬜ |
| 棕地 UI 工作流 | `aexos-workflows/brownfield-ui-workflow.md` | `zh/aexos-workflows/brownfield-ui-workflow.md` | ⬜ |
| 棕地发现工作流 | `aexos-workflows/brownfield-discovery-workflow.md` | `zh/aexos-workflows/brownfield-discovery-workflow.md` | ⬜ |
| 规格流水线工作流 | `aexos-workflows/spec-pipeline-workflow.md` | `zh/aexos-workflows/spec-pipeline-workflow.md` | ⬜ |
| QA 循环工作流 | `aexos-workflows/qa-loop-workflow.md` | `zh/aexos-workflows/qa-loop-workflow.md` | ⬜ |
| Story 开发周期 | `aexos-workflows/story-development-cycle-workflow.md` | `zh/aexos-workflows/story-development-cycle-workflow.md` | ⬜ |
...
| AEXOS 视觉概览 | `architecture/AEXOS-VISUAL-OVERVIEW.md` | `zh/architecture/AEXOS-VISUAL-OVERVIEW.md` | ⬜ |
...
| Gate | 门控 | 門控 | 质量门控 |
| Persona | 角色 / 人格 | 角色 / 人格 | |
| Constitution | 宪法 / 准则 | 憲法 / 準則 | AEXOS Constitution |
| CLI | CLI / 命令行 | CLI / 命令列 | |
| Hook | 钩子 | 鉤子 | |
| MCP | MCP | MCP | 不翻译 |
...
3. **保留品牌名** - Cyryx Labs、AEXOS、Claude 等品牌名不翻译
...
│       └── README.md
│
├── aexos-agent-flows/                   # 代理流程
│   ├── README.md
│   ├── aexos-master-system.md
│   ├── dev-system.md
│   ├── architect-system.md
│   ├── qa-system.md
