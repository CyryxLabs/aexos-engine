<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/architecture/agent-responsibility-matrix.md
...
本文档为所有 AEXOS 代理定义了清晰的责任界限，特别关注:
...
- [ ] **创建 Git 前推送钩子**
  - 位置: `.git/hooks/pre-push`
  - 内容: 检查 `$AEXOS_ACTIVE_AGENT`，如果 != "github-devops" 则阻止
...
- [ ] **更新代理激活脚本**
  - 添加环境变量配置: `AEXOS_ACTIVE_AGENT={agent_id}`
  - 适当设置 `AEXOS_GIT_PUSH_ALLOWED`
