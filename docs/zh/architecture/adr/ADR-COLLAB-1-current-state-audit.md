<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/architecture/adr/ADR-COLLAB-1-current-state-audit.md
...
**来源:** `gh api repos/Cyryx Labs/aexos-core/branches/main/protection`
...
**来源:** `gh api repos/Cyryx Labs/aexos-core`
...
**来源:** `gh api repos/Cyryx Labs/aexos-core/actions/workflows`
...
1. 创建包含 AEXOS 特定规则的 `.coderabbit.yaml`
