<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/architecture/contribution-workflow-research.md
...
本文档汇总了开源项目外部贡献者工作流最佳实践的研究发现，特别是为了实现 AEXOS 代理和任务的安全社区贡献。
...
1. **创建 `.coderabbit.yaml`** 带有 AEXOS 特定路径说明
