<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/architecture/high-level-architecture.md
...
**AEXOS（AI 操作系统）** 是用于 AI 代理、工作者和人类在复杂软件开发工作流中进行编排的精巧框架。v2.1 版本引入了具有 4 个模块的模块化架构、多仓库策略和 3 层质量门槛。
...
| 包 | 注册表 | 许可证 |
| --- | --- | --- |
| `@aexos/core` | npm 公开 | MIT |
| `@aexos/squad-etl` | npm 公开 | MIT |
| `@aexos/squad-creator` | npm 公开 | MIT |
| `@aexos/squad-mmos` | npm 公开 | MIT |
| `@aexos/mcp-presets` | npm 公开 | Apache 2.0 |
...
| 模块 | 路径 | 目的 | 主要内容 |
| --- | --- | --- | --- |
| **核心** | `.aexos-core/core/` | 框架基础 | 配置、注册表、QG、MCP、会话 |
| **开发** | `.aexos-core/development/` | 开发制品 | 代理、任务、工作流、脚本 |
| **产品** | `.aexos-core/product/` | PM 制品 | 模板、检查表、数据 |
| **基础设施** | `.aexos-core/infrastructure/` | 系统配置 | 脚本、工具、集成 |
...
- [AEXOS-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.aexos-core/docs/standards/AEXOS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - 框架完整指南
