<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/architecture/multi-repo-strategy.md
...
- [概览](#概览)
- [仓库结构](#仓库结构)
- [主要仓库 (aexos-core)](#主要仓库-aexos-core)
- [Squad 仓库](#squad-仓库)
...
AEXOS v4 采用**多仓库策略**以实现模块化开发、社区贡献和核心框架、扩展(squads)和专有组件之间的清晰分离。
...
主仓库包含所有项目依赖的基础 AEXOS 框架。

### 内容

| 目录                       | 描述                                    |
| -------------------------- | --------------------------------------- |
| `.aexos-core/core/`         | 框架基础(配置、注册表、质量门)          |
| `.aexos-core/development/`  | 代理、任务、工作流定义                  |
| `.aexos-core/product/`      | 模板、检查表、PM 数据                   |
| `.aexos-core/infrastructure/` | 脚本、工具、集成                      |
| `docs/`                    | 框架文档                                |
...
### Cyryx Labs/certified-partners(专有)
...
| 包                   | 注册表 | 许可证     | 仓库        |
| -------------------- | ------ | ---------- | ----------- |
| `@aexos/core`         | npm    | MIT        | aexos-core   |
| `@aexos/squad-etl`    | npm    | MIT        | aexos-squads |
| `@aexos/squad-creator`| npm    | MIT        | aexos-squads |
| `@aexos/squad-mmos`   | npm    | MIT        | aexos-squads |
| `@aexos/mcp-presets`  | npm    | Apache 2.0 | mcp-ecosystem |
