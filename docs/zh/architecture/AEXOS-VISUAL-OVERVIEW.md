<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/architecture/AIOX-VISUAL-OVERVIEW.md
...
**AEXOS (Cyryx)** (AI Operating System) 是一个框架，它改变了团队构建软件的方式 — 将 **专业化 AI 代理** 与 **真实人类** 结合在一种独特的敏捷方法论中。
...
flowchart LR
    ...
    subgraph TASKFIRST["Task-First (AEXOS)"]
        direction TB
        TK1["已验证任务"] --> DEC1{"执行器?"}
        DEC1 --> E1["代理"]
        DEC1 --> E2["工作器"]
...
```mermaid
flowchart TB
    subgraph EXECUTORS["AEXOS 的 4 种执行器"]
        direction TB
...
这是决定 AEXOS 中每个任务应分配哪个执行器的主要流程图:
...
AEXOS 是模块化的 — 你像乐高积木一样组合小队、代理和配置。
...
flowchart TB
    subgraph WS["公司动态工作空间"]
        ...
        subgraph FRAMEWORK[".aexos-core/ — 框架 (不可变)"]
            AGENTS_CORE["11 个核心代理<br/>dev, qa, architect, pm,<br/>po, sm, analyst, devops,<br/>data-engineer, ux, aexos-master"]
...
AEXOS 的差异化在于小队 **不会取代** 人类 — 它们 **一起** 工作:
...
flowchart LR
    ...
    subgraph AEXOS_WAY["AEXOS (Cyryx) (Task-First)"]
        direction TB
    ...
    style AEXOS_WAY fill:#27ae60,color:#fff
```

### 宪法原则

AEXOS 在具有不可协商原则的 **正式宪法** 下运行:
...
| 文档 | 内容 |
|-----------|----------|
| [EXECUTOR-DECISION-TREE.md](../../.aexos-core/docs/standards/EXECUTOR-DECISION-TREE.md) | 带示例和成本效益分析的详细决策树 |
| [SYNAPSE-FLOWCHARTS.md](SYNAPSE/SYNAPSE-FLOWCHARTS.md) | SYNAPSE 上下文引擎的 12 个流程图 |
| [Constitution](../../.aexos-core/constitution.md) | 框架的不可协商原则 |
| [User Guide](../../.aexos-core/user-guide.md) | AEXOS 使用完整指南 |
| [Squads Guide](../guides/squads-guide.md) | 如何创建和管理小队 |

---

*AEXOS (Cyryx) 可视化概览 v1.0.0*
