<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/spec-pipeline-workflow.md
...
| 任务 | 阶段 | 代理 | 文件 |
|------|------|------|------|
| 收集需求 | 1 | @pm | `.aexos-core/development/tasks/spec-gather-requirements.md` |
| 评估复杂性 | 2 | @architect | `.aexos-core/development/tasks/spec-assess-complexity.md` |
| 研究依赖 | 3 | @analyst | `.aexos-core/development/tasks/spec-research-dependencies.md` |
| 编写规范 | 4 | @pm | `.aexos-core/development/tasks/spec-write-spec.md` |
| 批评规范 | 5, 5c | @qa | `.aexos-core/development/tasks/spec-critique.md` |
| 创建实现计划 | 6 | @architect | `.aexos-core/development/tasks/plan-create-implementation.md` |
...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.aexos-core/development/workflows/spec-pipeline.yaml` |
| 任务: 收集 | `.aexos-core/development/tasks/spec-gather-requirements.md` |
| 任务: 评估 | `.aexos-core/development/tasks/spec-assess-complexity.md` |
| 任务: 研究 | `.aexos-core/development/tasks/spec-research-dependencies.md` |
| 任务: 编写规范 | `.aexos-core/development/tasks/spec-write-spec.md` |
| 任务: 批评 | `.aexos-core/development/tasks/spec-critique.md` |
| 任务: 创建计划 | `.aexos-core/development/tasks/plan-create-implementation.md` |
...
- [AEXOS 文档索引](../AEXOS-DOCUMENTATION-INDEX.md)
