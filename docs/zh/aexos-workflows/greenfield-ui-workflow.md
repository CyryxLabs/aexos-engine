<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/greenfield-ui-workflow.md
...
2. **aexos-core 可用**
   - `.aexos-core/development/templates/` 中的模板
   - `.aexos-core/development/tasks/` 中的任务
   - `.aexos-core/development/checklists/` 中的检查列表
...
| 问题 | 可能原因 | 解决方案 |
|------|---------|---------|
| 模板未找到 | 路径不正确 | 检查 `.aexos-core/development/templates/` |
...
| 文件 | 路径 |
|------|------|
| 工作流定义 | `.aexos-core/development/workflows/greenfield-ui.yaml` |
| 知识库 | `.aexos-core/data/aexos-kb.md` |
...
| 模板 | 路径 |
|------|------|
| 项目简报 | `.aexos-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.aexos-core/development/templates/prd-tmpl.yaml` |
| 前端规范 | `.aexos-core/development/templates/front-end-spec-tmpl.yaml` |
| 前端架构 | `.aexos-core/development/templates/front-end-architecture-tmpl.yaml` |
| 故事 | `.aexos-core/development/templates/story-tmpl.yaml` |

### 检查列表

| 检查列表 | 路径 |
|---------|------|
| PO 主检查 | `.aexos-core/development/checklists/po-master-checklist.md` |
| 故事草稿 | `.aexos-core/development/checklists/story-draft-checklist.md` |
| 故事完成定义 | `.aexos-core/development/checklists/story-dod-checklist.md` |

### 相关文档

- [AEXOS 知识库](.aexos-core/data/aexos-kb.md) - 中央知识库
...
*文档自动从 `.aexos-core/development/workflows/greenfield-ui.yaml` 生成*
