<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/brownfield-fullstack-workflow.md
...
> **类型：** 棕地项目开发
> **状态：** 官方文档
> **源文件：** `.aexos-core/development/workflows/brownfield-fullstack.yaml`
...
**任务文件：** `.aexos-core/development/tasks/document-project.md`
...
**清单文件：** `.aexos-core/development/checklists/po-master-checklist.md`
...
**任务文件：** `.aexos-core/development/tasks/shard-doc.md`
...
- [ ] AEXOS核心配置已配置 (`.aexos-core/core-config.yaml`)
...
| 文件 | 目的 |
|------|------|
| `.aexos-core/development/workflows/brownfield-fullstack.yaml` | 工作流定义 |
| `.aexos-core/development/tasks/brownfield-create-story.md` | 创建简单故事的任务 |
| `.aexos-core/development/tasks/brownfield-create-epic.md` | 创建史诗的任务 |
| `.aexos-core/development/tasks/document-project.md` | 记录现有项目的任务 |
| `.aexos-core/development/tasks/shard-doc.md` | 分割文档的任务 |
| `.aexos-core/development/tasks/create-brownfield-story.md` | 创建棕地故事的任务 |
| `.aexos-core/development/tasks/create-next-story.md` | 从PRD创建故事的任务 |
| `.aexos-core/product/checklists/po-master-checklist.md` | PO验证清单 |

### 代理文件

| 文件 | 代理 |
|------|------|
| `.aexos-core/development/agents/analyst.md` | @analyst (Atlas) |
| `.aexos-core/development/agents/architect.md` | @architect (Aria) |
| `.aexos-core/development/agents/pm.md` | @pm (Morgan) |
| `.aexos-core/development/agents/po.md` | @po (Pax) |
| `.aexos-core/development/agents/sm.md` | @sm (River) |
| `.aexos-core/development/agents/dev.md` | @dev (Dex) |
| `.aexos-core/development/agents/qa.md` | @qa (Quinn) |
...
| `.aexos-core/working-in-the-brownfield.md` | 棕地工作指南 |
