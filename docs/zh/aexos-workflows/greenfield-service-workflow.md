<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/greenfield-service-workflow.md
...
**版本:** 1.0
**创建:** 2026-02-04
**源:** `.aexos-core/development/workflows/greenfield-service.yaml`
...
**参考:** `.aexos-core/data/aexos-kb.md#IDE Development Workflow`
...
| 文件 | 描述 |
|------|------|
| `.aexos-core/core-config.yaml` | 框架配置 |
| `.env` | 环境变量 |
...
| 类型 | 位置 |
|------|------|
| 代理日志 | `.aexos/logs/agent.log` |
| 项目状态 | `.aexos/project-registry.yaml` |
...
| 文件 | 描述 |
|------|------|
| `.aexos-core/development/workflows/greenfield-service.yaml` | 工作流定义 |
| `.aexos-core/data/aexos-kb.md` | AEXOS 知识库 |

### 代理

| 文件 | 代理 |
|------|------|
| `.aexos-core/development/agents/analyst.md` | Atlas (分析师) |
| `.aexos-core/development/agents/pm.md` | Morgan (PM) |
| `.aexos-core/development/agents/architect.md` | Aria (架构师) |
| `.aexos-core/development/agents/po.md` | Pax (PO) |
| `.aexos-core/development/agents/sm.md` | River (SM) |
| `.aexos-core/development/agents/dev.md` | Dex (Dev) |
| `.aexos-core/development/agents/qa.md` | Quinn (QA) |

### 主要任务

| 文件 | 任务 |
|------|------|
| `.aexos-core/development/tasks/create-doc.md` | 创建文档 |
| `.aexos-core/development/tasks/shard-doc.md` | 分片文档 |
| `.aexos-core/development/tasks/sm-create-next-story.md` | 创建故事 |
| `.aexos-core/development/tasks/dev-develop-story.md` | 实施故事 |
| `.aexos-core/development/tasks/qa-review-story.md` | 审阅实现 |
| `.aexos-core/development/tasks/execute-checklist.md` | 执行检查列表 |

### 模板

| 文件 | 模板 |
|------|------|
| `.aexos-core/development/templates/project-brief-tmpl.yaml` | 项目简报 |
| `.aexos-core/development/templates/prd-tmpl.yaml` | PRD |
| `.aexos-core/development/templates/architecture-tmpl.yaml` | 架构 |
| `.aexos-core/development/templates/story-tmpl.yaml` | 用户故事 |
| `.aexos-core/development/templates/qa-gate-tmpl.yaml` | 质量保证关卡 |

### 检查列表

| 文件 | 检查列表 |
|------|----------|
| `.aexos-core/development/checklists/po-master-checklist.md` | PO 验证 |
| `.aexos-core/development/checklists/story-draft-checklist.md` | 验证故事草稿 |
| `.aexos-core/development/checklists/story-dod-checklist.md` | 完成定义 |
...
*文档自动从 `.aexos-core/development/workflows/greenfield-service.yaml` 生成*
