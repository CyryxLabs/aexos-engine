<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/brownfield-ui-workflow.md
...
| **AEXOS模板** | 已安装的模板 | 检查 `.aexos-core/development/templates/` |
| **已配置的代理** | 工作流的所有代理 | 检查 `.aexos-core/development/agents/` |
...
| 文档 | 位置 | 需要用于 |
|------|------|---------|
| PRD模板 | `.aexos-core/development/templates/brownfield-prd-tmpl.yaml` | 步骤2 |
| 前端模板 | `.aexos-core/development/templates/front-end-spec-tmpl.yaml` | 步骤3 |
| 架构模板 | `.aexos-core/development/templates/brownfield-architecture-tmpl.yaml` | 步骤4 |
| PO清单 | `.aexos-core/development/checklists/po-master-checklist.md` | 步骤5 |
| 故事模板 | `.aexos-core/development/templates/story-tmpl.yaml` | 步骤8 |
...
| 文档 | 位置 | 描述 |
|------|------|------|
| AEXOS知识库 | `.aexos-core/data/aexos-kb.md` | AEXOS基础知识库 |
| IDE开发工作流 | `.aexos-core/data/aexos-kb.md#IDE Development Workflow` | IDE开发工作流 |
| 棕地PRD模板 | `.aexos-core/development/templates/brownfield-prd-tmpl.yaml` | 棕地PRD模板 |
| 前端规范模板 | `.aexos-core/development/templates/front-end-spec-tmpl.yaml` | 前端规范模板 |
| 棕地架构模板 | `.aexos-core/development/templates/brownfield-architecture-tmpl.yaml` | 棕地架构模板 |
| PO主清单 | `.aexos-core/development/checklists/po-master-checklist.md` | PO验证清单 |

### 代理

| 代理 | 文件 | 文档 |
|------|------|------|
| @architect | `.aexos-core/development/agents/architect.md` | Aria - 整体系统架构师 |
| @pm | `.aexos-core/development/agents/pm.md` | Morgan - 产品经理 |
| @ux-expert | `.aexos-core/development/agents/ux-design-expert.md` | Uma - UX/UI设计师 |
| @po | `.aexos-core/development/agents/po.md` | Pax - 产品所有者 |
| @sm | `.aexos-core/development/agents/sm.md` | River - 敏捷主管 |
| @analyst | `.aexos-core/development/agents/analyst.md` | Atlas - 业务分析师 |
| @dev | `.aexos-core/development/agents/dev.md` | Dex - 全栈开发人员 |
| @qa | `.aexos-core/development/agents/qa.md` | Quinn - 测试架构师 |
...
*从`.aexos-core/development/workflows/brownfield-ui.yaml`自动生成的文档*
