<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/design-system-build-quality-workflow.md
...
| 文档 | 路径 |
|------|------|
| 工作流定义 | `.aexos-core/development/workflows/design-system-build-quality.yaml` |
| UX 设计专家代理 | `.aexos-core/development/agents/ux-design-expert.md` |
| 任务: 构建组件 | `.aexos-core/development/tasks/build-component.md` |
| 任务: 生成文档 | `.aexos-core/development/tasks/generate-documentation.md` |
| 检查清单: WCAG A11y | `.aexos-core/development/checklists/accessibility-wcag-checklist.md` |
| 任务: 计算 ROI | `.aexos-core/development/tasks/calculate-roi.md` |
...
| 版本 | 日期 | 作者 | 更改 |
|------|------|------|------|
| 1.0.0 | 2025-01-30 | Orion (AEXOS 主机) | 工作流初始版本 |
