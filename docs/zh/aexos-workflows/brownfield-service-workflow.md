<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/brownfield-service-workflow.md
...
| 文件 | 描述 | 路径 |
|------|------|------|
| 工作流定义 | 工作流的YAML定义 | `.aexos-core/development/workflows/brownfield-service.yaml` |
| PRD模板 | 棕地PRD的模板 | `.aexos-core/development/templates/brownfield-prd-tmpl.yaml` |
| 架构模板 | 架构的模板 | `.aexos-core/development/templates/brownfield-architecture-tmpl.yaml` |
| 故事模板 | 故事的模板 | `.aexos-core/development/templates/story-tmpl.yaml` |
| PO主清单 | 验证清单 | `.aexos-core/development/checklists/po-master-checklist.md` |
| 故事草稿清单 | 故事清单 | `.aexos-core/development/checklists/story-draft-checklist.md` |
| 故事DoD清单 | 完成定义 | `.aexos-core/development/checklists/story-dod-checklist.md` |

### 代理

| 代理 | 文件 | 路径 |
|------|------|------|
| @architect | Aria | `.aexos-core/development/agents/architect.md` |
| @pm | Morgan | `.aexos-core/development/agents/pm.md` |
| @po | Pax | `.aexos-core/development/agents/po.md` |
| @sm | River | `.aexos-core/development/agents/sm.md` |
| @analyst | Atlas | `.aexos-core/development/agents/analyst.md` |
| @dev | Dex | `.aexos-core/development/agents/dev.md` |
| @qa | Quinn | `.aexos-core/development/agents/qa.md` |

### 相关文档

- [AEXOS知识库](../../../.aexos-core/data/aexos-kb.md) - 框架知识库
- [技术偏好](../../../.aexos-core/development/data/technical-preferences.md) - 项目技术偏好
- [IDE开发工作流](../../../.aexos-core/data/aexos-kb.md#IDE-Development-Workflow) - IDE开发流程
...
*从workflow `brownfield-service.yaml` 生成 - AEXOS框架 v2.2*
