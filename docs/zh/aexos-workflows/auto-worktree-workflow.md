<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/auto-worktree-workflow.md
...
graph TB
    ...
    subgraph FS["文件系统"]
        WT[.aexos/worktrees/{storyId}/<br/>工作树目录]
        LOG[.aexos/logs/merges/<br/>合并审计日志]
    end
...
| 属性 | 值 |
|------|-----|
| **位置** | `.aexos-core/development/tasks/create-worktree.md` |
| **代理** | @devops (Gage) |
| **版本** | 1.0 |
| **故事** | 1.3 |
...
| `WorktreeManager not found` | AEXOS 不完整 | 重新安装 AEXOS |
...
3. 增加限制 (如需): 在 `.aexos/config.yaml` 中
...
| 文件 | 路径 |
|------|------|
| **工作流定义** | `.aexos-core/development/workflows/auto-worktree.yaml` |
| **任务创建** | `.aexos-core/development/tasks/create-worktree.md` |
