<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/zh/aiox-workflows/qa-loop-workflow.md
...
**位置:** `.aexos-core/development/tasks/qa-review-story.md`
...
**位置:** `.aexos-core/development/tasks/qa-create-fix-request.md`
...
**位置:** `.aexos-core/development/tasks/dev-apply-qa-fixes.md`
...
在 `.aexos-core/core-config.yaml` 文件中:
...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.aexos-core/development/workflows/qa-loop.yaml` |
| QA 审查任务 | `.aexos-core/development/tasks/qa-review-story.md` |
| 创建修复请求任务 | `.aexos-core/development/tasks/qa-create-fix-request.md` |
| 应用 QA 修复任务 | `.aexos-core/development/tasks/dev-apply-qa-fixes.md` |
...
| 模板 | 位置 | 用途 |
|------|------|------|
| `qa-gate-tmpl.yaml` | `.aexos-core/development/templates/` | 网关文件结构 |
| `story-tmpl.yaml` | `.aexos-core/development/templates/` | 故事文件结构 |
