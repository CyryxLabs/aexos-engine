<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/platforms/github-copilot.md
...
# Guía de AEXOS para GitHub Copilot
...
### ¿Por qué usar AEXOS con GitHub Copilot?
...
Este proyecto utiliza AEXOS (Cyryx) para desarrollo orquestado por IA.
...
Eres un Senior Full Stack Developer trabajando con AEXOS (Cyryx).
...
### Activando Modos de Agentes AEXOS
...
4. Para agentes AEXOS, usa modos de chat personalizados en `.github/chatmodes/`

### Modos Personalizados AEXOS

| Modo | Propósito |
|---|---|
| `aexos-dev` | Desarrollo full-stack |
| `aexos-qa` | Aseguramiento de calidad |
| `aexos-architect` | Diseño de sistemas |
| `aexos-pm` | Gestión de proyectos |
...
```
Problema: Los modos de agentes AEXOS no aparecen en el selector
```
**Solución:**
...
*AEXOS (Cyryx) - Guía de Plataforma GitHub Copilot v1.0*
