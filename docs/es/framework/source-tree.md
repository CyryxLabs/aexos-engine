<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/framework/source-tree.md
...
# Estructura del Árbol de Código Fuente AEXOS
...
**Repositorio:** Cyryx Labs/aexos-core
...
- [Core del Framework (.aexos-core/)](#core-del-framework-aexos-core)
...
AEXOS utiliza una **arquitectura modular** con clara separación de responsabilidades:

1. **Core del Framework** (`.aexos-core/`) - Componentes portables del framework organizados por dominio
...
```
aexos-core/                             # Proyecto raíz
├── .aexos-core/                        # Core del framework (modular)
...
│
├── bin/                               # Ejecutables CLI
│   └── aexos.js                        # Punto de entrada principal CLI
│
...
│   ├── aexos migration/                # Stories de migración AEXOS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a AEXOS. A diferencia de los Squads deprecados, los Squads siguen una estructura de template estandarizada.
...
### REPO 1: Cyryx Labs/aexos-core (MIT)

```
aexos-core/
├── .aexos-core/                        # Assets del framework (modular v2.0)
│   ├── cli/                           # Comandos CLI y utilidades
│   ├── core/                          # Esenciales del framework
│   │   ├── config/                    # Sistema de configuración
...
### REPO 2: Cyryx Labs/squads (MIT)

```
squads/
├── verified/                          # Squads curados por AEXOS
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
### REPO 3: Cyryx Labs/mcp-ecosystem (Apache 2.0)
...
### REPO 4: Cyryx Labs/certified-partners (Privado)
...
### REPO 5: Cyryx Labs/mmos (Privado + NDA)
...
Ubicación: .aexos-core/development/agents/{agent-name}.md
Ejemplo: .aexos-core/development/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicación: .aexos-core/development/tasks/{task-name}.md
Ejemplo: .aexos-core/development/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicación: .aexos-core/development/workflows/{workflow-name}.yaml
Ejemplo: .aexos-core/development/workflows/continuous-deployment.yaml

# Estoy creando un nuevo template:
Ubicación: .aexos-core/product/templates/{template-name}-tmpl.{yaml|md}
Ejemplo: .aexos-core/product/templates/deployment-plan-tmpl.yaml

# Estoy creando un nuevo checklist:
Ubicación: .aexos-core/product/checklists/{checklist-name}-checklist.md
Ejemplo: .aexos-core/product/checklists/security-review-checklist.md

# Estoy creando un comando CLI:
Ubicación: .aexos-core/cli/commands/{category}/{command-name}.js
Ejemplo: .aexos-core/cli/commands/generate/workflow.js

# Estoy creando una utilidad core:
Ubicación: .aexos-core/core/utils/{utility-name}.js
Ejemplo: .aexos-core/core/utils/performance-monitor.js

# Estoy creando un script de infraestructura:
Ubicación: .aexos-core/infrastructure/scripts/{category}/{script-name}.js
Ejemplo: .aexos-core/infrastructure/scripts/llm-routing/router.js

# Estoy agregando un adaptador de herramienta PM:
Ubicación: .aexos-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Ejemplo: .aexos-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
| 1.1     | 2025-12-14 | Actualizada org a Cyryx Labs, reemplazado Squads con sistema de Squads [Story 6.10]                                          | Dex (dev)        |
...
_Este es un estándar oficial del framework AEXOS. Toda colocación de archivos debe seguir esta estructura._
