<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/specifications/docs-agent-technical-specification.md
...
**@docs (Ajax)** es un agente de IA especializado en crear **documentacion educativa** para AEXOS. A diferencia de la documentacion tecnica (JSDoc/Typedoc), Ajax se enfoca en **tutoriales, guias de incorporacion, explicadores visuales y materiales de capacitacion para socios**.
...
whenToUse: |
  ...
  - Tutoriales explicando como usar funciones de AEXOS
...
Entrada:
  ...
  - campo: agent_definition_path
    ...
    obligatorio: false
    example: "squads/aexos/agents/dev/agent.yaml"
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Usa estilo consistente (paleta de colores AEXOS)"
      blocker: false
...
whenToUse: |
  ...
  - Nuevo socio se une al ecosistema AEXOS
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Enlaces a documentacion AEXOS relevante"
      blocker: false
...
[Nombre del Agente] es el agente [rol] de AEXOS, especializado en [experiencia principal].
...
**Notas de Plantilla:**
- Usar paleta de colores AEXOS (Azul primario, Purpura secundario, Rosa terciario)
...
```bash
#!/bin/bash
# Hook de Auto-Actualizacion AEXOS @docs
...
jobs:
  check-docs:
    ...
    steps:
      ...
      - name: Instalar AEXOS CLI
        run: npm install -g @aexos/core
  ...
  qa-docs:
    ...
    steps:
      ...
      - name: Ejecutar QA de Documentacion
        id: qa
        run: |
          aexos agent invoke @docs --task qa-documentation \
            --paths "docs/**/*.md" \
...
- [ ] Crear `squads/aexos/agents/docs/agent.yaml`
...
- [ ] **Reconocimiento de Industria:** Docs de AEXOS citados como "mejor en espacio de agentes IA"
...
Con la adicion de @docs (Ajax), AEXOS ahora tiene **13 agentes nombrados**:
...
| 13 | @aexos-master | Orion | Comandante | Aries | Cian |
