<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/getting-started.md
...
# Primeros Pasos con AEXOS (Cyryx)

> 🌐 [EN](../getting-started.md) | [PT](../pt/getting-started.md) | **ES**

---

Bienvenido a AEXOS (Cyryx)! Esta guia te llevara a traves de tus primeros pasos con el framework de desarrollo auto-modificable impulsado por IA.
...
Antes de instalar AEXOS (Cyryx), asegurate de tener:
...
AEXOS (Cyryx) ofrece opciones de instalacion flexibles:
...
```
my-first-project/
├── .aexos/                    # Configuracion del framework
...
El archivo de configuracion principal (`.aexos/config.json`) contiene:
...
El meta-agente es el nucleo de AEXOS (Cyryx) - una IA que entiende y puede modificar su propia base de codigo.
...
- **[Tutoriales en Video](https://github.com/CyryxLabs/aexos-engine)**: Aprendizaje visual
...
- **Twitter**: Sigue [Cyryx support](https://cyryxlabs.com/contact)
...
Recuerda: AEXOS (Cyryx) aprende y mejora con el uso. Cuanto mas interactues con el, mejor entendera tu estilo de desarrollo y necesidades.

Feliz programacion con AEXOS (Cyryx)!
