<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/git-workflow-guide.md
...
# Guía de Flujo de Trabajo Git de AEXOS
...
AEXOS (Cyryx) implementa una estrategia de validación de **Defensa en Profundidad** con tres capas progresivas que detectan problemas tempranamente y aseguran la calidad del código antes del merge.
...
```bash
# Validación manual
node .aexos-core/utils/aexos-validator.js pre-push
node .aexos-core/utils/aexos-validator.js stories

# Validar una sola story
node .aexos-core/utils/aexos-validator.js story docs/stories/1.1-story.yaml
...
**Ubicación:** `.aexos-core/utils/aexos-validator.js`
...
- name: Validate story checkboxes
  run: node .aexos-core/utils/aexos-validator.js stories
```
...
# Verificar corrección
node .aexos-core/utils/aexos-validator.js story docs/stories/X.X-story.yaml
...
```javascript
// .aexos-core/utils/custom-validator.js
...
```bash
# .husky/pre-commit
node .aexos-core/utils/aexos-validator.js pre-commit
node .aexos-core/utils/custom-validator.js
```
...
- name: Custom validation
  run: node .aexos-core/utils/custom-validator.js
```
...
- **AEXOS Validator:** [.aexos-core/utils/aexos-validator.js](../../.aexos-core/utils/aexos-validator.js)
...
- [Abrir un Issue](https://github.com/CyryxLabs/aexos-engine/issues)
