<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/how-to-contribute-with-pull-requests.md
...
- **Para correcciones de bugs**: Crea un issue usando la [plantilla de reporte de bugs](https://github.com/CyryxLabs/aexos-engine/issues/new?template=bug_report.md)
- **Para nuevas features**:
  1. Discute en Discord en el [Cyryx support](https://cyryxlabs.com/contact)
  2. Crea un issue usando la [plantilla de solicitud de feature](https://github.com/CyryxLabs/aexos-engine/issues/new?template=feature_request.md)
...
1. Ve al [repositorio AEXOS (Cyryx)](https://github.com/CyryxLabs/aexos-engine)
...
- Reporta bugs usando la [plantilla de reporte de bugs](https://github.com/CyryxLabs/aexos-engine/issues/new?template=bug_report.md)
- Sugiere features usando la [plantilla de solicitud de feature](https://github.com/CyryxLabs/aexos-engine/issues/new?template=feature_request.md)
