<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/api/squads-api.md
...
> **Interfaz pública de Squads — availability boundary**
>
> AEXOS no publica en este repositorio un endpoint alojado de Squads ni un emisor de claves API verificado.
>
> **Portable content retained:** La interfaz pública disponible es local: carga y valida manifiestos de squads dentro del proyecto.
>
> **Unsupported prerequisite:** El endpoint privado y el flujo de claves descritos por el documento de origen no están disponibles y no deben reutilizarse.
<!-- Traduccion: ES | Original: /docs/en/api/squads-api.md | Sincronizacion: 2026-01-26 -->

# Referencia de la API de Squads

API REST para sincronizar squads con Cyryx Labs y descubrir squads del marketplace.

## Vision General

La API de Squads permite:

- **Sync**: Enviar squads locales a la nube de Cyryx Labs
...
Obtiene tu clave API de: AEXOS_HOSTED_SQUADS_ENDPOINT_UNAVAILABLE

## Endpoints

### Sincronizar Squad

Envia una definicion de squad a Cyryx Labs.
...
Elimina un squad de Cyryx Labs.
...
```json
{
  ...
  "data": {
    "valid": true,
    "errors": [],
    "warnings": ["Falta campo recomendado: description", "Falta campo aexos.minVersion"]
  }
}
```
...
{
  "info": {
    "name": "API de Squads Cyryx Labs",
    "description": "API REST para el Marketplace de Squads de Cyryx Labs",
