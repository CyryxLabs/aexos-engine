<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/DOCUMENTATION-ROADMAP.md
...
# Hoja de Ruta de Documentación de AEXOS
...
| `internal-tools-analysis.md`                      | `.aexos-core/infrastructure/tools/README.md`  | Referencia existente                 |
| `.aexos-core/core/registry/README.md`              | **YA EXISTE**                                | No se necesita acción                |
