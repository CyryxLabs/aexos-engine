<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/GUIDING-PRINCIPLES.md
...
# Principios Rectores del Método AEXOS

> 🌐 [EN](../GUIDING-PRINCIPLES.md) | [PT](../pt/GUIDING-PRINCIPLES.md) | **ES**

---

El Método AEXOS es un framework de lenguaje natural para el desarrollo de software asistido por IA. Estos principios aseguran que las contribuciones mantengan la efectividad del método.
...
Las plantillas siguen la especificación de [Plantilla de Documento AEXOS](../../common/utils/aexos-doc-template.md) usando formato YAML:
