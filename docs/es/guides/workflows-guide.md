<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/guides/workflows-guide.md
...
Los Workflows de AEXOS son secuencias orquestadas de actividades de agents que automatizan procesos de desarrollo complejos. Proporcionan patrones estructurados y repetibles para escenarios de desarrollo comunes.
...
El state se persiste en `.aexos/{instance-id}-state.yaml`:
...
AEXOS detecta patrones comunes de workflow basados en el historial de comandos:
...
| **Ubicacion** | `.aexos-core/development/workflows/` | `.aexos-core/development/tasks/` |
...
*Guia de Workflows de AEXOS v1.0 - Orquestando la Colaboracion IA-Humano*
