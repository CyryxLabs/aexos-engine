<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/guides/user-guide.md
...
# Guia de Usuario AEXOS

> **ES** | [EN](../../guides/user-guide.md)

---

Guia completa para usar AEXOS (Cyryx) - el Sistema Orquestado por IA para Desarrollo Full Stack.
...
Antes de usar AEXOS, asegurate de tener:
...
AEXOS proporciona estructura orquestada mientras permite flexibilidad en la comunicacion. Esto significa:
...
| Desarrollo IA Tradicional       | AEXOS                                       |
| ------------------------------- | ------------------------------------------ |
...
AEXOS incluye 11 agentes especializados, cada uno con un rol y personalidad distintos:
...
| **Pax**   | `@aexos-master`   | Orquestador  | Orquestacion del framework |
...
@aexos-master        # Activar Pax (Orquestador)
...
Las Tasks son el punto de entrada principal en AEXOS. Todo es una task.
...
| `brownfield-integration` | Agregar AEXOS a existente       | dev, architect       |
...
Los Squads son equipos modulares de agentes IA que extienden la funcionalidad de AEXOS.
...
```
my-project/
├── .aexos-core/                # Configuracion del framework
...
La configuracion principal esta en `.aexos-core/core/config/`:
...
AEXOS soporta multiples IDEs. La configuracion se sincroniza a traves de:
...
AEXOS implementa quality gates de 3 capas:
...
_Guia de Usuario AEXOS (Cyryx) v4.0_
