<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/guides/api-reference.md
...
-->
# Referencia de API AEXOS

> [EN](../../guides/api-reference.md) | [PT](../../pt/guides/api-reference.md) | **ES**

---

Referencia completa de la API para AEXOS (Cyryx) - el Sistema Orquestado por IA para Desarrollo Full Stack.
...
AEXOS proporciona una API unificada para interactuar con agentes de IA especializados a través de dos mecanismos principales:
...
| `@aexos-master`   | Orion  | Orchestrator | Orquestación del framework, meta-operaciones   |

### Comportamiento de Activación

Cuando se activa un agente:

1. Se carga el archivo de definición del agente desde `.aexos-core/development/agents/{id}.md`
...
*develop story-1.2.3
    │
    ▼
.aexos-core/development/tasks/dev-develop-story.md
    │
    ▼
...
### @aexos-master (Orquestador)

**Desarrollo del Framework:**

| Comando                | Argumentos      | Descripción                                    |
| ---------------------- | --------------- | ---------------------------------------------- |
| `*create`              | `{type} {name}` | Crear componente AEXOS (agent/task/workflow)    |
...
| `*kb`   | -                          | Alternar modo KB (conocimiento AEXOS Method)   |
...
```bash
# Iniciar workflow
@aexos-master *workflow greenfield-fullstack
...
| -------------------- | ---------------------------------- | -------------------------------------- |
| `AGENT_NOT_FOUND`    | Definición de agente faltante      | Verificar `.aexos-core/development/agents/` |
...
/aexos-master  → Activa agente @aexos-master
```
...
- [Guía de Usuario](./user-guide.md) - Comenzando con AEXOS
...
- [Guía de Squads](./squads-guide.md) - Extendiendo AEXOS con squads

---

_Synkra AEXOS API Reference v4.2.11_
