<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/guides/contributing-squads.md
...
Como contribuir squads al ecosistema AEXOS.

## Descripcion General

Hay dos formas de compartir tu squad con la comunidad:

1. **Repositorio aexos-squads** - Squads gratuitos y de codigo abierto en GitHub
2. **Marketplace de Cyryx Labs** - Squads premium via API de Cyryx Labs
...
| **Compatibilidad AEXOS** | `aexos.minVersion: "2.1.0"` o superior |
...
Esto:
1. Hara fork de `Cyryx Labs/aexos-squads` (si es necesario)
...
## Publicando en el Marketplace de Cyryx Labs

### Prerequisitos

1. Cuenta de Cyryx Labs
...
- **Preguntas**: [Discusiones de GitHub](https://github.com/CyryxLabs/aexos-engine/discussions)
- **Issues**: [Rastreador de Issues](https://github.com/CyryxLabs/aexos-engine/issues)
