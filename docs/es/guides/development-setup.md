<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/guides/development-setup.md
...
Guia completa para desarrolladores que quieren contribuir al proyecto AEXOS (Cyryx).
...
| -------------------- | ------------------------------------------- |
| **Claude Code**      | Desarrollo potenciado por IA con agentes AEXOS |
| **VS Code / Cursor** | IDE con integracion AEXOS                    |
...
1. Navega a [github.com/Cyryx Labs/aexos-core](https://github.com/CyryxLabs/aexos-engine)
...
```bash
# Clonar tu fork
git clone https://github.com/YOUR_USERNAME/aexos-engine.git
cd aexos-core

# Agregar remote upstream
git remote add upstream https://github.com/CyryxLabs/aexos-engine.git

# Verificar remotes
git remote -v
# origin    https://github.com/YOUR_USERNAME/aexos-engine.git (fetch)
# origin    https://github.com/YOUR_USERNAME/aexos-engine.git (push)
# upstream  https://github.com/CyryxLabs/aexos-engine.git (fetch)
# upstream  https://github.com/CyryxLabs/aexos-engine.git (push)
```
...
Sincroniza los agentes AEXOS con tu IDE:
...
Entendiendo la estructura de directorios de `aexos-core`:

```
aexos-core/
├── .aexos-core/                    # Fuente del framework (committed)
...
│   ├── commands/AEXOS/agents/      # Comandos skill de agentes
...
| ----------------------------------- | -------------------------------- | ------------------------- |
| `.aexos-core/development/agents/`    | Personas y comportamientos de agentes | Agregar/modificar agentes |
| `.aexos-core/development/tasks/`     | Workflows de tasks ejecutables   | Agregar/modificar tasks   |
| `.aexos-core/development/workflows/` | Orquestaciones multi-paso        | Crear workflows           |
...
Crea un nuevo archivo en `.aexos-core/development/agents/`:

```bash
# Archivo: .aexos-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Crear en .aexos-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Crear en .aexos-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crea un nuevo archivo en `.aexos-core/development/tasks/`:
...
# Ejemplos:
# .aexos-core/development/tasks/dev-build-component.md  (agente dev)
# .aexos-core/development/tasks/create-doc.md          (compartida)
```
...
## Definicion de Task (AEXOS Task Format V1.0)
...
Crea un nuevo archivo en `.aexos-core/development/workflows/`:

```bash
# Archivo: .aexos-core/development/workflows/my-workflow.yaml
```
...
npx js-yaml .aexos-core/development/agents/my-agent.md

# Verificar que existan dependencias
ls .aexos-core/development/tasks/my-task.md
```
...
AEXOS_DEBUG=true npm run trace -- workflow-name

# Verificar estado de workflow
cat .aexos/state/workflow-state.json
```
...
- **GitHub Discussions:** [github.com/Cyryx Labs/aexos-core/discussions](https://github.com/CyryxLabs/aexos-engine/discussions)
- **Issue Tracker:** [github.com/Cyryx Labs/aexos-core/issues](https://github.com/CyryxLabs/aexos-engine/issues)
- **Discord:** [Cyryx support](https://cyryxlabs.com/contact)
...
- Etiquetar `@Cyryx Labs/core-team` para issues urgentes
...
_Synkra AEXOS Guia de Configuracion para Desarrollo v1.0.0_
