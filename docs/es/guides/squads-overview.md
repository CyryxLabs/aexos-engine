<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/guides/squads-overview.md
...
Introduccion a AEXOS Squads - equipos modulares de agentes IA que extienden la funcionalidad del framework.
...
Los Squads son equipos modulares de agentes IA que extienden la funcionalidad de AEXOS para dominios o casos de uso especificos. Cada squad es un paquete autocontenido que puede ser instalado, compartido y compuesto con otros squads.

> **AEXOS Squads:** Equipos de agentes IA trabajando contigo
...
| Agentes Tradicionales      | AEXOS Squads                    |
| -------------------------- | ------------------------------ |
...
│  Nivel 2: AEXOS-SQUADS  --> github.com/Cyryx Labs (Publico)    │
...
Las tasks deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).

### 2. Usar Herencia de Config Sabiamente

| Modo       | Comportamiento                              |
| ---------- | ------------------------------------------- |
| `extend`   | Agregar reglas del squad a reglas core AEXOS |
...
- **Aprender Formato de Tasks:** Leer [TASK-FORMAT-SPECIFICATION-V1](../../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Especificacion de Formato de Tasks](../../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_AEXOS Squads: Equipos de agentes IA trabajando contigo_
