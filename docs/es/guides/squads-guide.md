<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/guides/squads-guide.md
...
Guia completa para crear, validar, publicar y gestionar Squads en AEXOS.

> **AEXOS Squads:** Equipos de agentes de IA trabajando contigo
...
Los Squads son equipos modulares de agentes de IA que extienden la funcionalidad de AEXOS. Cada squad es un paquete autocontenido que incluye:
...
│  Nivel 2: AEXOS-SQUADS  → github.com/Cyryx Labs (Publico/Gratis)│
...
- Node.js 18+
- Proyecto AEXOS inicializado (`.aexos-core/` existe)
...
Las tareas deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.aexos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Modo       | Comportamiento                                     |
| ---------- | -------------------------------------------------- |
| `extend`   | Agregar reglas del squad a las reglas base de AEXOS |
...
### Nivel 2: Repositorio aexos-squads (Publico)
...
### Nivel 3: Marketplace de Cyryx Labs
...
3. **Agregar Campos** - `aexos.type`, `aexos.minVersion`
...
# - aexos.type: debe ser "squad"
# - aexos.minVersion: debe ser semver valido
```
...
### Cual es la diferencia entre un Squad y formatos legados de squad en AEXOS?

**Squads** son el formato estandar en AEXOS 2.1+ con:
...
### Cual es la version minima de AEXOS para Squads?

Los Squads requieren AEXOS 2.1.0+. Configurar en el manifiesto:
...
- [Agente @squad-creator](../../../.aexos-core/development/agents/squad-creator.md)
...
- [Discusiones de GitHub](https://github.com/CyryxLabs/aexos-engine/discussions)
- [Rastreador de Issues](https://github.com/CyryxLabs/aexos-engine/issues)

---

_AEXOS Squads: Equipos de agentes de IA trabajando contigo_
