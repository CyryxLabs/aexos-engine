<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/CHANGELOG.md
...
Todos los cambios notables en AEXOS (Cyryx) seran documentados en este archivo.
...
- **Estructura de Directorios**: Renombrado `.legacy-core/` a `.aexos-core/`
...
- **Configuracion de IDE**: Agentes de Claude Code movidos a `.claude/commands/AEXOS/agents/`
- **Ubicaciones de Archivos**:
  ...
  - `.aexos-core/utils/` → `.aexos-core/scripts/`
...
- Proceso de instalacion manual (usar `npx @aexos/core install` en su lugar)
...
- Lanzamiento publico inicial de AEXOS (Cyryx)
...
**Cambios clave:**
1. Directorio renombrado: `.legacy-core/` → `.aexos-core/`
...
- [Repositorio GitHub](https://github.com/CyryxLabs/aexos-engine)
