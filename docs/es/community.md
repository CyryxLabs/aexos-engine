<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/community.md
...
-->
# Comunidad de AEXOS (Cyryx)

> 🇧🇷 [Versão em Português](COMMUNITY-PT.md)

¡Bienvenido a la comunidad de AEXOS (Cyryx)!
...
4. Preséntate en [Discussions](https://github.com/CyryxLabs/aexos-engine/discussions)

### Encuentra tu Primera Contribución

- Busca issues etiquetados como [`good-first-issue`](https://github.com/CyryxLabs/aexos-engine/labels/good-first-issue)
- Revisa [`help-wanted`](https://github.com/CyryxLabs/aexos-engine/labels/help-wanted) para tareas más complejas
- Explora las [Discussions abiertas](https://github.com/CyryxLabs/aexos-engine/discussions) para ayudar a otros

## Canales de Comunicación

### GitHub Discussions (Principal)

Nuestro centro de comunicación principal para todos los repositorios AEXOS:

- **Announcements** - Actualizaciones del proyecto de los mantenedores
- **General** - Discusiones generales sobre AEXOS
- **Ideas** - Propón nuevas características y mejoras
- **Q&A** - Obtén ayuda con preguntas técnicas
- **Show and Tell** - Comparte tus proyectos usando AEXOS
- **Troubleshooting** - Obtén ayuda con problemas
- **Squads** - Discusiones sobre AEXOS Squads (equipos de agentes modulares)
- **MCP Ecosystem** - Discusiones sobre herramientas e integraciones MCP

[Únete a la Discusión](https://github.com/CyryxLabs/aexos-engine/discussions)

### Issue Tracker

Para reportes de bugs y solicitudes de características:

- [aexos-core Issues](https://github.com/CyryxLabs/aexos-engine/issues) - Framework principal
- [aiox-squads Issues](https://github.com/SynkraAI/aiox-squads/issues) - AEXOS Squads
...
Cualquiera que haya contribuido a AEXOS de cualquier manera.
- Listados en nuestra [página de Contribuidores](https://github.com/CyryxLabs/aexos-engine/graphs/contributors)
...
- [@Cyryx Labs](https://github.com/SynkraAI) - Líder del Proyecto
...
Todos los contribuidores son reconocidos en nuestra [página de Contribuidores](https://github.com/CyryxLabs/aexos-engine/graphs/contributors).
...
Reporta violaciones a: conduct@Cyryx Labs.com
...
2. Busca en [Discussions existentes](https://github.com/CyryxLabs/aexos-engine/discussions)
3. Pregunta en Q&A Discussions
4. Abre una discusión de Troubleshooting

### ¿Encontraste un bug?

1. Busca en [issues existentes](https://github.com/CyryxLabs/aexos-engine/issues)
2. Si es nuevo, [abre un reporte de bug](https://github.com/CyryxLabs/aexos-engine/issues/new?template=bug_report.md)

### ¿Tienes una idea?

1. Verifica si existe en [Ideas](https://github.com/CyryxLabs/aexos-engine/discussions/categories/ideas)
2. Si es nueva, [comparte tu idea](https://github.com/CyryxLabs/aexos-engine/discussions/new?category=ideas)
3. Lee nuestro [Proceso de Solicitud de Características](docs/FEATURE_PROCESS.md) para guías detalladas

## Hoja de Ruta del Proyecto

¿Quieres saber hacia dónde se dirige AEXOS? Consulta nuestra hoja de ruta pública:
...
1. **Votando** en ideas en [Discussions](https://github.com/CyryxLabs/aexos-engine/discussions/categories/ideas)
...
- [Guía de Usuario](.aexos-core/user-guide.md)

### Recursos Externos

- [Organización de AEXOS en GitHub](https://github.com/SynkraAI)
...
- Versión Actual: Ver [releases](https://github.com/CyryxLabs/aexos-engine/releases)
...
**¡Gracias por ser parte de la comunidad AEXOS!**

---

*Este documento es mantenido por la comunidad AEXOS.*
