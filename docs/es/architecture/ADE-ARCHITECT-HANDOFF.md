<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/architecture/ADE-ARCHITECT-HANDOFF.md
...
> **Fecha:** 2026-01-28
> **Proyecto:** AEXOS Autonomous Development Engine (ADE)

---

## Resumen Ejecutivo

El ADE es un proyecto de **Prompt Engineering + Infraestructura** para habilitar ejecución autónoma de desarrollo en AEXOS. Aproximadamente **60% del trabajo es creación de tasks .md, workflows .yaml y templates** - no código tradicional.
...
- `docs/prd/aexos-autonomous-development-engine.md`

### Stories

- `docs/stories/aexos-core-ade/` (7 archivos de epic + README)

### Quality Gates

- `docs/qa/gates/aexos-core-ade/` (7 archivos de gate + README)

### Referencia

- `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md` (patrones del Auto-Claude)
- `.aexos-core/core-config.yaml` (configuración central)
...
1. **Leer el PRD completo** - `docs/prd/aexos-autonomous-development-engine.md`
