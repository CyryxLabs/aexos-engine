<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/architecture/adr/ADR-COLLAB-2-proposed-configuration.md
...
Siguiendo la [Auditoria de Estado Actual](./ADR-COLLAB-1-current-state-audit.md), este documento propone cambios de configuracion especificos para habilitar contribuciones externas seguras a AEXOS.
...
```bash
gh api repos/Cyryx Labs/aexos-core/branches/main/protection -X PUT \
...
# Configuracion CodeRabbit para AEXOS
# Historia: COLLAB-1
...
reviews:
  ...
  path_instructions:
    ...
    '.aexos-core/development/agents/**':
      - 'Verificar que el agente sigue la estructura YAML de agentes AEXOS (persona_profile, commands, dependencies)'
    ...
    '.aexos-core/development/tasks/**':
      - 'Verificar que la tarea sigue el formato de tareas AEXOS con puntos de elicitacion claros'
    ...
    '.aexos-core/product/templates/**':
      - 'Asegurar que la plantilla sigue las convenciones de plantillas AEXOS'
    ...
    '**/*.js':
      ...
      - 'Asegurar que el codigo sigue los estandares de codigo AEXOS'
...
# ============================================
* @Cyryx Labs/maintainers

# ============================================
# Framework Core
# ============================================
# Definiciones de agentes - requiere revision del equipo core
.aexos-core/development/agents/ @Cyryx Labs/core-team

# Definiciones de tareas - requiere revision del equipo core
.aexos-core/development/tasks/ @Cyryx Labs/core-team

# Definiciones de workflows - requiere revision del equipo core
.aexos-core/development/workflows/ @Cyryx Labs/core-team

# Plantillas - requiere revision de arquitecto/equipo core
.aexos-core/product/templates/ @Cyryx Labs/core-team
templates/ @Cyryx Labs/core-team

# Utilidades core - requiere revision senior
.aexos-core/core/ @Cyryx Labs/core-team
.aexos-core/cli/ @Cyryx Labs/core-team

# ============================================
# Infraestructura
# ============================================
# CI/CD - requiere aprobacion de devops
.github/ @Cyryx Labs/devops

# Configuraciones de Docker
.docker/ @Cyryx Labs/devops

# Archivos de configuracion
.aexos-core/core-config.yaml @Cyryx Labs/core-team
package.json @Cyryx Labs/maintainers
package-lock.json @Cyryx Labs/maintainers

# ============================================
# Documentacion (Mas Permisiva)
# ============================================
# Documentacion general - mantenedores pueden aprobar
docs/ @Cyryx Labs/maintainers

# Decisiones de arquitectura - requiere equipo core
docs/architecture/ @Cyryx Labs/core-team
docs/framework/ @Cyryx Labs/core-team

# Historias - mantenedores (documentacion de desarrollo interno)
docs/stories/ @Cyryx Labs/maintainers

# Guias - mantenedores (amigable para contribuidores)
docs/guides/ @Cyryx Labs/maintainers

# ============================================
# Archivos Sensibles de Seguridad
# ============================================
# Configuraciones de seguridad
.github/CODEOWNERS @Cyryx Labs/core-team
.github/workflows/semantic-release.yml @Cyryx Labs/devops
.github/workflows/npm-publish.yml @Cyryx Labs/devops

# Archivos de configuracion raiz
.env* @Cyryx Labs/core-team
*.config.js @Cyryx Labs/maintainers
```

**Equipos de GitHub Requeridos:**

- `@Cyryx Labs/maintainers` - Mantenedores generales (acceso de escritura)
- `@Cyryx Labs/core-team` - Desarrolladores core del framework
- `@Cyryx Labs/devops` - CI/CD e infraestructura
...
- [ ] El agente sigue la estructura YAML de agentes AEXOS
...
- [ ] La tarea sigue el formato de tareas AEXOS
...
gh api -X DELETE repos/Cyryx Labs/aexos-core/branches/main/protection
...
echo "* @Cyryx Labs" > .github/CODEOWNERS
