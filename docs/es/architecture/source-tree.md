<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/architecture/source-tree.md
...
# Estructura del Arbol de Codigo Fuente AEXOS
...
**Aviso de Migracion:** Este documento migrara al repositorio `Cyryx Labs/aexos-core` en Q2 2026 (ver Decision 005)
...
- [Estructura Actual (aexos-core Brownfield)](#estructura-actual-aexos-core-brownfield)
...
AEXOS usa una **arquitectura de doble capa**:

1. **Framework Core** (`.aexos-core/`) - Componentes portables del framework
...
## Estructura Actual (aexos-core Brownfield)

```
aexos-core/                             # Raiz (proyecto brownfield)
├── .aexos-core/                        # Framework core (portable)
...
│
├── bin/                               # Ejecutables CLI
│   ├── aexos-core.js           # Punto de entrada principal del CLI
│   └── aexos-minimal.js                # CLI minimo
│
...
**Proposito:** Componentes portables del framework que funcionan en cualquier proyecto AEXOS.
...
│
├── stories/                           # Historias de desarrollo
│   ├── aexos migration/                # Historias de migracion AEXOS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a AEXOS. A diferencia de los Paquetes de Expansion obsoletos, los Squads siguen una estructura de plantilla estandarizada.
...
│   └── cli/                           # Interfaz CLI
│
├── .aexos-core/                        # Assets del framework (estructura actual)
│   ├── agents/
│   ├── tasks/
│   ├── templates/
│   └── ...
...
Ubicacion: .aexos-core/agents/{nombre-agente}.md
Ejemplo: .aexos-core/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicacion: .aexos-core/tasks/{nombre-tarea}.md
Ejemplo: .aexos-core/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicacion: .aexos-core/workflows/{nombre-workflow}.yaml
Ejemplo: .aexos-core/workflows/continuous-deployment.yaml

# Estoy creando una nueva plantilla:
Ubicacion: .aexos-core/product/templates/{nombre-plantilla}-tmpl.{yaml|md}
...
Ejemplo: docs/stories/aexos migration/story-6.1.2.6.md
...
Ubicacion: .aexos-core/utils/{nombre-utilidad}.js
Ejemplo: .aexos-core/utils/performance-monitor.js
...
| 1.1     | 2025-12-14 | Actualizada org a Cyryx Labs, reemplazados Paquetes de Expansion con sistema de Squads [Story 6.10] | Dex (dev)        |

---

_Este es un estandar oficial del framework AEXOS. Toda colocacion de archivos debe seguir esta estructura._
