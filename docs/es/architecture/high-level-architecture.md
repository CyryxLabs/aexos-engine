<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/architecture/high-level-architecture.md
...
# Arquitectura de Alto Nivel AEXOS v4
...
**AEXOS (AI Operating System)** es un framework sofisticado para orquestar agentes de IA, workers y humanos en flujos de trabajo complejos de desarrollo de software. La versión 2.1 introduce una arquitectura modular con 4 módulos, estrategia multi-repositorio y quality gates de 3 capas.
...
| ------------------ | ---------------------------- | ------------------------ | ----------------------------------- |
| **Core**           | `.aexos-core/core/`           | Fundación del framework  | Config, Registry, QG, MCP, Session  |
| **Development**    | `.aexos-core/development/`    | Artefactos de desarrollo | Agentes, Tareas, Workflows, Scripts |
| **Product**        | `.aexos-core/product/`        | Artefactos PM            | Plantillas, Checklists, Data        |
| **Infrastructure** | `.aexos-core/infrastructure/` | Config del sistema       | Scripts, Tools, Integraciones       |
...
| Pax    | `aexos-master`   | Orquestador  | Orquestación del framework |
...
- [AEXOS-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.aexos-core/docs/standards/AEXOS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guía completa del framework
