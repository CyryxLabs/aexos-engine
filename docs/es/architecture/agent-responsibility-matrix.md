<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/architecture/agent-responsibility-matrix.md
...
Este documento define límites claros de responsabilidad para todos los agentes AEXOS, con enfoque particular en:
...
1. **Hook Git Pre-Push** (Aplicación Primaria)
   ...
   - Verifica: Variable de entorno `$AEXOS_ACTIVE_AGENT`
...
- [ ] **Crear Hook Git Pre-Push**
  - Ubicación: `.git/hooks/pre-push`
  - Contenido: Verificar `$AEXOS_ACTIVE_AGENT`, bloquear si != "github-devops"
...
- [ ] **Actualizar Scripts de Activación de Agentes**
  - Agregar configuración de variable de entorno: `AEXOS_ACTIVE_AGENT={agent_id}`
  - Configurar `AEXOS_GIT_PUSH_ALLOWED` apropiadamente
