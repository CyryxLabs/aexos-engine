<!--
  AEXOS localization provenance: adapted from https://github.com/SynkraAI/aiox-core/blob/4ef6530ff03b83aea953e4a426f95e012b8b70c5/docs/es/architecture/utility-integration-guide.md
...
**Propósito:** Definir patrones estándar para integrar scripts de utilidades en el framework AEXOS

---

## ¿Qué es la Integración de Utilidades?

**Definición:** La integración de utilidades es el proceso de hacer que un script de utilidad huérfano sea **descubrible, documentado y utilizable** dentro del framework AEXOS.
...
- `.aexos-core/agents/{agent}.yaml` (agregar a dependencies.utils)
- `.aexos-core/core-config.yaml` (registrar si es necesario)
- `.aexos-core/utils/README.md` (documentar utilidad)
...
```yaml
# .aexos-core/tasks/generate-commit-message.md
...
**Archivos Modificados:**
- `.aexos-core/tasks/{task}.md` (agregar execution.utils)
- `.aexos-core/agents/{agent}.yaml` (agregar tarea a lista executes)
- `.aexos-core/core-config.yaml` (registrar si es necesario)
- `.aexos-core/utils/README.md` (documentar utilidad)
...
**Archivos Modificados:**
- `.aexos-core/core-config.yaml` (registrar bajo framework)
- `.aexos-core/utils/README.md` (documentar como utilidad de framework)
...
```yaml
# .aexos-core/agents/architect.yaml
dependencies:
  utils:
...
**Archivos Modificados:**
- `.aexos-core/agents/{agent}.yaml`
- `.aexos-core/tasks/{task}.md` (si se crea tarea)
- `.aexos-core/core-config.yaml`
- `.aexos-core/utils/README.md`
...
**Ejemplos:** aexos-validator, code-quality-improver, coverage-analyzer
...
const utility = require('.aexos-core/utils/{utility-name}');
...
**Ubicación:** `.aexos-core/utils/{name}.js`
