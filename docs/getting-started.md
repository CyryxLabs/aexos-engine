...
AEXOS 1.0.0 is distributed through the GitHub release artifact below. The npm registry retains the previous version line.

There are two commands and they are not interchangeable:

```bash
# New project — `init` creates the directory and REQUIRES a name
npx --yes --package=https://github.com/CyryxLabs/aexos-engine/releases/download/v1.0.0/aexos-core-1.0.0.tgz aexos init my-first-project
cd my-first-project
```
...
npx --yes --package=https://github.com/CyryxLabs/aexos-engine/releases/download/v1.0.0/aexos-core-1.0.0.tgz aexos init my-project --template enterprise
...
npx --yes --package=https://github.com/CyryxLabs/aexos-engine/releases/download/v1.0.0/aexos-core-1.0.0.tgz aexos init my-project --force

# 4. Skip dependency installation (manual install later)
npx --yes --package=https://github.com/CyryxLabs/aexos-engine/releases/download/v1.0.0/aexos-core-1.0.0.tgz aexos init my-project --skip-install
```
...
```bash
npx --yes --package=https://github.com/CyryxLabs/aexos-engine/releases/download/v1.0.0/aexos-core-1.0.0.tgz aexos doctor
```
...
npx --yes --package=https://github.com/CyryxLabs/aexos-engine/releases/download/v1.0.0/aexos-core-1.0.0.tgz aexos doctor --fix
```
