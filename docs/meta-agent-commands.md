...
```bash
AEXOS_AI_PROVIDER=openai          # AI provider
AEXOS_AI_MODEL=gpt-4             # AI model
AEXOS_LOG_LEVEL=debug            # Log level
AEXOS_TELEMETRY=disabled         # Telemetry setting
AEXOS_TIMEOUT=30000             # Command timeout (ms)
AEXOS_MEMORY_CACHE=true         # Memory caching
```
