...
git clone https://github.com/CyryxLabs/AEXOS.git ~/.aexos-core-source
...
2. Configure AEXOS rules in `.continue/`
...
# Config files: ~/.config/cyryx/
# Cache: ~/.cache/cyryx/
# State: ~/.local/state/cyryx/
```
...
- Back up any customizations to `.aexos-backup/`
...
```bash
# Remove AEXOS from a project
rm -rf .aexos-core .claude/commands/AEXOS

# Remove global installation
rm -rf ~/.aexos-core-source ~/.npm-global/lib/node_modules/@cyryx
```
