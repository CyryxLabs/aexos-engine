...
Welcome to the AEXOS community!
...
4. Introduce yourself in [Discussions](https://github.com/CyryxLabs/AEXOS/discussions)

### Find Your First Contribution

- Look for issues labeled [`good-first-issue`](https://github.com/CyryxLabs/AEXOS/labels/good-first-issue)
- Check [`help-wanted`](https://github.com/CyryxLabs/AEXOS/labels/help-wanted) for more complex tasks
- Browse [open Discussions](https://github.com/CyryxLabs/AEXOS/discussions) to help others

## Communication Channels

### GitHub Discussions (Primary)

Our main communication hub for all AEXOS repositories:

- **Announcements** - Project updates from maintainers
- **General** - General discussions about AEXOS
- **Ideas** - Propose new features and improvements
- **Q&A** - Get help with technical questions
- **Show and Tell** - Share your projects using AEXOS
- **Troubleshooting** - Get help with problems
- **Squads** - Discussions about AEXOS Squads (modular agent teams)
- **MCP Ecosystem** - Discussions about MCP tools and integrations

[Join the Discussion](https://github.com/CyryxLabs/AEXOS/discussions)

### Issue Tracker

For bug reports and feature requests:

- [aexos-core Issues](https://github.com/CyryxLabs/AEXOS/issues) - Core framework
- [aexos-squads Issues](https://github.com/CyryxLabs/aexos-squads/issues) - AEXOS Squads
- [mcp-ecosystem Issues](https://github.com/CyryxLabs/mcp-ecosystem/issues) - MCP tools
...
Anyone who has contributed to AEXOS in any way.
- Listed in our [Contributors page](https://github.com/CyryxLabs/AEXOS/graphs/contributors)
...
- [@CyryxLabs](https://github.com/CyryxLabs) - Project Lead
...
All contributors are recognized in our [Contributors page](https://github.com/CyryxLabs/AEXOS/graphs/contributors).
...
Report violations to: conduct@cyryx.ai
...
2. Search [existing Discussions](https://github.com/CyryxLabs/AEXOS/discussions)
3. Ask in Q&A Discussions
4. Open a Troubleshooting discussion

### Found a bug?

1. Search [existing issues](https://github.com/CyryxLabs/AEXOS/issues)
2. If new, [open a bug report](https://github.com/CyryxLabs/AEXOS/issues/new?template=bug_report.md)

### Have an idea?

1. Check if it exists in [Ideas](https://github.com/CyryxLabs/AEXOS/discussions/categories/ideas)
2. If new, [share your idea](https://github.com/CyryxLabs/AEXOS/discussions/new?category=ideas)
3. Read our [Feature Request Process](docs/FEATURE_PROCESS.md) for detailed guidelines

## Project Roadmap

Want to know where AEXOS is headed? Check out our public roadmap:

- [ROADMAP.md](ROADMAP.md) - High-level vision and planned features
- [GitHub Project](https://github.com/orgs/CyryxLabs/projects/1) - Detailed tracking board

The roadmap is updated monthly and reflects community input. You can influence our direction by:

1. **Voting** on ideas in [Discussions](https://github.com/CyryxLabs/AEXOS/discussions/categories/ideas)
...
- [AEXOS GitHub Organization](https://github.com/CyryxLabs)
...
- Current Version: See [releases](https://github.com/CyryxLabs/AEXOS/releases)
...
**Thank you for being part of the AEXOS community!**

---

*This document is maintained by the AEXOS community.*
