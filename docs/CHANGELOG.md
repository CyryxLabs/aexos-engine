...
- **🤖 AEXOS Autonomous Development Engine (ADE)**: Complete autonomous development system with 7 Epics:
...
- **Agent Sync**: All agents now synced between `.aexos-core/development/agents/` and `.claude/commands/AEXOS/agents/`
...
- **Directory Structure**: Renamed `.legacy-core/` to `.aexos-core/`
...
- **IDE Configuration**: Claude Code agents moved to `.claude/commands/AEXOS/agents/`
- **File Locations**:
...
- Initial public release of AEXOS (Cyryx)
...
1. Directory renamed: `.legacy-core/` → `.aexos-core/`
...
- [GitHub Repository](https://github.com/CyryxLabs/AEXOS)
