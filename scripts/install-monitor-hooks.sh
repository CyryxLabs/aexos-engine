#!/bin/bash
#
# AEXOS Monitor Hooks Installation Script
#
# This script installs the AEXOS monitor hooks into ~/.claude/hooks/
...
AEXOS_ROOT="$(dirname "$SCRIPT_DIR")"
HOOKS_SOURCE="$AEXOS_ROOT/.aexos-core/monitor/hooks"
HOOKS_TARGET="$HOME/.claude/hooks"

echo "╔════════════════════════════════════════════════════════════════╗"
echo "║              AEXOS Monitor Hooks Installer                      ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "║     export AEXOS_MONITOR_URL=http://localhost:4001              ║"
echo "║                                                                ║"
