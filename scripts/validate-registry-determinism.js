 ...
 * compares the output against the committed `.aexos-core/data/entity-registry.yaml`.
...
const REGISTRY_PATH = path.join(REPO_ROOT, '.aexos-core', 'data', 'entity-registry.yaml');
const POPULATOR_PATH = path.join(REPO_ROOT, '.aexos-core', 'development', 'scripts', 'populate-entity-registry.js');
...
function fail(message, details) {
  ...
  console.error('     node .aexos-core/development/scripts/populate-entity-registry.js');
  console.error('     git add .aexos-core/data/entity-registry.yaml');
