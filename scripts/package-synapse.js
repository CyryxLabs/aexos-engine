...
const FILES = {
  // Core Engine
  'core/engine.js': '.aexos-core/core/synapse/engine.js',
  'core/context/context-tracker.js': '.aexos-core/core/synapse/context/context-tracker.js',
  'core/domain/domain-loader.js': '.aexos-core/core/synapse/domain/domain-loader.js',
  'core/layers/layer-processor.js': '.aexos-core/core/synapse/layers/layer-processor.js',
  'core/layers/l0-constitution.js': '.aexos-core/core/synapse/layers/l0-constitution.js',
  'core/layers/l1-global.js': '.aexos-core/core/synapse/layers/l1-global.js',
  'core/layers/l2-agent.js': '.aexos-core/core/synapse/layers/l2-agent.js',
  'core/layers/l3-workflow.js': '.aexos-core/core/synapse/layers/l3-workflow.js',
  'core/layers/l4-task.js': '.aexos-core/core/synapse/layers/l4-task.js',
  'core/layers/l5-squad.js': '.aexos-core/core/synapse/layers/l5-squad.js',
  'core/layers/l6-keyword.js': '.aexos-core/core/synapse/layers/l6-keyword.js',
  ...
  'core/utils/tokens.js': '.aexos-core/core/synapse/utils/tokens.js',

  // Diagnostics
  'core/diagnostics/synapse-diagnostics.js': '.aexos-core/core/synapse/diagnostics/synapse-diagnostics.js',
  'core/diagnostics/report-formatter.js': '.aexos-core/core/synapse/diagnostics/report-formatter.js',
  'core/diagnostics/collectors/safe-read-json.js': '.aexos-core/core/synapse/diagnostics/collectors/safe-read-json.js',
  'core/diagnostics/collectors/hook-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/hook-collector.js',
  'core/diagnostics/collectors/session-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/session-collector.js',
  'core/diagnostics/collectors/manifest-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/manifest-collector.js',
  'core/diagnostics/collectors/pipeline-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/pipeline-collector.js',
  'core/diagnostics/collectors/uap-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/uap-collector.js',
  'core/diagnostics/collectors/timing-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/timing-collector.js',
  'core/diagnostics/collectors/quality-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/quality-collector.js',
  'core/diagnostics/collectors/consistency-collector.js': '.aexos-core/core/synapse/diagnostics/collectors/consistency-collector.js',
...
const RUNTIME_DOMAINS = [
  ...
  'agent-ux', 'agent-aexos-master', 'agent-squad-creator',
...
SYNAPSE (AEXOS Adaptive Processing & State Engine) is the JIT context injection
engine for AEXOS. On every user prompt, it injects \`<synapse-rules>\` with adaptive
...
\`\`\`
cp -r core/ <your-project>/.aexos-core/core/synapse/
\`\`\`
...
├── core/                      # Engine source (.aexos-core/core/synapse/)
...
*SYNAPSE Context Engine v2.0 — AEXOS (Cyryx)*
