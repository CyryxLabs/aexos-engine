---
metadata:
  short-description: "AEXOS workflow: aexos-validate-story-draft"
name: aexos-validate-story-draft
description: >
...
`.aexos-core/development/tasks/validate-next-story.md`

Fallback if project uses the dev-side validator:

`.aexos-core/development/tasks/dev-validate-next-story.md`
