/**
 * InstallTransaction - Transaction manager for AEXOS installer
 *
...
class InstallTransaction {
   ...
   */
  constructor(options = {}) {
    this.backupDir = options.backupDir || path.join(process.cwd(), '.aexos-backup', this._generateTimestamp());
    this.logFile = options.logFile || path.join(process.cwd(), '.aexos-install.log');
   ...
   *
   * @example
   * await transaction.backupDirectory('.aexos-core/');
   */
