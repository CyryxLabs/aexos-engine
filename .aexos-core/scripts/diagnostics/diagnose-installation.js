#!/usr/bin/env node
/**
 * AEXOS-Core Installation Diagnostic Tool
 *
 * Run this script to diagnose installation issues:
 *   node diagnose-installation.js
 *
 * Or directly from URL:
 *   npx https://raw.githubusercontent.com/CyryxLabs/AEXOS/main/tools/diagnose-installation.js
 */
...
console.log('');
console.log('╔══════════════════════════════════════════════════════════════════╗');
console.log('║          AEXOS-Core Installation Diagnostic Tool                  ║');
console.log('╚══════════════════════════════════════════════════════════════════╝');
console.log('');
...
const pkgInfo = exec('npm view aexos-core version 2>&1');
if (pkgInfo && !pkgInfo.includes('E404') && !pkgInfo.includes('error')) {
  console.log(`  ✓ aexos-core v${pkgInfo} is available on npm`);
} else {
  console.log('  ⚠️  Cannot verify aexos-core package availability');
...
console.log('  Testing: npx @aexos/core --version');
const npxTest = exec('npx @aexos/core --version 2>&1');
...
const summaryFile = path.join(os.tmpdir(), 'aexos-diagnostic-result.json');
