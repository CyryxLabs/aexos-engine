# AEXOS-Core Quick Diagnostic - Run this in PowerShell
# Usage: Copy and paste this entire script into PowerShell on the target machine

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "   AEXOS-Core Quick Diagnostic" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$registryTest = & npm view aexos-core version 2>$null
if ($registryTest) {
    Write-Host "  aexos-core v$registryTest available" -ForegroundColor Green
} else {
...
# Test npx aexos-core
Write-Host ""
Write-Host "Testing: npx aexos-core@latest --version" -ForegroundColor Yellow
Write-Host "(This may take a moment...)" -ForegroundColor Gray
try {
    $result = & npx aexos-core@latest --version 2>&1
...
Write-Host "  npx aexos-core@latest" -ForegroundColor White
Write-Host ""
