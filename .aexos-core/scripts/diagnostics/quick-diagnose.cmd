...
echo.
echo ========================================
echo    AEXOS-Core Quick Diagnostic (CMD)
echo ========================================
echo.
...
echo.
echo Checking aexos-core availability on npm...
npm view aexos-core version 2>nul
if %errorlevel% neq 0 (
    echo   ERROR: Cannot access npm registry!
    echo   Check your internet/firewall settings
) else (
    echo   aexos-core: Available
)

echo.
echo ========================================
echo    Testing npx aexos-core@latest
echo ========================================
echo.
echo Running: npx aexos-core@latest --version
echo (This may take a moment on first run...)
echo.
npx aexos-core@latest --version
if %errorlevel% neq 0 (
    echo.
    echo   ERROR: npx aexos-core failed!
    echo.
    echo Common fixes:
