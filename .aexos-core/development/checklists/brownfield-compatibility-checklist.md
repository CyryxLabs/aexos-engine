...
> Story AEXOS-DIFF-4.3.2: Checklist formal de compatibilidade retroativa
...
- [ ] `.env` files backed up (never overwritten by AEXOS)
...
- [ ] `git diff HEAD~1` shows only AEXOS additions
- [ ] `git checkout HEAD~1 -- .` would restore pre-AEXOS state
- [ ] No orphaned AEXOS processes or files

---

## Compatibility Matrix

| Existing Config | AEXOS Behavior | User Action Required |
|-----------------|---------------|---------------------|
...
# Option 2: Remove only AEXOS files
rm -rf .aexos-core/
rm -rf docs/architecture/ docs/prd/ docs/stories/
# Review and revert .gitignore AEXOS entries
...
*AEXOS Brownfield Compatibility Checklist v1.0*
*Story AEXOS-DIFF-4.3.2*
