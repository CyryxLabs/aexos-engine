 ...
 * @see .aexos-core/scripts/decision-log-generator.js - Generates final log from this context
 */

const { readGitHead } = require('../../core/utils/git-head');
