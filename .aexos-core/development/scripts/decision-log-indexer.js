...
async function loadConfig() {
  ...
  try {
    const configContent = await fs.readFile('.aexos-core/core-config.yaml', 'utf8');
...
- [Core Configuration](.aexos-core/core-config.yaml)
...
*To manually rebuild the index, run: node .aexos-core/scripts/decision-log-indexer.js rebuild*
`;
