  ...
  async buildGreeting(agent, context = {}) {
    ...
    try {
      ...
      const timeoutPromise = new Promise((_, reject) => {
        ...
        timeout = setTimeout(() => reject(new Error('Greeting timeout')), Math.max(0, GREETING_TIMEOUT - elapsedMs));
      });
    ...
    const patterns = [
      {
        ...
        priority: 1,
        desc: 'do **`.aexos-core/scripts/greeting-builder.js`**',
        category: 'script',
      },
      {
