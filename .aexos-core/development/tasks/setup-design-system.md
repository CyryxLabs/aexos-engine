...
- **Host binding:** project-scaffolder
  - **Purpose:** Generate project structure and config
  - **Availability:** `.aexos-core/scripts/project-scaffolder.js` is not distributed; use a concrete host or project tool that satisfies the substantive task steps, or treat the capability as blocked.

- **Host binding:** config-manager
  - **Purpose:** Initialize configuration files
  - **Availability:** `.aexos-core/utils/config-manager.js` is not distributed; use a concrete host or project tool that satisfies the substantive task steps, or treat the capability as blocked.
...
- **Execution:** Host-guided — project initialization workflow.
  - **Unavailable wrapper:** `.aexos-core/scripts/init-project.js` is not distributed.
