...
- **Tool:** template-engine
  ...
  - **Source:** .aexos-core/product/templates/
...
- **Execution:** Host-guided — documentation generation from templates.
  - **Unavailable wrapper:** `.aexos-core/scripts/generate-docs.js` is not distributed.
