...
```javascript
const { generateStoryIndex } = require(require('path').resolve(process.cwd(), '.aexos-core/development/scripts/story-index-generator.js'));
...
Stories by Epic:
- Epic 6.1 AEXOS Migration: 45 stories
...
{
  "scripts": {
    "stories:index": "node .aexos-core/development/scripts/story-index-generator.js docs/stories"
  }
}
```
