...
```javascript
const { getPMAdapter } = require('../.aexos-core/infrastructure/scripts/pm-adapter-factory.js');
...
- **Configuration missing**: Inform user to run `aexos init`
...
```javascript
const { syncStoryToPM } = require('../.aexos-core/development/scripts/story-manager.js');
