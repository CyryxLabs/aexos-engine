...
```javascript
const learning = require(require('path').resolve(process.cwd(), '.aexos-core/workflow-intelligence/learning'));
...
Storage file: .aexos-core/data/learned-patterns.yaml
...
try {
  ...
  console.log('Try running: rm .aexos-core/data/learned-patterns.yaml');
}
```
