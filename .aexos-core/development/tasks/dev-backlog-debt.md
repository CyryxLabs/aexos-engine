...
### 3. Add to Backlog
```javascript
const { BacklogManager } = require(require('path').resolve(process.cwd(), '.aexos-core/development/scripts/backlog-manager.js'));
...
```json
{
  "scripts": {
    ...
    "debt:review": "node .aexos-core/development/scripts/backlog-manager.js stats"
  }
}
```
