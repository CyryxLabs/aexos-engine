...
3. `.aexos-core/product/templates/tmpl-smoke-test.sql` (template)
...
elif [ -f ".aexos-core/product/templates/tmpl-smoke-test.sql" ]; then
  SMOKE_TEST=".aexos-core/product/templates/tmpl-smoke-test.sql"
else
