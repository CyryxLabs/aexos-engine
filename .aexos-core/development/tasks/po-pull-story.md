...
```javascript
const { getPMAdapter, isPMToolConfigured } = require('../.aexos-core/infrastructure/scripts/pm-adapter-factory.js');
...
```javascript
const { pullStoryFromPM } = require('../.aexos-core/development/scripts/story-manager.js');
