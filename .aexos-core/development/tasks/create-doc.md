...
# User selects from available templates in .aexos-core/product/templates/
tools:
...
If a YAML Template has not been provided, list all templates from .aexos-core/product/templates or ask the user to provide another.
