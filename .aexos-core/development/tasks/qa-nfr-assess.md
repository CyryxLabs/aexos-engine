...
required:
  ...
  - story_path: `aexos-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `aexos-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `aexos-core/core-config.yaml` for the `technicalPreferences`
