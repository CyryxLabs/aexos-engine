...
# Collaborative Edit - AEXOS Developer Task
...
*collaborative-edit start --component aexos-core/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.aexos', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 AEXOS Collaborative Editing'));
