...
- **Execution:** Host-guided — extract issues from QA report.
  - **Unavailable wrapper:** `.aexos-core/development/scripts/parse-qa-report.js` is not distributed.
...
_Generated by Argus (Test Architect) - AEXOS QA System_
