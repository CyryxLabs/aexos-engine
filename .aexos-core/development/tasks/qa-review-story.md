...
2. Call `getReferenceImpact(files)` from `.aexos-core/core/code-intel/helpers/qa-helper.js`
...
- Create directory defined in `qa.qaLocation/gates` (see `.aexos-core/core-config.yaml`) if missing
