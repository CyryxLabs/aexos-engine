...
- Target task must exist in `.aexos-core/development/tasks/`
...
- Load target task from `.aexos-core/development/tasks/{task-name}.md`
- Create timestamped backup: `.aexos-core/development/tasks/.backups/{task-name}.md.{timestamp}`
