...
3. agent-tool - Tool for AEXOS agents
...
const { checkBeforeWriting } = require(require('path').resolve(process.cwd(), '.aexos-core/core/code-intel/helpers/dev-helper.js'));
...
// Check uniqueness
const targetDir = `.aexos-core/infrastructure/services/${serviceName}/`;
...
```javascript
const templateDir = '.aexos-core/development/templates/service-template/';
const templates = [
  'README.md.hbs',
  'index.ts.hbs',
  'types.ts.hbs',
...
cd .aexos-core/infrastructure/services/{service_name}/
...
============================================
 ...
 Next Steps:
   1. cd .aexos-core/infrastructure/services/{service_name}
