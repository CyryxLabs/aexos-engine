...
- **Tool:** backup-manager
  ...
  - **Source:** .aexos-core/infrastructure/scripts/backup-manager.js
...
- **Execution:** Host-guided — rollback to previous state.
  - **Unavailable wrapper:** `.aexos-core/scripts/rollback-changes.js` is not distributed.
...
Rollback the last component creation or modification operation. This task allows undoing recent changes made by the aexos-developer agent, including single component creation, batch creation, or component updates.
...
Operations:
  - Created: /aexos-core/agents/data-analyst.md
  - Updated: /aexos-core/team-manifest.yaml
  - Created: /aexos-core/tasks/analyze-data.md
```
