...
```javascript
const PatternExtractor = require(require('path').resolve(process.cwd(), '.aexos-core/infrastructure/scripts/pattern-extractor.js'));
...
Subcommands:
  ...
  save        Save to .aexos/patterns.md
...
Examples:
  ...
  *extract-patterns save                      # Save to .aexos/patterns.md
...
Output File:
  Default location: .aexos/patterns.md
...
Patterns saved to: .aexos/patterns.md
...
node .aexos-core/infrastructure/scripts/pattern-extractor.js [command] [options]
