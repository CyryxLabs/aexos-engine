...
# Deprecate Component - AEXOS Developer Task
...
*deprecate-component util old-logger --replacement @cyryx/logger --migration-guide docs/migration/logger.md --severity high
...
class DeprecateComponentTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🚫 AEXOS Component Deprecation'));
