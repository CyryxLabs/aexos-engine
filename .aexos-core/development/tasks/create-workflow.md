...
## Purpose
To create a new workflow definition that orchestrates multiple agents and tasks for complex multi-step processes in AEXOS (Cyryx).
...
4. **Create Workflow File**
   - Resolve output path based on target_context:
     - `core` → `.aexos-core/development/workflows/{workflow-name}.yaml`
