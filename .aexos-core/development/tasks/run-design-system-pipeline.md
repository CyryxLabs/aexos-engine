...
- **Tool:** build-component
  ...
  - **Source:** .aexos-core/development/tasks/build-component.md

- **Tool:** generate-documentation
  - **Purpose:** Generate Pattern Library docs
  - **Source:** .aexos-core/development/tasks/generate-documentation.md
...
- **Tool:** calculate-roi
  ...
  - **Source:** .aexos-core/development/tasks/calculate-roi.md
