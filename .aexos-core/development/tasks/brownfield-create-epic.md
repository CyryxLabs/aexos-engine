...
const { getCodebaseOverview, getDependencyGraph } = require(require('path').resolve(process.cwd(), '.aexos-core/core/code-intel/helpers/planning-helper.js'));
...
const { assignExecutorFromContent } = require(require('path').resolve(process.cwd(), '.aexos-core/core/orchestration/executor-assignment.js'));
