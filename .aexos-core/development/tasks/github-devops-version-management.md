...
**Purpose**: Analyze changes, recommend version bumps, and manage semantic versioning for ANY repository using AEXOS.
...
if (!context) {
  throw new Error('Unable to detect repository context. Run "aexos init" first.');
}
