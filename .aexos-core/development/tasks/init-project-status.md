...
```javascript
const { loadProjectStatus } = require('./.aexos-core/infrastructure/scripts/project-status-loader.js');
...
- `.aexos-core/infrastructure/scripts/project-status-loader.js` - Core status loader
