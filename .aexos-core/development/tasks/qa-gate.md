...
**ALWAYS** check the `aexos-core/core-config.yaml` for the `qa.qaLocation/gates`
...
2. Call `getBlastRadius(files)` from `.aexos-core/core/code-intel/helpers/qa-helper.js`
...
1. **ALWAYS** create gate file at: `qa.qaLocation/gates` from `aexos-core/core-config.yaml`
