...
/**
 * Get global AEXOS directory path
 * @returns {string} Path to ~/.aexos/
 */
function getGlobalAexosDir() {
  return path.join(getHomeDir(), '.aexos');
}

// Compatibility aliases for extensions built against earlier public names.
const getGlobalAioxDir = getGlobalAexosDir;
const getGlobalCyryxDir = getGlobalAexosDir;

/**
 * Get global MCP directory path
 * @returns {string} Path to ~/.aexos/mcp/
 */
function getGlobalMcpDir() {
  return path.join(getGlobalAexosDir(), 'mcp');
}

/**
 * Get global MCP config file path
 * @returns {string} Path to ~/.aexos/mcp/global-config.json
 */
 ...
 * @returns {string} Path to ~/.aexos/mcp/servers/
 */
 ...
 * @returns {string} Path to ~/.aexos/mcp/cache/
 */
 ...
 * @returns {string} Path to ~/.aexos/credentials/
 */
function getCredentialsDir() {
  return path.join(getGlobalAexosDir(), 'credentials');
}
