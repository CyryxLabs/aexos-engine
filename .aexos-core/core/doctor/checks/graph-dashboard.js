 ...
 *
 * Validates .aexos-core/core/graph-dashboard/ directory exists
 * with at least 1 .js file.
 *
 * @module aexos-core/doctor/checks/graph-dashboard
 * @story INS-4.1
 */
...
async function run(context) {
  const dashboardDir = path.join(context.projectRoot, '.aexos-core', 'core', 'graph-dashboard');
