 ...
 *
 * Validates .aexos-core/data/entity-registry.yaml exists and mtime < 48h.
 *
 * @module aexos-core/doctor/checks/entity-registry
 * @story INS-4.1
 */
...
async function run(context) {
  const registryPath = path.join(context.projectRoot, '.aexos-core', 'data', 'entity-registry.yaml');
