#!/usr/bin/env node
/**
 * AEXOS Session Start Hook for Gemini CLI
 * Story GEMINI-INT.6 - AEXOS Hooks System
 *
 * Executes at session start to load AEXOS context and memory.
...
async function sessionStart() {
  ...
  try {
    const codebaseMapPath = path.join(projectDir, '.aexos', 'codebase-map.json');
