 ...
 */
const EVENT_MAPPING = {
  // AEXOS Event -> { claude: ClaudeEvent, gemini: GeminiEvent }
...
class UnifiedHook {
   ...
   * @param {string} config.event - AEXOS event name
  ...
  toClaudeConfig() {
    ...
    // Runners not yet implemented - path .aexos-core/hooks/unified/runners/ does not exist
    return null;

    // return {
    //   event: claudeEvent,
    //   matcher: this.matcher,
    //   handler: `node .aexos-core/hooks/unified/runners/claude-runner.js ${this.name}`,
    // };
  }
  ...
  toGeminiConfig() {
    ...
    //       name: this.name,
    //       type: 'command',
    //       command: `node .aexos-core/hooks/unified/runners/gemini-runner.js ${this.name}`,
