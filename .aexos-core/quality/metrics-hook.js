 ...
 * const { recordPreCommitMetrics } = require('./.aexos-core/quality/metrics-hook');
 ...
 * @param {Object} [result.quinn] - Argus (QA agent) findings
 * @param {Object} [result.metadata] - Additional metadata
 * @returns {Promise<Object>} Recorded run
 *
 * @example
 * const { recordPRReviewMetrics } = require('./.aexos-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordHumanReviewMetrics } = require('./.aexos-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { withPreCommitMetrics } = require('./.aexos-core/quality/metrics-hook');
 *
