...
This directory contains automated workflows for the AEXOS project.
...
> **Note:** Legacy 1MCP metrics have been deprecated. AEXOS now uses Docker MCP Toolkit exclusively (Story 5.11).
