---
name: Squad Proposal
about: Propose a new AEXOS Squad for the framework
title: '[SQUAD] '
...
### 📋 Description
A clear and concise description of what this AEXOS Squad does and what domain it covers.

> AEXOS Squads are modular teams of AI agents that work together to accomplish specialized tasks.
...
- Core AEXOS framework (aexos-core)?
...
# Or via CLI
cyryx squad activate my-domain
```

### 📦 Dependencies
- **Core Framework:** Required aexos-core version?
- **Other Squads:** Any dependencies on other AEXOS Squads?
- **External Services:** Any API keys or external services needed?

### 🔒 License & Distribution
- [ ] This squad will be open-source (MIT) in `aexos-squads` repo
...
### ✅ Checklist
- [ ] Squad follows AEXOS structure (`{squad}/agents/`, `{squad}/tasks/`, etc.)
...
**Note:** All squad proposals are reviewed by maintainers. Approved squads may be included in the official `aexos-squads` repository.
