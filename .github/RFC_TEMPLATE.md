...
>
> - Someone familiar with AEXOS can understand
...
4. Tag relevant stakeholders: @CyryxLabs/core-team
...
**Note:** This template follows the AEXOS RFC process. For questions about the process, see [CONTRIBUTING.md](/CONTRIBUTING.md).
