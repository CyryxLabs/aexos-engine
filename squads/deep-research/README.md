...
```
Or use the AEXOS activation:
```
/AEXOS:agents:dr-orchestrator
```

### Direct Specialist Access
```
/AEXOS:agents:sackett              # PICO question formulation
/AEXOS:agents:booth                # Review methodology selection
/AEXOS:agents:creswell             # Research design (qual/quant/mixed)
/AEXOS:agents:forsgren             # Technical metrics (DORA/SPACE)
/AEXOS:agents:cochrane             # Systematic reviews (PRISMA)
/AEXOS:agents:higgins              # OSINT investigations
/AEXOS:agents:klein                # Pattern recognition / sensemaking
/AEXOS:agents:gilad                # Competitive intelligence
/AEXOS:agents:ioannidis            # Evidence reliability audit
/AEXOS:agents:kahneman             # Cognitive bias audit
```
