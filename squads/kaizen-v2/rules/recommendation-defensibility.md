...
| Agente | O que muda |
|--------|-----------|
| @kaizen-v2-chief | Síntese só inclui recomendações que passam no GATE-RD |
| @kaizen-v2-topology-analyst | Classificações de team type precisam de evidência de interação |
| @kaizen-v2-performance-tracker | Alertas precisam de trend (2+ períodos), não spike isolado |
| @kaizen-v2-bottleneck-hunter | Constraint identification precisa de throughput data real |
| @kaizen-v2-capability-mapper | Gaps classificados por N de ocorrências, não por intuição |
| @kaizen-v2-tech-radar | Movimentos entre rings precisam de fitness function evidence |
| @kaizen-v2-cost-analyst | ROI com margem de erro quando baseado em projeção |
