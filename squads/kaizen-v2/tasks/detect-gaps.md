...
# ID: KZ-TP-001
# Executor: kaizen-v2-capability-mapper (primary) + kaizen-v2-tech-radar (tool gaps)
# Trigger: *gaps command or proactive on epic/story update

task:
  name: "Detect Gaps"
  status: ready
  responsible_executor: kaizen-v2-capability-mapper
  ...
  action_items:
    - "Run kaizen-v2-capability-mapper *gaps"
    - "Run kaizen-v2-tech-radar *recommend-tools"
    - "Merge results into unified gap report"
    - "Hand off to kaizen-v2-chief for synthesis"
