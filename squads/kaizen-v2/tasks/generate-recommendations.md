...
# Executor: kaizen-v2-chief (synthesis)
...
task:
  ...
  status: ready
  responsible_executor: kaizen-v2-chief
  ...
  input:
    - "topology_report — from kaizen-v2-topology-analyst"
    - "performance_report — from kaizen-v2-performance-tracker"
    - "bottleneck_report — from kaizen-v2-bottleneck-hunter"
    - "capability_report — from kaizen-v2-capability-mapper"
    - "radar_report — from kaizen-v2-tech-radar"
    - "cost_report — from kaizen-v2-cost-analyst"
  ...
  steps:
    ...
    - id: "5"
      ...
      action: |
        ...
        - ROI: From kaizen-v2-cost-analyst calculation
  ...
  action_items:
    - "kaizen-v2-chief synthesizes all reports"
