...
# ID: KZ-TP-002
# Executor: kaizen-v2-performance-tracker
# Trigger: *performance command or weekly cadence

task:
  name: "Performance Dashboard"
  status: ready
  responsible_executor: kaizen-v2-performance-tracker
  ...
  action_items:
    - "Run kaizen-v2-performance-tracker *performance"
    - "Hand off alerts to kaizen-v2-bottleneck-hunter if constraints detected"
    - "Hand off to kaizen-v2-chief for weekly report"
