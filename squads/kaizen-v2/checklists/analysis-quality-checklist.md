...
# ID: KZ-QC-003
# Used by: kaizen-v2-chief para validar qualidade de cada dimensão da análise

## Validação por Dimensão

### 1. Estrutura (kaizen-v2-topology-analyst)
...
### 2. Performance (kaizen-v2-performance-tracker)
...
### 3. Bottlenecks (kaizen-v2-bottleneck-hunter)
...
### 4. Capabilities (kaizen-v2-capability-mapper)
...
### 5. Technology Radar (kaizen-v2-tech-radar)
...
### 6. Custos (kaizen-v2-cost-analyst)
