...
This knowledge base contains comprehensive guidance on creating high-quality AEXOS-FULLSTACK squads. It covers architectural patterns, best practices, design principles, and domain-specific knowledge for the Squad Architect Squad.
...
An squad is a modular, self-contained extension to AEXOS-FULLSTACK that adds domain-specific capabilities through:
...
- **Modularity:** Extend AEXOS without modifying core framework
...
- **Community:** Enable community contributions to AEXOS ecosystem
...
- Integrates with AEXOS framework
...
```yaml
dependencies:
  - AEXOS-developer  # For code generation
...
❌ **Assumed Knowledge**
- Expecting users know AEXOS internals
...
**Stay Current**
- Monitor AEXOS framework updates
- Update dependencies regularly
- Test with new AEXOS versions
...
- Contribution rate
- Update frequency
- Compatibility with latest AEXOS
...
- Contribute to AEXOS ecosystem

---

_Knowledge Base Version: 1.0_
_Last Updated: 2025-09-30_
_Maintained by: AEXOS Squad Architect Team_
