...
```yaml
collect_mind_dna:
  condition: "include_minds == true AND .aexos/squad-runtime/minds/{expert}/ exists"

  for_each_expert:
    - action: "Check mind directory"
      path: ".aexos/squad-runtime/minds/{expert_slug}/"
...
| Mind dir missing | .aexos/squad-runtime/minds/{expert}/ not found | Skip DNA section, note in doc |
