...
**Quality Standard:** AEXOS Level (comprehensive research, validated sources)
...
- [ ] Write permissions for `.aexos/squad-runtime/discovery/{domain}/`
...
```yaml
generate_report:
  file: ".aexos/squad-runtime/discovery/{domain}/tool-discovery-report.md"
...
|--------|----------|-------------|
| Tool Discovery Report | `.aexos/squad-runtime/discovery/{domain}/tool-discovery-report.md` | MCP research findings |
| Capability Map | `.aexos/squad-runtime/discovery/{domain}/capability-tools.yaml` | Domain capability to tool mapping |
| Integration Plan | `.aexos/squad-runtime/discovery/{domain}/tool-integration-plan.md` | Prioritized implementation steps |
