...
**Purpose:** Validate a squad against AEXOS principles using tiered, context-aware validation
...
**Worker Scripts (Modular - RFC-001):**
  ...
  - `infrastructure/scripts/squads/validate_workflow_contracts.cjs` -- AEXOS workflow contract parity check (same as CI)
...
`.aexos/squad-runtime/validate-squad/{squad_name}/state.json`
