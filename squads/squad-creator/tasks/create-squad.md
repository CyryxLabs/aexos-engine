...
**Purpose:** Create a complete AEXOS-FULLSTACK squad through guided elicitation, template selection, and validation
**Orchestrator:** @squad-chief
**Mode:** Incremental (human checkpoints) or YOLO (autonomous)
**Quality Standard:** AEXOS Level (all components meet minimum standards)
...
workspace_domain_check:
  read_files:
    - ".aexos/project-context/index.yaml"       # Lista de dominios e providers
    - ".aexos/project-context/domains/"          # Dominios existentes
    - ".aexos/project-context/businesses/"       # BUs e produtos existentes

  checks:
    - domain_exists_in_workspace: ".aexos/project-context/domains/{domain}/ existe?"
    - product_alignment: "Squad serve qual produto em .aexos/project-context/businesses/{bu}/products/?"
  ...
  behavior:
    ...
    domain_not_exists: "Prosseguir normalmente. Apos criacao, sugerir criacao de .aexos/project-context/domains/{domain}/"
```
...
workspace_domain_check:
  read_files:
    - ".aexos/project-context/index.yaml"       # Dominios e providers registrados
    - ".aexos/project-context/domains/"          # Dominios existentes
    - ".aexos/project-context/businesses/"       # BUs e produtos existentes

  analysis:
    - domain_exists: ".aexos/project-context/domains/{domain}/ existe?"
    - domain_has_entities: ".aexos/project-context/domains/{domain}/entities.yaml existe?"
    - domain_has_workflows: ".aexos/project-context/domains/{domain}/workflows.yaml existe?"
...
**Usage:**
- Se `.aexos/project-context/domains/{domain}/` existe -> informar squad-chief para que agentes respeitem entidades existentes
- Se `.aexos/project-context/domains/{domain}/entities.yaml` existe -> incluir entidades como contexto nos agentes criados
- Se `.aexos/project-context/businesses/{bu}/products/` tem produtos relevantes -> alinhar use cases com produtos existentes
...
pack_structure_elicitation:
  ...
  derived:
    ...
    - outputs_path: ".aexos/squad-runtime/create-squad/{squad_name}/"
...
| Runtime Outputs | `.aexos/squad-runtime/create-squad/{squad_name}/` | Artifacts gerados em execucoes reais |
...
- [ ] Runtime state exists at `.aexos/squad-runtime/create-squad/{squad_name}/state.json`
