...
**Quality Standard:** AEXOS Level (300+ lines, valid YAML/MD)
...
This task creates output templates for AEXOS squads. Templates define the structure and format of artifacts that agents and tasks produce.
...
- Follow AEXOS template standards
