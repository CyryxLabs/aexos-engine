...
**Quality Standard:** AEXOS Level (300+ lines, voice_dna, output_examples)
...
self_contained:
  ...
  forbidden:
    - ".aexos/squad-runtime/minds/*"  # DNA extraido deve ser INTEGRADO, nao referenciado
    - ".aexos-core/*"     # Nao depender de core externo
...
load_template:
  ...
  extract_required_sections:
    # Level 1: Identity
    - activation_notice: "Standard AEXOS header"
...
- Follow AEXOS agent definition standards (6 levels)
