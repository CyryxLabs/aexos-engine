...
**Quality Standard:** AEXOS Level (300+ lines simple, 500+ lines complex)
...
This task creates a single workflow task for an AEXOS squad. The key insight: **every task must follow the Task Anatomy standard (8 fields) for consistency and quality**.
