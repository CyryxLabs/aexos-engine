...
sections:
  ...
  - id: integration
    title: Integration with Core AEXOS
    instruction: Explain how this squad integrates with AEXOS framework
    template: |
      ## Integration with Core AEXOS
  ...
  - id: footer
    ...
    template: |
      ...
      **Ready to {{pack_tagline}}? Let's get started! 🚀**
      ...
      _Version: {{version}}_
      _Compatible with: AEXOS-FULLSTACK v4+_
