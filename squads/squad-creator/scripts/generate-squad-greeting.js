...
// Framework dependencies (from .aexos-core/ — optional, graceful fallback if not present)
let SquadLoader, GreetingBuilder, SessionContextLoader, loadProjectStatus;
try {
  ({ SquadLoader } = require('../../../.aexos-core/development/scripts/squad/squad-loader'));
  GreetingBuilder = require('../../../.aexos-core/development/scripts/greeting-builder');
  SessionContextLoader = require('../../../.aexos-core/scripts/session-context-loader');
...
const REGISTRY_PATH_ENV = 'AEXOS_ECOSYSTEM_REGISTRY_PATH';
const DEFAULT_REGISTRY_REL_PATH = path.join('.AEXOS', 'squad-runtime', 'ecosystem-registry.yaml');
...
async function generateEcosystemReport(settings = {}) {
  ...
  let report = `## 📊 AEXOS Squad Ecosystem
