...
def test_scoring_adapter_fallback_json_contract_without_pro() -> None:
    result = _run_script("scoring.py", "squad-creator", "--output", "json", env={"AEXOS_FORCE_NO_PRO": "1"})
...
def test_coherence_adapter_fallback_json_contract_without_pro() -> None:
    result = _run_script("coherence-validator.py", "--output", "json", env={"AEXOS_FORCE_NO_PRO": "1"})
