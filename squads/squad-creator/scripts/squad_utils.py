...
def detect_squad_usage(squad_name: str, project_root: Path) -> Dict[str, Any]:
    ...
    Signals checked:
    1. .aexos/squad-runtime/{squad}/ - outputs generated by squad
    ...
    # 1. Check canonical runtime evidence directories in .aexos/squad-runtime
    runtime_candidates = [
        project_root / ".AEXOS" / "squad-runtime" / "squads" / squad_name,
        project_root / ".AEXOS" / "squad-runtime" / "create-squad" / squad_name,
        project_root / ".AEXOS" / "squad-runtime" / "validate-squad" / squad_name,
    ]
