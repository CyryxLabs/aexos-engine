...
> requer o **AEXOS Pro** (squad-creator-pro). No modo base, o @squad-chief
...
> apenas com o **AEXOS Pro** (squad-creator-pro instalado).
...
```
User: "*clone-mind Gary Halbert"
squad-chief: "Essa funcionalidade requer o AEXOS Pro.
...
squad-chief apresenta upgrade prompt:
  "Essa funcionalidade requer o AEXOS Pro (squad-creator-pro).
