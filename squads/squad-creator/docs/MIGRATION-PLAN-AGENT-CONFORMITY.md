...
> **Objetivo:** Alinhar 3 agents do Squad-Creator com o padrão AEXOS de activation
> **Data:** 2026-02-10
...
O sistema AEXOS tem um padrão de "activation" (como o agent se apresenta e lista comandos). Sem esse padrão:
