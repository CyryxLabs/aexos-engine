...
This checklist validates AEXOS squads using a **tiered, context-aware approach** based on analysis of well-structured squads.
...
- [ ] If `workspace_integration.level != none`, squad has explicit `.aexos/project-context/` path references in tasks/workflows/config
