...
The Dispatch Squad is the **execution backbone** of AEXOS. It receives stories, PRDs, or task lists, decomposes them into atomic sub-tasks, optimizes into DAG-based waves, routes to the correct agents/models, and executes in parallel via subagents — all while keeping the main Opus context clean.
...
- **Source:** Self-contained in `squads/dispatch/` (legacy `.aexos-core/` dispatcher files have been removed)
...
*Dispatch Squad v1.0.0 — AEXOS Framework*
