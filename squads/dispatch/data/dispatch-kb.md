...
Dispatch is the **execution backbone** of AEXOS — every parallelizable work goes through it. It receives stories/PRDs/tasks, decomposes them into atomic sub-tasks, optimizes into DAG-based waves, routes to correct agents/models, and executes in parallel via subagents.
