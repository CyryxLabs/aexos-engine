...
description: >-
  Design and implement ICU MessageFormat patterns for pluralization, gender selection, ordinals, and
  nested selects for robust internationalization
elicit: true
