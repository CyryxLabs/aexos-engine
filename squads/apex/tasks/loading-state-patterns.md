...
description: >-
  Design loading experiences: skeleton screens, shimmer effects, progressive loading, optimistic UI,
  and perceived performance patterns
elicit: true
