...
description: >-
  Design empty states for all scenarios: first-use, no-results, error-cleared, filtered-empty, and
  data-deleted with appropriate CTAs and illustrations
elicit: true
