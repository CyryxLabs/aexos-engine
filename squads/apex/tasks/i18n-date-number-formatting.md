---
task: i18n-date-number-formatting
...
description: >-
  Implement Intl-based date, time, number, currency, and relative time formatting with timezone
  awareness and locale-specific patterns
elicit: true
