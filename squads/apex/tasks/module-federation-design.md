...
description: >-
  Design micro-frontend architecture with Module Federation: shared dependencies, runtime
  integration, versioning strategy, and fallback patterns
elicit: true
