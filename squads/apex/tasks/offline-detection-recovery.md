---
task: offline-detection-recovery
owner: react-eng
owner_type: agent
atomic_layer: task
...
description: >-
  Design offline-first patterns: network state detection, mutation queue, sync strategies, cached
  data display, and PWA offline support
elicit: true
executor: react-eng
outputs:
