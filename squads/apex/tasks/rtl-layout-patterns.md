...
description: >-
  Design RTL-safe layouts using CSS logical properties, bidirectional text handling, mirrored UI
  patterns, and locale-aware component variants
elicit: true
