...
description: >-
  Design and catalog reusable custom hooks: useDebounce, useMediaQuery, useIntersection,
  useLocalStorage, and composition patterns for hook architecture
elicit: true
executor: react-eng
outputs:
