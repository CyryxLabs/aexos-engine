---
task: monorepo-architecture-design
owner: frontend-arch
owner_type: agent
atomic_layer: task
...
description: >-
  Evaluate monorepo vs polyrepo, design package boundaries, dependency constraints, versioning
  strategy, and build graph for frontend projects
elicit: true
