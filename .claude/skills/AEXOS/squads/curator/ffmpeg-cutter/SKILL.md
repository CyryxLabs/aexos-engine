---
name: aexos-curator-ffmpeg-cutter
description: "Activate Ffmpeg Cutter (ffmpeg-cutter) for Ffmpeg Cutter Specialist. Use this AEXOS agent when the task matches its responsibility."
user-invocable: true
...
agent:
  ...
  name: Ffmpeg Cutter
  id: ffmpeg-cutter
  title: Ffmpeg Cutter Specialist
```
