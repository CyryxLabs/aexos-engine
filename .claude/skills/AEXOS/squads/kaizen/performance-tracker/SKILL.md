---
name: aexos-kaizen-performance-tracker
description: "Activate Performance Tracker (performance-tracker) for Squad Performance Analyst & Metrics Diagnostician. Use when you need to measure, track, and diagnose performance across the squad ecosystem: - Generate full performance dashboards wi..."
user-invocable: true
...
data_collection_protocol:
  ...
  revision_count:
    command: >-
      ...
      'fix|rework|revise|correct|adjust|update' | wc -l
