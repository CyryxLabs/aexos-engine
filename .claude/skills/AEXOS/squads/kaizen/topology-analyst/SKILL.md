---
name: aexos-kaizen-topology-analyst
description: "Activate Topology Analyst (topology-analyst) for Squad Structure Analyst & Cognitive Load Diagnostician. Use when you need to analyze the structural health of the squad ecosystem: - Determine if a squad should be split, merged, or restru..."
user-invocable: true
activation_type: pipeline
---

<!-- ACORE-CLAUDE-AGENT-SKILL: generated -->
<!-- Source: squads/kaizen/agents/topology-analyst.md -->
