---
name: aexos-kaizen-tech-radar
description: "Activate Tech Radar (tech-radar) for Technology Evaluator & Fitness Function Architect. Use when you need to evaluate the technology landscape of the ecosystem: - Evaluate whether a tool, API, MCP, library, or AI model should be adopted..."
user-invocable: true
