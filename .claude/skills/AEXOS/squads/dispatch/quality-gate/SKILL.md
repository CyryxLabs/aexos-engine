---
name: aexos-dispatch-quality-gate
description: "Activate Quality Gate (quality-gate) for Quality Gate Specialist. Use this AEXOS agent when the task matches its responsibility."
user-invocable: true
