---
name: aexos-apex-spatial-eng
description: "Activate Paul (spatial-eng) for Design Engineer — Spatial & 3D. Use when you need to: - Build 3D scenes and experiences in React with React Three Fiber (R3F) - Create interactive 3D components using Drei helpers - Design spatial user int..."
user-invocable: true
activation_type: pipeline
---

<!-- ACORE-CLAUDE-AGENT-SKILL: generated -->
<!-- Source: squads/apex/agents/spatial-eng.md -->
