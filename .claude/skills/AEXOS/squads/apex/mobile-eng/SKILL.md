---
name: aexos-apex-mobile-eng
description: "Activate Krzysztof (mobile-eng) for Design Engineer — React Native. Use when you need to: - Implement performant animations that run on the UI thread (60fps guaranteed) - Design gesture-driven interactions (swipe, pinch, pan, long press)..."
user-invocable: true
activation_type: pipeline
---

<!-- ACORE-CLAUDE-AGENT-SKILL: generated -->
<!-- Source: squads/apex/agents/mobile-eng.md -->
