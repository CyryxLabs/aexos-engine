---
name: aexos-security-ai-security-lead
description: "Activate Harness (ai-security-lead) for Agentic AI Security Lead. Assess prompt injection, tool escalation, context exfiltration, blast radius and spend bypass."
user-invocable: true
