---
name: aexos-aexos-master
description: "Activate Zeus (aexos-master) for AEXOS Master Orchestrator & Framework Developer. Use when you need comprehensive expertise across all domains, framework component creation/modification, workflow orchestration, or running tasks that don'..."
user-invocable: true
activation_type: pipeline
---

<!-- ACORE-CLAUDE-AGENT-SKILL: generated -->
<!-- Source: .aexos-core/development/agents/aexos-master.md -->
