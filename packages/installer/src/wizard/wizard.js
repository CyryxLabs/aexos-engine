    ...
    return {
      ...
      detectInstallationMode(targetDir) {
        ...
        return {
          mode: legacyType,
          legacyType,
          reason: legacyType === 'EXISTING_CYRYX'
            ? 'brownfield project (existing AEXOS)'
...
/**
 * Interactive Wizard for AEXOS Installation
 *
 ...
 * - FRAMEWORK_DEV: Contributing to aexos-core itself
 *
 * @module wizard
 * @version 2.0.0
 * @story 6.9
...
async function runWizard(options = {}) {
  ...
  try {
    ...
    console.log('🚀 Welcome to AEXOS Installer\n');
...
async function confirmProjectType(detectedType) {
  ...
  const typeDescriptions = {
    GREENFIELD: 'New project - AEXOS will create complete structure',
    BROWNFIELD: 'Existing project - AEXOS will integrate with current setup',
    EXISTING_CYRYX: 'AEXOS already installed - Would you like to update or reinstall?',
