...
async function validateFiles(fileContext = {}) {
  ...
  try {
    ...
    const coreConfigPath = fileContext.coreConfig || '.aexos-core/core-config.yaml';
    ...
    // Validate directory structure - only .aexos-core is required
    const requiredDirs = ['.aexos-core'];
