...
const TRANSLATIONS = {
  en: {
    ...
    proForgotPassword:
      'Forgot your password? Visit https://aexos-license-server.vercel.app/reset-password',
    ...
    proModuleNotAvailable: 'Pro license module not available. Run: npx @aexos/core pro setup',
    proModuleBootstrap:
      'Pro license module not found locally. Installing AEXOS Pro to bootstrap...',
    proServerUnreachable:
      'License server is unreachable. Check your internet connection and try again.',
    ...
    proScaffolderNotAvailable: 'Pro scaffolder not available. Run: npx @aexos/core pro setup',
    ...
    proCISetEnv:
      'CI mode: Set AEXOS_PRO_EMAIL + AEXOS_PRO_PASSWORD or AEXOS_PRO_KEY environment variables.',
    proVerificationFailed: 'Verification failed: {message}',
    proPackageNotFound:
      'Pro content source not found. Re-run Pro setup with email login or contact support.',
  ...
  pt: {
    ...
    installingCore: 'Instalando AEXOS core...',
    ...
    proNoAccess: 'Nenhum acesso AEXOS Pro encontrado para este email.',
    proContactSupport: 'Se você acredita que isso é um erro, entre em contato com o suporte:',
    proPurchase: 'Comprar Pro: https://pro.cyryx.ai',
    ...
    proForgotPassword:
      'Esqueceu sua senha? Acesse https://aexos-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'Ou abra uma issue: https://github.com/CyryxLabs/AEXOS/issues',
    proAuthFailed: 'Falha na autenticação: {message}',
    proCreateAccount: 'Crie sua conta AEXOS Pro para começar.',
    ...
    proPurchaseAt: 'Compre o Pro em https://pro.cyryx.ai',
    ...
    proLicenseCacheFailed: 'Não foi possível salvar o cache local da licença Pro: {message}',
    ...
    proModuleNotAvailable:
      'Módulo de licença Pro não disponível. Execute: npx @aexos/core pro setup',
    proModuleBootstrap:
      'Módulo de licença Pro não encontrado localmente. Instalando o AEXOS Pro...',
    proServerUnreachable:
      'Servidor de licenças inacessível. Verifique sua conexão com a internet e tente novamente.',
    ...
    proInstallingPackage: 'Instalando pacote AEXOS Pro...',
    proPackageInstalled: 'Pacote Pro instalado',
    proPackageInstallFailed: 'Falha ao instalar pacote Pro',
    proScaffolderNotAvailable: 'Scaffolder Pro não disponível. Execute: npx @aexos/core pro setup',
    ...
    proInstallComplete: 'Instalação do AEXOS Pro completa!',
    proNeedHelp: 'Precisa de ajuda? Execute: npx -y @aexos/pro-cli@latest recover',
    proCISetEnv:
      'Modo CI: Defina as variáveis AEXOS_PRO_EMAIL + AEXOS_PRO_PASSWORD ou AEXOS_PRO_KEY.',
    proVerificationFailed: 'Verificação falhou: {message}',
    proPackageNotFound:
      'Fonte de conteúdo Pro não encontrada. Rode o setup Pro novamente com login por email ou contate o suporte.',
    proScaffolderNotFound: 'Módulo scaffolder Pro não encontrado.',
    proNpmInitFailed: 'npm init falhou: {message}',
    proNpmInstallFailed:
      'A instalação do pacote AEXOS Pro falhou: {message}. Tente manualmente: npx @aexos/core pro setup',
  },
  ...
  es: {
    ...
    proNoAccess: 'No se encontró acceso AEXOS Pro para este email.',
    ...
    proEmailNotVerified:
      'Email aún no verificado. Revise su bandeja de entrada y haga clic en el enlace de verificación.',
    ...
    proForgotPassword:
      '¿Olvidó su contraseña? Visite https://aexos-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'O abra un issue: https://github.com/CyryxLabs/AEXOS/issues',
    proAuthFailed: 'Error de autenticación: {message}',
    proCreateAccount: 'Cree su cuenta AEXOS Pro para comenzar.',
    ...
    proPurchaseAt: 'Compre Pro en https://pro.cyryx.ai',
    ...
    proLicenseCacheFailed: 'No se pudo guardar el caché local de la licencia Pro: {message}',
    ...
    proModuleNotAvailable:
      'Módulo de licencia Pro no disponible. Ejecute: npx @aexos/core pro setup',
    proModuleBootstrap: 'Módulo de licencia Pro no encontrado localmente. Instalando AEXOS Pro...',
    proServerUnreachable:
      'Servidor de licencias inaccesible. Verifique su conexión a internet e intente nuevamente.',
    proVerifyingAccessShort: 'Verificando acceso...',
    proAccessConfirmed: 'Acceso Pro confirmado.',
    proBuyerCheckUnavailable:
      'Verificación de comprador no disponible, procediendo con inicio de sesión...',
    ...
    proInstallingPackage: 'Instalando paquete AEXOS Pro...',
    proPackageInstalled: 'Paquete Pro instalado',
    proPackageInstallFailed: 'Error al instalar paquete Pro',
    proScaffolderNotAvailable: 'Scaffolder Pro no disponible. Ejecute: npx @aexos/core pro setup',
    ...
    proInstallComplete: '¡Instalación de AEXOS Pro completa!',
    proNeedHelp: '¿Necesita ayuda? Ejecute: npx -y @aexos/pro-cli@latest recover',
    proCISetEnv:
      'Modo CI: Configure las variables AEXOS_PRO_EMAIL + AEXOS_PRO_PASSWORD o AEXOS_PRO_KEY.',
    proVerificationFailed: 'Verificación fallida: {message}',
    proPackageNotFound:
      'Fuente de contenido Pro no encontrada. Ejecuta el setup Pro nuevamente con login por email o contacta soporte.',
    proScaffolderNotFound: 'Módulo scaffolder Pro no encontrado.',
    proNpmInitFailed: 'npm init falló: {message}',
    proNpmInstallFailed:
      'La instalación del paquete AEXOS Pro falló: {message}. Intente manualmente: npx @aexos/core pro setup',
  },
};
...
/**
 * Get supported language choices for the installer.
