 ...
 * IDE Configuration Metadata
 *
 * AEXOS (Cyryx) supports 7 main IDEs/CLIs:
 * - Claude Code (Anthropic's official CLI) - Recommended
 * - Codex CLI (OpenAI coding CLI)
 * - Grok Build (xAI coding TUI/CLI) - Recommended
...
const IDE_CONFIGS = {
  ...
  grok: {
    ...
    format: 'text',
    recommended: true,
    // Native profiles are generated by grok-skills-sync, not generic agent copy.
  },
  gemini: {
    name: 'Gemini CLI',
    description: '',
