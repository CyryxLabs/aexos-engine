...
/**
 * Get the current AEXOS version from package.json
 * @returns {string} The version string
 */
function getCyryxVersion() {
  try {
    return getCyryxCoreVersion() || '2.2.0';
  } catch {
    // Ignore errors
  }
  return '2.2.0';
...
const AEXOS_VERSION = getCyryxVersion();
...
function generateEnvContent(apiKeys = {}) {
  const content = `# ============================================
# AEXOS (Cyryx) Environment Configuration
# ============================================
# Generated by AEXOS Installer
...
# --------------------------------------------
# AEXOS Core Configuration
# --------------------------------------------
NODE_ENV=development
AEXOS_VERSION=${AEXOS_VERSION}
