...
jest.mock('../../../../../.aexos-core/infrastructure/scripts/ide-sync/index', () => ({
...
describe('IDE Sync Integration (Story INS-4.5)', () => {
  ...
  describe('AC3: Graceful failure', () => {
    ...
    test('failure message suggests aexos doctor --fix', () => {
      expect(wizardSource).toContain('aexos doctor --fix');
    });
