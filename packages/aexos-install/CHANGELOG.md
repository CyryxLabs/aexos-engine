...
- Renamed package from `@cyryx/aexos-install` to `@aexos-squads/aexos-install`.
- Preserved the `aexos-install` and `edmcp` bin commands under the new namespace.

## [1.0.0] - 2026-02-05

### Added

- Initial release of `@cyryx/aexos-install` NPX package
