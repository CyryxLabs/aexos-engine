module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    'tests/installer/add-tech-doc.test.js',
    ...
    // These suites import the inaccessible private pro/license implementation.
    // Public installer/license denial contracts run in the ordinary suite.
    'tests/license/',
  ],
