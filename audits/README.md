...
Cross-project audit reports and AuditFinding artifacts. Part of the CYRYX Framework Evolution Pipeline.
...
audits/
├── README.md                              # this file
├── <audit-narrative>.md                   # human-readable audit reports (e.g., <YYYY-MM-DD>-<slug>.md)
...
Any agent may author an audit. Promotion to a framework proposal requires the orchestrator's approval (see pipeline doc).
